...
import 'accountingadministrationpage33.dart';
import 'accountingadministrationpage34.dart';

class accountingadministrationtest33 extends StatefulWidget {
  const accountingadministrationtest33({super.key});

  @override
  accountingadministrationtest33State createState() =>
      accountingadministrationtest33State();
}

class accountingadministrationtest33State
    extends State<accountingadministrationtest33> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage33(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 33'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage34()));
              },
