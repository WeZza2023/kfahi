...
import 'accountingadministrationpage24.dart';
import 'accountingadministrationpage25.dart';

class accountingadministrationtest24 extends StatefulWidget {
  const accountingadministrationtest24({super.key});

  @override
  accountingadministrationtest24State createState() =>
      accountingadministrationtest24State();
}

class accountingadministrationtest24State
    extends State<accountingadministrationtest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage24(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 24'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage25()));
              },
