...
import 'accountingadministrationpage30.dart';
import 'accountingadministrationpage31.dart';

class accountingadministrationtest30 extends StatefulWidget {
  const accountingadministrationtest30({super.key});

  @override
  accountingadministrationtest30State createState() =>
      accountingadministrationtest30State();
}

class accountingadministrationtest30State
    extends State<accountingadministrationtest30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage30(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 30'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage31()));
              },
