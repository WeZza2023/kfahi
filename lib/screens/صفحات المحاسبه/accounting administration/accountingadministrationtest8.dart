...
import 'accountingadministrationpage8.dart';
import 'accountingadministrationpage9.dart';

class accountingadministrationtest8 extends StatefulWidget {
  const accountingadministrationtest8({super.key});

  @override
  accountingadministrationtest8State createState() =>
      accountingadministrationtest8State();
}

class accountingadministrationtest8State
    extends State<accountingadministrationtest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage8(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة الثامنه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const accountingadministrationpage9()));
              },
