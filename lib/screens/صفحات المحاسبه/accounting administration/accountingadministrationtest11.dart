...
class accountingadministrationtest11 extends StatefulWidget {
  const accountingadministrationtest11({super.key});

  @override
  accountingadministrationtest11State createState() =>
      accountingadministrationtest11State();
}

class accountingadministrationtest11State
    extends State<accountingadministrationtest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage11(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 11'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage12()));
              },
