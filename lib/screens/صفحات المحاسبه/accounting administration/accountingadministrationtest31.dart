...
import 'accountingadministrationpage31.dart';
import 'accountingadministrationpage32.dart';

class accountingadministrationtest31 extends StatefulWidget {
  const accountingadministrationtest31({super.key});

  @override
  accountingadministrationtest31State createState() =>
      accountingadministrationtest31State();
}

class accountingadministrationtest31State
    extends State<accountingadministrationtest31> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage31(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 31'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage32()));
              },
