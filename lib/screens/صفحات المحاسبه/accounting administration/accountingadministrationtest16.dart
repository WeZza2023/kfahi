...
import 'accountingadministrationpage16.dart';
import 'accountingadministrationpage17.dart';

class accountingadministrationtest16 extends StatefulWidget {
  const accountingadministrationtest16({super.key});

  @override
  accountingadministrationtest16State createState() =>
      accountingadministrationtest16State();
}

class accountingadministrationtest16State
    extends State<accountingadministrationtest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage16(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 16'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage17()));
              },
