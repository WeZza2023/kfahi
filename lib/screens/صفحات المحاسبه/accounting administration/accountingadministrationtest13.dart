...
import 'accountingadministrationpage13.dart';
import 'accountingadministrationpage14.dart';

class accountingadministrationtest13 extends StatefulWidget {
  const accountingadministrationtest13({super.key});

  @override
  accountingadministrationtest13State createState() =>
      accountingadministrationtest13State();
}

class accountingadministrationtest13State
    extends State<accountingadministrationtest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage13(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 13'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage14()));
              },
