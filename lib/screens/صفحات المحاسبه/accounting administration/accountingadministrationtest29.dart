...
import 'accountingadministrationpage29.dart';
import 'accountingadministrationpage30.dart';

class accountingadministrationtest29 extends StatefulWidget {
  const accountingadministrationtest29({super.key});

  @override
  accountingadministrationtest29State createState() =>
      accountingadministrationtest29State();
}

class accountingadministrationtest29State
    extends State<accountingadministrationtest29> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage29(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 29'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage30()));
              },
