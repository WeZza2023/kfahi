...
import 'accountingadministrationpage26.dart';

class accountingadministrationtest25 extends StatefulWidget {
  const accountingadministrationtest25({super.key});

  @override
  accountingadministrationtest25State createState() =>
      accountingadministrationtest25State();
}

class accountingadministrationtest25State
    extends State<accountingadministrationtest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage25(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 25'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage26()));
              },
