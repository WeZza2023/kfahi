...
import 'accountingadministrationpage2.dart';
import 'accountingadministrationpage3.dart';

class accountingadministrationtest2 extends StatefulWidget {
  const accountingadministrationtest2({super.key});

  @override
  accountingadministrationtest2State createState() =>
      accountingadministrationtest2State();
}

class accountingadministrationtest2State
    extends State<accountingadministrationtest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage2(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة الثانيه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const accountingadministrationpage3()));
              },
