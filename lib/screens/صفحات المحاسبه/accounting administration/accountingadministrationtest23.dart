...
class accountingadministrationtest23 extends StatefulWidget {
  const accountingadministrationtest23({super.key});

  @override
  accountingadministrationtest23State createState() =>
      accountingadministrationtest23State();
}

class accountingadministrationtest23State
    extends State<accountingadministrationtest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage23(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 23'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage24()));
              },
