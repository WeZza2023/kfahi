...
import 'accountingadministrationpage5.dart';
import 'accountingadministrationpage6.dart';

class accountingadministrationtest5 extends StatefulWidget {
  const accountingadministrationtest5({super.key});

  @override
  accountingadministrationtest5State createState() =>
      accountingadministrationtest5State();
}

class accountingadministrationtest5State
    extends State<accountingadministrationtest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage5(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة الخامسه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const accountingadministrationpage6()));
              },
