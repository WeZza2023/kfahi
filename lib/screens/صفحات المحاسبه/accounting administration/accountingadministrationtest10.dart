...
import 'accountingadministrationpage10.dart';
import 'accountingadministrationpage11.dart';

class accountingadministrationtest10 extends StatefulWidget {
  const accountingadministrationtest10({super.key});

  @override
  accountingadministrationtest10State createState() =>
      accountingadministrationtest10State();
}

class accountingadministrationtest10State
    extends State<accountingadministrationtest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage10(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 10'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage11()));
              },
