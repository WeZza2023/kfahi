...
class accountingadministrationtest32 extends StatefulWidget {
  const accountingadministrationtest32({super.key});

  @override
  accountingadministrationtest32State createState() =>
      accountingadministrationtest32State();
}

class accountingadministrationtest32State
    extends State<accountingadministrationtest32> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage32(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 32'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage33()));
              },
