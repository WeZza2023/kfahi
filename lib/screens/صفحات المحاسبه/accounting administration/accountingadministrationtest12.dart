...
import 'accountingadministrationpage12.dart';
import 'accountingadministrationpage13.dart';

class accountingadministrationtest12 extends StatefulWidget {
  const accountingadministrationtest12({super.key});

  @override
  accountingadministrationtest12State createState() =>
      accountingadministrationtest12State();
}

class accountingadministrationtest12State
    extends State<accountingadministrationtest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage12(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 12'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage13()));
              },
