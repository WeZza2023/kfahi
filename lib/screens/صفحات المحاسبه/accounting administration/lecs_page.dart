...
class AccAdminLecsPage extends StatefulWidget {
  AccAdminLecsPage({super.key});

  @override
  State<AccAdminLecsPage> createState() => _AccAdminLecsPageState();
}

class _AccAdminLecsPageState extends State<AccAdminLecsPage> {
