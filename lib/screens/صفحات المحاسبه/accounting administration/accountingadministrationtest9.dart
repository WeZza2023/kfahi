...
class accountingadministrationtest9 extends StatefulWidget {
  const accountingadministrationtest9({super.key});

  @override
  accountingadministrationtest9State createState() =>
      accountingadministrationtest9State();
}

class accountingadministrationtest9State
    extends State<accountingadministrationtest9> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة التاسعه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage10()));
              },
