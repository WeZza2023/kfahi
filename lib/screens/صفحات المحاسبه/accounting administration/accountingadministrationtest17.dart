...
import 'accountingadministrationpage18.dart';

class accountingadministrationtest17 extends StatefulWidget {
  const accountingadministrationtest17({super.key});

  @override
  accountingadministrationtest17State createState() =>
      accountingadministrationtest17State();
}

class accountingadministrationtest17State
    extends State<accountingadministrationtest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage17(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 17'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage18()));
              },
