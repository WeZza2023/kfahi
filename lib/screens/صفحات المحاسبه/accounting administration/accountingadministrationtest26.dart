...
class accountingadministrationtest26 extends StatefulWidget {
  const accountingadministrationtest26({super.key});

  @override
  accountingadministrationtest26State createState() =>
      accountingadministrationtest26State();
}

class accountingadministrationtest26State
    extends State<accountingadministrationtest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage26(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 26'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage27()));
              },
