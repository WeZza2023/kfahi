...
import 'accountingadministrationpage15.dart';
import 'accountingadministrationpage16.dart';

class accountingadministrationtest15 extends StatefulWidget {
  const accountingadministrationtest15({super.key});

  @override
  accountingadministrationtest15State createState() =>
      accountingadministrationtest15State();
}

class accountingadministrationtest15State
    extends State<accountingadministrationtest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage15(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 15'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage16()));
              },
