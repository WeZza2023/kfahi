...
class accountingadministrationtest20 extends StatefulWidget {
  const accountingadministrationtest20({super.key});

  @override
  accountingadministrationtest20State createState() =>
      accountingadministrationtest20State();
}

class accountingadministrationtest20State
    extends State<accountingadministrationtest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage20(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 20'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage21()));
              },
