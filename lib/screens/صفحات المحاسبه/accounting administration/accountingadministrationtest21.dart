...
import 'accountingadministrationpage21.dart';
import 'accountingadministrationpage22.dart';

class accountingadministrationtest21 extends StatefulWidget {
  const accountingadministrationtest21({super.key});

  @override
  accountingadministrationtest21State createState() =>
      accountingadministrationtest21State();
}

class accountingadministrationtest21State
    extends State<accountingadministrationtest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage21(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 21'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage22()));
              },
