...
class accountingadministrationtest7 extends StatefulWidget {
  const accountingadministrationtest7({super.key});

  @override
  accountingadministrationtest7State createState() =>
      accountingadministrationtest7State();
}

class accountingadministrationtest7State
    extends State<accountingadministrationtest7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة السابعه'),
      ),
      body: Center(
        child: Column(
