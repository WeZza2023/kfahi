...
class accountingadministrationtest18 extends StatefulWidget {
  const accountingadministrationtest18({super.key});

  @override
  accountingadministrationtest18State createState() =>
      accountingadministrationtest18State();
}

class accountingadministrationtest18State
    extends State<accountingadministrationtest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage18(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 18'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage19()));
              },
