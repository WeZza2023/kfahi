...
class accountingadministrationtest28 extends StatefulWidget {
  const accountingadministrationtest28({super.key});

  @override
  accountingadministrationtest28State createState() =>
      accountingadministrationtest28State();
}

class accountingadministrationtest28State
    extends State<accountingadministrationtest28> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage28(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 28'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage29()));
              },
