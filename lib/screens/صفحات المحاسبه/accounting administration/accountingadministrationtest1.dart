...
import 'accountingadministrationpage.dart';
import 'accountingadministrationpage2.dart';

class accountingadministrationtest1 extends StatefulWidget {
  const accountingadministrationtest1({super.key});

  @override
  accountingadministrationtest1State createState() =>
      accountingadministrationtest1State();
}

class accountingadministrationtest1State
    extends State<accountingadministrationtest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة الأولى'),
      ),
      body: Center(
        child: Column(
