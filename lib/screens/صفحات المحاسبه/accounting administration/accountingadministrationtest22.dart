...
import 'accountingadministrationpage22.dart';
import 'accountingadministrationpage23.dart';

class accountingadministrationtest22 extends StatefulWidget {
  const accountingadministrationtest22({super.key});

  @override
  accountingadministrationtest22State createState() =>
      accountingadministrationtest22State();
}

class accountingadministrationtest22State
    extends State<accountingadministrationtest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage22(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 22'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage23()));
              },
