...
class accountingadministrationtest14 extends StatefulWidget {
  const accountingadministrationtest14({super.key});

  @override
  accountingadministrationtest14State createState() =>
      accountingadministrationtest14State();
}

class accountingadministrationtest14State
    extends State<accountingadministrationtest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage14(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 14'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage15()));
              },
