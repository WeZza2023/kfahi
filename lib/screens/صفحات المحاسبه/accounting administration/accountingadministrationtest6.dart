...
import 'accountingadministrationpage7.dart';

class accountingadministrationtest6 extends StatefulWidget {
  const accountingadministrationtest6({super.key});

  @override
  accountingadministrationtest6State createState() =>
      accountingadministrationtest6State();
}

class accountingadministrationtest6State
    extends State<accountingadministrationtest6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة السادسه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const accountingadministrationpage7()));
              },
