...
import 'accountingadministrationpage27.dart';
import 'accountingadministrationpage28.dart';

class accountingadministrationtest27 extends StatefulWidget {
  const accountingadministrationtest27({super.key});

  @override
  accountingadministrationtest27State createState() =>
      accountingadministrationtest27State();
}

class accountingadministrationtest27State
    extends State<accountingadministrationtest27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const accountingadministrationpage27(),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة 27'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const accountingadministrationpage28()));
              },
