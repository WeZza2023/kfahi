...
class AccAdmintest extends StatefulWidget {
  const AccAdmintest({super.key});

  @override
  _AccAdmintestState createState() => _AccAdmintestState();
}

class _AccAdmintestState extends State<AccAdmintest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(AccAdminQues)
      ..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار Accounting Administration'),
      ),
      body: Center(
        child: Column(
