...
import 'accountingadministrationpage4.dart';

class accountingadministrationtest3 extends StatefulWidget {
  const accountingadministrationtest3({super.key});

  @override
  accountingadministrationtest3State createState() =>
      accountingadministrationtest3State();
}

class accountingadministrationtest3State
    extends State<accountingadministrationtest3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضرة الثالثه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const accountingadministrationpage4()));
              },
