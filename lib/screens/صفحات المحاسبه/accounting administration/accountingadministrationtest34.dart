...
class accountingadministrationtest34 extends StatefulWidget {
  const accountingadministrationtest34({super.key});

  @override
  _accountingadministrationtest34State createState() =>
      _accountingadministrationtest34State();
}

class _accountingadministrationtest34State
    extends State<accountingadministrationtest34> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => const accountingadministrationtest34()));
    }
