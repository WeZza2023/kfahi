...
import 'Costaccountingpage2.dart';
import 'Costaccountingpage3.dart';

class Costaccountingtest2 extends StatefulWidget {
  const Costaccountingtest2({super.key});

  @override
  _Costaccountingtest2State createState() => _Costaccountingtest2State();
}

class _Costaccountingtest2State extends State<Costaccountingtest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage3()));
              },
