...
class CostAccountingTest extends StatefulWidget {
  const CostAccountingTest({super.key});

  @override
  _CostAccountingTestState createState() => _CostAccountingTestState();
}

class _CostAccountingTestState extends State<CostAccountingTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(CostAccQues)
      ..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار Cost Accounting'),
      ),
      body: Center(
        child: Column(
