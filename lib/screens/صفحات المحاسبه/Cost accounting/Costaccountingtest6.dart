...
import 'Costaccountingpage6.dart';
import 'Costaccountingpage7.dart';

class Costaccountingtest6 extends StatefulWidget {
  const Costaccountingtest6({super.key});

  @override
  _Costaccountingtest6State createState() => _Costaccountingtest6State();
}

class _Costaccountingtest6State extends State<Costaccountingtest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage6()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره السادسه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage7()));
              },
