...
import 'Costaccountingpage1.dart';
import 'Costaccountingpage2.dart';

class Costaccountingtest1 extends StatefulWidget {
  const Costaccountingtest1({super.key});

  @override
  _Costaccountingtest1State createState() => _Costaccountingtest1State();
}

class _Costaccountingtest1State extends State<Costaccountingtest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage1()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage2()));
              },
