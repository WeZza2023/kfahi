...
import 'Costaccountingpage24.dart';
import 'Costaccountingpage25.dart';

class Costaccountingtest24 extends StatefulWidget {
  const Costaccountingtest24({super.key});

  @override
  _Costaccountingtest24State createState() => _Costaccountingtest24State();
}

class _Costaccountingtest24State extends State<Costaccountingtest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage25()));
              },
