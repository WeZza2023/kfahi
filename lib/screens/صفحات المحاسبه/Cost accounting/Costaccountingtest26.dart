...
import 'Costaccountingpage27.dart';

class Costaccountingtest26 extends StatefulWidget {
  const Costaccountingtest26({super.key});

  @override
  _Costaccountingtest26State createState() => _Costaccountingtest26State();
}

class _Costaccountingtest26State extends State<Costaccountingtest26> {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage27()));
              },
