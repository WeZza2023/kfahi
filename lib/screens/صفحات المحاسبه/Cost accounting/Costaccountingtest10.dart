...
import 'Costaccountingpage10.dart';
import 'Costaccountingpage11.dart';

class Costaccountingtest10 extends StatefulWidget {
  const Costaccountingtest10({super.key});

  @override
  _Costaccountingtest10State createState() => _Costaccountingtest10State();
}

class _Costaccountingtest10State extends State<Costaccountingtest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage10()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره العاشره'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage11()));
              },
