...
import 'Costaccountingpage15.dart';
import 'Costaccountingpage16.dart';

class Costaccountingtest15 extends StatefulWidget {
  const Costaccountingtest15({super.key});

  @override
  _Costaccountingtest15State createState() => _Costaccountingtest15State();
}

class _Costaccountingtest15State extends State<Costaccountingtest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage16()));
              },
