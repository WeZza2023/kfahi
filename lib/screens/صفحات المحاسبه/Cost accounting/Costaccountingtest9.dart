...
import 'Costaccountingpage9.dart';

class Costaccountingtest9 extends StatefulWidget {
  const Costaccountingtest9({super.key});

  @override
  _Costaccountingtest9State createState() => _Costaccountingtest9State();
}

class _Costaccountingtest9State extends State<Costaccountingtest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage9()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره التاسعه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage10()));
              },
