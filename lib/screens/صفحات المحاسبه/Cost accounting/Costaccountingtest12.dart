...
class Costaccountingtest12 extends StatefulWidget {
  const Costaccountingtest12({super.key});

  @override
  _Costaccountingtest12State createState() => _Costaccountingtest12State();
}

class _Costaccountingtest12State extends State<Costaccountingtest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage13()));
              },
