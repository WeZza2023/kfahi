...
import 'Costaccountingpage21.dart';

class Costaccountingtest20 extends StatefulWidget {
  const Costaccountingtest20({super.key});

  @override
  _Costaccountingtest20State createState() => _Costaccountingtest20State();
}

class _Costaccountingtest20State extends State<Costaccountingtest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage21()));
              },
