...
import 'Costaccountingpage8.dart';
import 'Costaccountingpage9.dart';

class Costaccountingtest8 extends StatefulWidget {
  const Costaccountingtest8({super.key});

  @override
  _Costaccountingtest8State createState() => _Costaccountingtest8State();
}

class _Costaccountingtest8State extends State<Costaccountingtest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage8()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره الثامنه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage9()));
              },
