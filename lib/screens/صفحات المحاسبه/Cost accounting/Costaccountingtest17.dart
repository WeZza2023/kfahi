...
import 'Costaccountingpage17.dart';
import 'Costaccountingpage18.dart';

class Costaccountingtest17 extends StatefulWidget {
  const Costaccountingtest17({super.key});

  @override
  _Costaccountingtest17State createState() => _Costaccountingtest17State();
}

class _Costaccountingtest17State extends State<Costaccountingtest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage18()));
              },
