...
import 'Costaccountingpage22.dart';
import 'Costaccountingpage23.dart';

class Costaccountingtest22 extends StatefulWidget {
  const Costaccountingtest22({super.key});

  @override
  _Costaccountingtest22State createState() => _Costaccountingtest22State();
}

class _Costaccountingtest22State extends State<Costaccountingtest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage23()));
              },
