...
class Costaccountingtest23 extends StatefulWidget {
  const Costaccountingtest23({super.key});

  @override
  _Costaccountingtest23State createState() => _Costaccountingtest23State();
}

class _Costaccountingtest23State extends State<Costaccountingtest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage24()));
              },
