...
class Costaccountingtest16 extends StatefulWidget {
  const Costaccountingtest16({super.key});

  @override
  _Costaccountingtest16State createState() => _Costaccountingtest16State();
}

class _Costaccountingtest16State extends State<Costaccountingtest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage17()));
              },
