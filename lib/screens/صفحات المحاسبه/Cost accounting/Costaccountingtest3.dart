...
import 'Costaccountingpage3.dart';
import 'Costaccountingpage4.dart';

class Costaccountingtest3 extends StatefulWidget {
  const Costaccountingtest3({super.key});

  @override
  _Costaccountingtest3State createState() => _Costaccountingtest3State();
}

class _Costaccountingtest3State extends State<Costaccountingtest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage4()));
              },
