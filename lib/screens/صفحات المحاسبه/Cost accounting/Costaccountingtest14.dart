...
class Costaccountingtest14 extends StatefulWidget {
  const Costaccountingtest14({super.key});

  @override
  _Costaccountingtest14State createState() => _Costaccountingtest14State();
}

class _Costaccountingtest14State extends State<Costaccountingtest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage15()));
              },
