...
class Costaccountingtest21 extends StatefulWidget {
  const Costaccountingtest21({super.key});

  @override
  _Costaccountingtest21State createState() => _Costaccountingtest21State();
}

class _Costaccountingtest21State extends State<Costaccountingtest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage22()));
              },
