...
import 'Costaccountingpage13.dart';
import 'Costaccountingpage14.dart';

class Costaccountingtest13 extends StatefulWidget {
  const Costaccountingtest13({super.key});

  @override
  _Costaccountingtest13State createState() => _Costaccountingtest13State();
}

class _Costaccountingtest13State extends State<Costaccountingtest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage14()));
              },
