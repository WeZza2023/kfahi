...
import 'Costaccountingpage26.dart';

class Costaccountingtest25 extends StatefulWidget {
  const Costaccountingtest25({super.key});

  @override
  _Costaccountingtest25State createState() => _Costaccountingtest25State();
}

class _Costaccountingtest25State extends State<Costaccountingtest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage25()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage26()));
              },
