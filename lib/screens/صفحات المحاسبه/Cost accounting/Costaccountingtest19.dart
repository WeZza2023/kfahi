...
import 'Costaccountingpage19.dart';
import 'Costaccountingpage20.dart';

class Costaccountingtest19 extends StatefulWidget {
  const Costaccountingtest19({super.key});

  @override
  _Costaccountingtest19State createState() => _Costaccountingtest19State();
}

class _Costaccountingtest19State extends State<Costaccountingtest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage20()));
              },
