...
class Costaccountingtest5 extends StatefulWidget {
  const Costaccountingtest5({super.key});

  @override
  _Costaccountingtest5State createState() => _Costaccountingtest5State();
}

class _Costaccountingtest5State extends State<Costaccountingtest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage5()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره الخامسه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage6()));
              },
