...
import 'Costaccountingpage12.dart';

class Costaccountingtest11 extends StatefulWidget {
  const Costaccountingtest11({super.key});

  @override
  _Costaccountingtest11State createState() => _Costaccountingtest11State();
}

class _Costaccountingtest11State extends State<Costaccountingtest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage12()));
              },
