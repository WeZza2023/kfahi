...
import 'Costaccountingpage4.dart';
import 'Costaccountingpage5.dart';

class Costaccountingtest4 extends StatefulWidget {
  const Costaccountingtest4({super.key});

  @override
  _Costaccountingtest4State createState() => _Costaccountingtest4State();
}

class _Costaccountingtest4State extends State<Costaccountingtest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage4()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره الرابعه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage5()));
              },
