...
class Costaccountingtest7 extends StatefulWidget {
  const Costaccountingtest7({super.key});

  @override
  _Costaccountingtest7State createState() => _Costaccountingtest7State();
}

class _Costaccountingtest7State extends State<Costaccountingtest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage7()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره السابعه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage8()));
              },
