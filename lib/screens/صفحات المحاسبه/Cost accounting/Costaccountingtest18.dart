...
import 'Costaccountingpage18.dart';
import 'Costaccountingpage19.dart';

class Costaccountingtest18 extends StatefulWidget {
  const Costaccountingtest18({super.key});

  @override
  _Costaccountingtest18State createState() => _Costaccountingtest18State();
}

class _Costaccountingtest18State extends State<Costaccountingtest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Costaccountingpage19()));
              },
