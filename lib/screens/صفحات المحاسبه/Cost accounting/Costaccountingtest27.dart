...
class Costaccountingtest27 extends StatefulWidget {
  const Costaccountingtest27({super.key});

  @override
  _Costaccountingtest27State createState() => _Costaccountingtest27State();
}

class _Costaccountingtest27State extends State<Costaccountingtest27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Costaccountingpage27()));
    }
