...
class Financialaccountingtest4 extends StatefulWidget {
  const Financialaccountingtest4({super.key});

  @override
  _Financialaccountingtest4State createState() =>
      _Financialaccountingtest4State();
}

class _Financialaccountingtest4State extends State<Financialaccountingtest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage5()));
              },
