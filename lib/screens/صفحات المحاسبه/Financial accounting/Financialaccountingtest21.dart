...
class Financialaccountingtest21 extends StatefulWidget {
  const Financialaccountingtest21({super.key});

  @override
  _Financialaccountingtest21State createState() =>
      _Financialaccountingtest21State();
}

class _Financialaccountingtest21State extends State<Financialaccountingtest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage22()));
              },
