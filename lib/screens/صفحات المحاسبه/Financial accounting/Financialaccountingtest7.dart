...
import 'Financialaccountingpage7.dart';
import 'Financialaccountingpage8.dart';

class Financialaccountingtest7 extends StatefulWidget {
  const Financialaccountingtest7({super.key});

  @override
  _Financialaccountingtest7State createState() =>
      _Financialaccountingtest7State();
}

class _Financialaccountingtest7State extends State<Financialaccountingtest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage8()));
              },
