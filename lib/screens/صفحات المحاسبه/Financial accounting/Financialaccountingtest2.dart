...
import 'Financialaccountingpage2.dart';
import 'Financialaccountingpage3.dart';

class Financialaccountingtest2 extends StatefulWidget {
  const Financialaccountingtest2({super.key});

  @override
  _Financialaccountingtest2State createState() =>
      _Financialaccountingtest2State();
}

class _Financialaccountingtest2State extends State<Financialaccountingtest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage3()));
              },
