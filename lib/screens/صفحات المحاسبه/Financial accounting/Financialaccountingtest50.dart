...
class Financialaccountingtest50 extends StatefulWidget {
  const Financialaccountingtest50({super.key});

  @override
  _Financialaccountingtest50State createState() =>
      _Financialaccountingtest50State();
}

class _Financialaccountingtest50State extends State<Financialaccountingtest50> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage50()));
    }
