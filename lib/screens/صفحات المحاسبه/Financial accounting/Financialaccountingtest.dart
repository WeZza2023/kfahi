...
class FinancialAccountingTest extends StatefulWidget {
  const FinancialAccountingTest({super.key});

  @override
  _FinancialAccountingTestState createState() =>
      _FinancialAccountingTestState();
}

class _FinancialAccountingTestState extends State<FinancialAccountingTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(FinanceAccQues)
      ..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار Financial Accounting'),
      ),
      body: Center(
        child: Column(
