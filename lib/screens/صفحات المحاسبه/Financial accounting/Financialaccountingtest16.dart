...
class Financialaccountingtest16 extends StatefulWidget {
  const Financialaccountingtest16({super.key});

  @override
  _Financialaccountingtest16State createState() =>
      _Financialaccountingtest16State();
}

class _Financialaccountingtest16State extends State<Financialaccountingtest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage17()));
              },
