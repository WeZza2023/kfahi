...
class Financialaccountingtest32 extends StatefulWidget {
  const Financialaccountingtest32({super.key});

  @override
  _Financialaccountingtest32State createState() =>
      _Financialaccountingtest32State();
}

class _Financialaccountingtest32State extends State<Financialaccountingtest32> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage32()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage33()));
              },
