...
import 'Financialaccountingpage45.dart';
import 'Financialaccountingpage46.dart';

class Financialaccountingtest45 extends StatefulWidget {
  const Financialaccountingtest45({super.key});

  @override
  _Financialaccountingtest45State createState() =>
      _Financialaccountingtest45State();
}

class _Financialaccountingtest45State extends State<Financialaccountingtest45> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage45()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage46()));
              },
