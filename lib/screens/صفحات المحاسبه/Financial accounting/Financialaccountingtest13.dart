...
import 'Financialaccountingpage13.dart';
import 'Financialaccountingpage14.dart';

class Financialaccountingtest13 extends StatefulWidget {
  const Financialaccountingtest13({super.key});

  @override
  _Financialaccountingtest13State createState() =>
      _Financialaccountingtest13State();
}

class _Financialaccountingtest13State extends State<Financialaccountingtest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage14()));
              },
