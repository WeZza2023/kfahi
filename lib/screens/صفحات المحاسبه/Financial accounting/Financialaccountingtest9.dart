...
import 'Financialaccountingpage9.dart';

class Financialaccountingtest9 extends StatefulWidget {
  const Financialaccountingtest9({super.key});

  @override
  _Financialaccountingtest9State createState() =>
      _Financialaccountingtest9State();
}

class _Financialaccountingtest9State extends State<Financialaccountingtest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage10()));
              },
