...
import 'Financialaccountingpage38.dart';
import 'Financialaccountingpage39.dart';

class Financialaccountingtest38 extends StatefulWidget {
  const Financialaccountingtest38({super.key});

  @override
  _Financialaccountingtest38State createState() =>
      _Financialaccountingtest38State();
}

class _Financialaccountingtest38State extends State<Financialaccountingtest38> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage38()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage39()));
              },
