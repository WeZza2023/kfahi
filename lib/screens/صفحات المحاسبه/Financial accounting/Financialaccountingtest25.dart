...
import 'Financialaccountingpage26.dart';

class Financialaccountingtest25 extends StatefulWidget {
  const Financialaccountingtest25({super.key});

  @override
  _Financialaccountingtest25State createState() =>
      _Financialaccountingtest25State();
}

class _Financialaccountingtest25State extends State<Financialaccountingtest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage25()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage26()));
              },
