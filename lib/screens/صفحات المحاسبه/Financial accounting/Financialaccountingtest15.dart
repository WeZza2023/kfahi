...
import 'Financialaccountingpage16.dart';

class Financialaccountingtest15 extends StatefulWidget {
  const Financialaccountingtest15({super.key});

  @override
  _Financialaccountingtest15State createState() =>
      _Financialaccountingtest15State();
}

class _Financialaccountingtest15State extends State<Financialaccountingtest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage16()));
              },
