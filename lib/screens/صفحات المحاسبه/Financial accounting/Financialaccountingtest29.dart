...
import 'Financialaccountingpage29.dart';
import 'Financialaccountingpage30.dart';

class Financialaccountingtest29 extends StatefulWidget {
  const Financialaccountingtest29({super.key});

  @override
  _Financialaccountingtest29State createState() =>
      _Financialaccountingtest29State();
}

class _Financialaccountingtest29State extends State<Financialaccountingtest29> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage29()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage30()));
              },
