...
import 'Financialaccountingpage14.dart';
import 'Financialaccountingpage15.dart';

class Financialaccountingtest14 extends StatefulWidget {
  const Financialaccountingtest14({super.key});

  @override
  _Financialaccountingtest14State createState() =>
      _Financialaccountingtest14State();
}

class _Financialaccountingtest14State extends State<Financialaccountingtest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage15()));
              },
