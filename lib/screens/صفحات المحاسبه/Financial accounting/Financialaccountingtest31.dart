...
import 'Financialaccountingpage31.dart';
import 'Financialaccountingpage32.dart';

class Financialaccountingtest31 extends StatefulWidget {
  const Financialaccountingtest31({super.key});

  @override
  _Financialaccountingtest31State createState() =>
      _Financialaccountingtest31State();
}

class _Financialaccountingtest31State extends State<Financialaccountingtest31> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage31()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage32()));
              },
