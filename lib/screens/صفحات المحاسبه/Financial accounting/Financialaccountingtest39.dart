...
class Financialaccountingtest39 extends StatefulWidget {
  const Financialaccountingtest39({super.key});

  @override
  _Financialaccountingtest39State createState() =>
      _Financialaccountingtest39State();
}

class _Financialaccountingtest39State extends State<Financialaccountingtest39> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage39()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage40()));
              },
