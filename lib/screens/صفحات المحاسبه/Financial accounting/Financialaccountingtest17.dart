...
import 'Financialaccountingpage17.dart';
import 'Financialaccountingpage18.dart';

class Financialaccountingtest17 extends StatefulWidget {
  const Financialaccountingtest17({super.key});

  @override
  _Financialaccountingtest17State createState() =>
      _Financialaccountingtest17State();
}

class _Financialaccountingtest17State extends State<Financialaccountingtest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage18()));
              },
