...
class Financialaccountingtest23 extends StatefulWidget {
  const Financialaccountingtest23({super.key});

  @override
  _Financialaccountingtest23State createState() =>
      _Financialaccountingtest23State();
}

class _Financialaccountingtest23State extends State<Financialaccountingtest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage24()));
              },
