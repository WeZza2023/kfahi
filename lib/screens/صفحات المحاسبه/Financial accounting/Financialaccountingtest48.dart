...
import 'Financialaccountingpage48.dart';
import 'Financialaccountingpage49.dart';

class Financialaccountingtest48 extends StatefulWidget {
  const Financialaccountingtest48({super.key});

  @override
  _Financialaccountingtest48State createState() =>
      _Financialaccountingtest48State();
}

class _Financialaccountingtest48State extends State<Financialaccountingtest48> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage48()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage49()));
              },
