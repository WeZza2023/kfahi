...
import 'Financialaccountingpage5.dart';
import 'Financialaccountingpage6.dart';

class Financialaccountingtest5 extends StatefulWidget {
  const Financialaccountingtest5({super.key});

  @override
  _Financialaccountingtest5State createState() =>
      _Financialaccountingtest5State();
}

class _Financialaccountingtest5State extends State<Financialaccountingtest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage6()));
              },
