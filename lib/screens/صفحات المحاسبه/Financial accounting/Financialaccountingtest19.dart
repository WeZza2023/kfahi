...
import 'Financialaccountingpage19.dart';
import 'Financialaccountingpage20.dart';

class Financialaccountingtest19 extends StatefulWidget {
  const Financialaccountingtest19({super.key});

  @override
  _Financialaccountingtest19State createState() =>
      _Financialaccountingtest19State();
}

class _Financialaccountingtest19State extends State<Financialaccountingtest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage20()));
              },
