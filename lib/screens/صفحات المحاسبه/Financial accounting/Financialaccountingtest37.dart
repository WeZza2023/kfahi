...
import 'Financialaccountingpage37.dart';
import 'Financialaccountingpage38.dart';

class Financialaccountingtest37 extends StatefulWidget {
  const Financialaccountingtest37({super.key});

  @override
  _Financialaccountingtest37State createState() =>
      _Financialaccountingtest37State();
}

class _Financialaccountingtest37State extends State<Financialaccountingtest37> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage37()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage38()));
              },
