...
import 'Financialaccountingpage35.dart';
import 'Financialaccountingpage36.dart';

class Financialaccountingtest35 extends StatefulWidget {
  const Financialaccountingtest35({super.key});

  @override
  _Financialaccountingtest35State createState() =>
      _Financialaccountingtest35State();
}

class _Financialaccountingtest35State extends State<Financialaccountingtest35> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage35()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage36()));
              },
