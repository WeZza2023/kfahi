...
import 'Financialaccountingpage33.dart';
import 'Financialaccountingpage34.dart';

class Financialaccountingtest33 extends StatefulWidget {
  const Financialaccountingtest33({super.key});

  @override
  _Financialaccountingtest33State createState() =>
      _Financialaccountingtest33State();
}

class _Financialaccountingtest33State extends State<Financialaccountingtest33> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage33()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage34()));
              },
