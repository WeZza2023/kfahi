...
import 'Financialaccountingpage20.dart';
import 'Financialaccountingpage21.dart';

class Financialaccountingtest20 extends StatefulWidget {
  const Financialaccountingtest20({super.key});

  @override
  _Financialaccountingtest20State createState() =>
      _Financialaccountingtest20State();
}

class _Financialaccountingtest20State extends State<Financialaccountingtest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage21()));
              },
