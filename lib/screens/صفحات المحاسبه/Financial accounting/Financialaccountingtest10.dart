...
import 'Financialaccountingpage10.dart';
import 'Financialaccountingpage11.dart';

class Financialaccountingtest10 extends StatefulWidget {
  const Financialaccountingtest10({super.key});

  @override
  _Financialaccountingtest10State createState() =>
      _Financialaccountingtest10State();
}

class _Financialaccountingtest10State extends State<Financialaccountingtest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage11()));
              },
