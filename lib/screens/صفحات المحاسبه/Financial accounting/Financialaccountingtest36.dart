...
class Financialaccountingtest36 extends StatefulWidget {
  const Financialaccountingtest36({super.key});

  @override
  _Financialaccountingtest36State createState() =>
      _Financialaccountingtest36State();
}

class _Financialaccountingtest36State extends State<Financialaccountingtest36> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage36()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage37()));
              },
