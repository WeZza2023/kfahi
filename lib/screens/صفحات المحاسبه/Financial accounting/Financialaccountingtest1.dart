...
import 'Financialaccountingpage.dart';

class Financialaccountingtest1 extends StatefulWidget {
  const Financialaccountingtest1({super.key});

  @override
  Financialaccountingtest1State createState() =>
      Financialaccountingtest1State();
}

class Financialaccountingtest1State extends State<Financialaccountingtest1> {
