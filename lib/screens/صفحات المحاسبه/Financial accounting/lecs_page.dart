...
class FinancialAccountingLecsPage extends StatefulWidget {
  FinancialAccountingLecsPage({super.key});

  @override
  State<FinancialAccountingLecsPage> createState() =>
      _FinancialAccountingLecsPageState();
}

class _FinancialAccountingLecsPageState
    extends State<FinancialAccountingLecsPage> {
