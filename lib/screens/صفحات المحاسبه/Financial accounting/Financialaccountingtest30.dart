...
class Financialaccountingtest30 extends StatefulWidget {
  const Financialaccountingtest30({super.key});

  @override
  _Financialaccountingtest30State createState() =>
      _Financialaccountingtest30State();
}

class _Financialaccountingtest30State extends State<Financialaccountingtest30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage30()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage31()));
              },
