...
class Financialaccountingtest6 extends StatefulWidget {
  const Financialaccountingtest6({super.key});

  @override
  _Financialaccountingtest6State createState() =>
      _Financialaccountingtest6State();
}

class _Financialaccountingtest6State extends State<Financialaccountingtest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage7()));
              },
