...
class Financialaccountingtest41 extends StatefulWidget {
  const Financialaccountingtest41({super.key});

  @override
  _Financialaccountingtest41State createState() =>
      _Financialaccountingtest41State();
}

class _Financialaccountingtest41State extends State<Financialaccountingtest41> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage41()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage42()));
              },
