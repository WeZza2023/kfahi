...
class Financialaccountingtest43 extends StatefulWidget {
  const Financialaccountingtest43({super.key});

  @override
  _Financialaccountingtest43State createState() =>
      _Financialaccountingtest43State();
}

class _Financialaccountingtest43State extends State<Financialaccountingtest43> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage43()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage44()));
              },
