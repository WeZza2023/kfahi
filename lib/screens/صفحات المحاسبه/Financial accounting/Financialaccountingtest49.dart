...
import 'Financialaccountingpage50.dart';

class Financialaccountingtest49 extends StatefulWidget {
  const Financialaccountingtest49({super.key});

  @override
  _Financialaccountingtest49State createState() =>
      _Financialaccountingtest49State();
}

class _Financialaccountingtest49State extends State<Financialaccountingtest49> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage49()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage50()));
              },
