...
class Financialaccountingtest28 extends StatefulWidget {
  const Financialaccountingtest28({super.key});

  @override
  _Financialaccountingtest28State createState() =>
      _Financialaccountingtest28State();
}

class _Financialaccountingtest28State extends State<Financialaccountingtest28> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage28()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage29()));
              },
