...
import 'Financialaccountingpage44.dart';
import 'Financialaccountingpage45.dart';

class Financialaccountingtest44 extends StatefulWidget {
  const Financialaccountingtest44({super.key});

  @override
  _Financialaccountingtest44State createState() =>
      _Financialaccountingtest44State();
}

class _Financialaccountingtest44State extends State<Financialaccountingtest44> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage44()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage45()));
              },
