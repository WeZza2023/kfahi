...
import 'Financialaccountingpage24.dart';
import 'Financialaccountingpage25.dart';

class Financialaccountingtest24 extends StatefulWidget {
  const Financialaccountingtest24({super.key});

  @override
  _Financialaccountingtest24State createState() =>
      _Financialaccountingtest24State();
}

class _Financialaccountingtest24State extends State<Financialaccountingtest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage25()));
              },
