...
class Financialaccountingtest34 extends StatefulWidget {
  const Financialaccountingtest34({super.key});

  @override
  _Financialaccountingtest34State createState() =>
      _Financialaccountingtest34State();
}

class _Financialaccountingtest34State extends State<Financialaccountingtest34> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage34()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage35()));
              },
