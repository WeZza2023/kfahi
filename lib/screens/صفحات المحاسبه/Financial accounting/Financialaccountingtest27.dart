...
import 'Financialaccountingpage27.dart';
import 'Financialaccountingpage28.dart';

class Financialaccountingtest27 extends StatefulWidget {
  const Financialaccountingtest27({super.key});

  @override
  _Financialaccountingtest27State createState() =>
      _Financialaccountingtest27State();
}

class _Financialaccountingtest27State extends State<Financialaccountingtest27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage27()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage28()));
              },
