...
import 'Financialaccountingpage40.dart';
import 'Financialaccountingpage41.dart';

class Financialaccountingtest40 extends StatefulWidget {
  const Financialaccountingtest40({super.key});

  @override
  _Financialaccountingtest40State createState() =>
      _Financialaccountingtest40State();
}

class _Financialaccountingtest40State extends State<Financialaccountingtest40> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage40()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage41()));
              },
