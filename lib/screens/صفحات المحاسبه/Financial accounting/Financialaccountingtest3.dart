...
import 'Financialaccountingpage3.dart';
import 'Financialaccountingpage4.dart';

class Financialaccountingtest3 extends StatefulWidget {
  const Financialaccountingtest3({super.key});

  @override
  _Financialaccountingtest3State createState() =>
      _Financialaccountingtest3State();
}

class _Financialaccountingtest3State extends State<Financialaccountingtest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage4()));
              },
