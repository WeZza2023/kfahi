...
import 'Financialaccountingpage47.dart';
import 'Financialaccountingpage48.dart';

class Financialaccountingtest47 extends StatefulWidget {
  const Financialaccountingtest47({super.key});

  @override
  _Financialaccountingtest47State createState() =>
      _Financialaccountingtest47State();
}

class _Financialaccountingtest47State extends State<Financialaccountingtest47> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage47()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage48()));
              },
