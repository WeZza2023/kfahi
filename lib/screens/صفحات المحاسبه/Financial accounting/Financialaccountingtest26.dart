...
class Financialaccountingtest26 extends StatefulWidget {
  const Financialaccountingtest26({super.key});

  @override
  _Financialaccountingtest26State createState() =>
      _Financialaccountingtest26State();
}

class _Financialaccountingtest26State extends State<Financialaccountingtest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage26()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage27()));
              },
