...
import 'Financialaccountingpage42.dart';
import 'Financialaccountingpage43.dart';

class Financialaccountingtest42 extends StatefulWidget {
  const Financialaccountingtest42({super.key});

  @override
  _Financialaccountingtest42State createState() =>
      _Financialaccountingtest42State();
}

class _Financialaccountingtest42State extends State<Financialaccountingtest42> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage42()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage43()));
              },
