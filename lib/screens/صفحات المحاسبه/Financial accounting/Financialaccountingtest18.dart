...
class Financialaccountingtest18 extends StatefulWidget {
  const Financialaccountingtest18({super.key});

  @override
  _Financialaccountingtest18State createState() =>
      _Financialaccountingtest18State();
}

class _Financialaccountingtest18State extends State<Financialaccountingtest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage19()));
              },
