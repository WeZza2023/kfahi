...
import 'Financialaccountingpage11.dart';
import 'Financialaccountingpage12.dart';

class Financialaccountingtest11 extends StatefulWidget {
  const Financialaccountingtest11({super.key});

  @override
  _Financialaccountingtest11State createState() =>
      _Financialaccountingtest11State();
}

class _Financialaccountingtest11State extends State<Financialaccountingtest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage12()));
              },
