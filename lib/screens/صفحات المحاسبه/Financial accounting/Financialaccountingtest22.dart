...
import 'Financialaccountingpage22.dart';
import 'Financialaccountingpage23.dart';

class Financialaccountingtest22 extends StatefulWidget {
  const Financialaccountingtest22({super.key});

  @override
  _Financialaccountingtest22State createState() =>
      _Financialaccountingtest22State();
}

class _Financialaccountingtest22State extends State<Financialaccountingtest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage23()));
              },
