...
class Financialaccountingtest8 extends StatefulWidget {
  const Financialaccountingtest8({super.key});

  @override
  _Financialaccountingtest8State createState() =>
      _Financialaccountingtest8State();
}

class _Financialaccountingtest8State extends State<Financialaccountingtest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage9()));
              },
