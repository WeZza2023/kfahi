...
class Financialaccountingtest12 extends StatefulWidget {
  const Financialaccountingtest12({super.key});

  @override
  _Financialaccountingtest12State createState() =>
      _Financialaccountingtest12State();
}

class _Financialaccountingtest12State extends State<Financialaccountingtest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Financialaccountingpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Financialaccountingpage13()));
              },
