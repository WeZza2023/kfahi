...
import 'Taxaccountingpage12.dart';
import 'Taxaccountingpage13.dart';

class Taxaccountingtest12 extends StatefulWidget {
  const Taxaccountingtest12({super.key});

  @override
  Taxaccountingtest12State createState() => Taxaccountingtest12State();
}

class Taxaccountingtest12State extends State<Taxaccountingtest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage12(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage13()));
              },
