...
import 'Taxaccountingpage10.dart';
import 'Taxaccountingpage11.dart';

class Taxaccountingtest10 extends StatefulWidget {
  const Taxaccountingtest10({super.key});

  @override
  Taxaccountingtest10State createState() => Taxaccountingtest10State();
}

class Taxaccountingtest10State extends State<Taxaccountingtest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage10(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage11()));
              },
