...
import 'Taxaccountingpage6.dart';
import 'Taxaccountingpage7.dart';

class Taxaccountingtest6 extends StatefulWidget {
  const Taxaccountingtest6({super.key});

  @override
  Taxaccountingtest6State createState() => Taxaccountingtest6State();
}

class Taxaccountingtest6State extends State<Taxaccountingtest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage6(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage7()));
              },
