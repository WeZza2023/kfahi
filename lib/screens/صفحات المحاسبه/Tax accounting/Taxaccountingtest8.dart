...
import 'Taxaccountingpage8.dart';
import 'Taxaccountingpage9.dart';

class Taxaccountingtest8 extends StatefulWidget {
  const Taxaccountingtest8({super.key});

  @override
  Taxaccountingtest8State createState() => Taxaccountingtest8State();
}

class Taxaccountingtest8State extends State<Taxaccountingtest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage8(),
        ),
      );
    }
