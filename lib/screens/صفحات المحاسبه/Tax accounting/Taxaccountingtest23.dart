...
import 'Taxaccountingpage23.dart';
import 'Taxaccountingpage24.dart';

class Taxaccountingtest23 extends StatefulWidget {
  const Taxaccountingtest23({super.key});

  @override
  Taxaccountingtest23State createState() => Taxaccountingtest23State();
}

class Taxaccountingtest23State extends State<Taxaccountingtest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage23(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage24()));
              },
