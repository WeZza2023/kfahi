...
import 'Taxaccountingpage18.dart';
import 'Taxaccountingpage19.dart';

class Taxaccountingtest18 extends StatefulWidget {
  const Taxaccountingtest18({super.key});

  @override
  Taxaccountingtest18State createState() => Taxaccountingtest18State();
}

class Taxaccountingtest18State extends State<Taxaccountingtest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage18(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage19()));
              },
