...
import 'Taxaccountingpage2.dart';
import 'Taxaccountingpage3.dart';

class Taxaccountingtest2 extends StatefulWidget {
  const Taxaccountingtest2({super.key});

  @override
  Taxaccountingtest2State createState() => Taxaccountingtest2State();
}

class Taxaccountingtest2State extends State<Taxaccountingtest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage2(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage3()));
              },
