...
import 'Taxaccountingpage9.dart';

class Taxaccountingtest9 extends StatefulWidget {
  const Taxaccountingtest9({super.key});

  @override
  Taxaccountingtest9State createState() => Taxaccountingtest9State();
}

class Taxaccountingtest9State extends State<Taxaccountingtest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage9(),
        ),
      );
    }
