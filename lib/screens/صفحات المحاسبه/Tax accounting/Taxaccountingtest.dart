...
class TaxAccountingTest extends StatefulWidget {
  const TaxAccountingTest({super.key});

  @override
  _TaxAccountingTestState createState() => _TaxAccountingTestState();
}

class _TaxAccountingTestState extends State<TaxAccountingTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(TaxAccQues)
      ..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار Tax Accounting'),
      ),
      body: Center(
        child: Column(
