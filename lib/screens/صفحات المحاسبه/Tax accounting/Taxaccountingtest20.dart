...
import 'Taxaccountingpage20.dart';
import 'Taxaccountingpage21.dart';

class Taxaccountingtest20 extends StatefulWidget {
  const Taxaccountingtest20({super.key});

  @override
  Taxaccountingtest20State createState() => Taxaccountingtest20State();
}

class Taxaccountingtest20State extends State<Taxaccountingtest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage20(),
        ),
      );
    }
