...
import 'Taxaccountingpage25.dart';
import 'Taxaccountingpage26.dart';

class Taxaccountingtest25 extends StatefulWidget {
  const Taxaccountingtest25({super.key});

  @override
  Taxaccountingtest25State createState() => Taxaccountingtest25State();
}

class Taxaccountingtest25State extends State<Taxaccountingtest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage25(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage26()));
              },
