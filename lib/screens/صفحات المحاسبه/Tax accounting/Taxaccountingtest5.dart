...
import 'Taxaccountingpage5.dart';
import 'Taxaccountingpage6.dart';

class Taxaccountingtest5 extends StatefulWidget {
  const Taxaccountingtest5({super.key});

  @override
  Taxaccountingtest5State createState() => Taxaccountingtest5State();
}

class Taxaccountingtest5State extends State<Taxaccountingtest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage5(),
        ),
      );
    }
