...
class Taxaccountingtest26 extends StatefulWidget {
  const Taxaccountingtest26({super.key});

  @override
  _Taxaccountingtest26State createState() => _Taxaccountingtest26State();
}

class _Taxaccountingtest26State extends State<Taxaccountingtest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Taxaccountingpage26()));
    }
