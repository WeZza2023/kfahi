...
import 'Taxaccountingpage15.dart';
import 'Taxaccountingpage16.dart';

class Taxaccountingtest15 extends StatefulWidget {
  const Taxaccountingtest15({super.key});

  @override
  Taxaccountingtest15State createState() => Taxaccountingtest15State();
}

class Taxaccountingtest15State extends State<Taxaccountingtest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage15(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage16()));
              },
