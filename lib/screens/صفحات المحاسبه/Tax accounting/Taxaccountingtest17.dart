...
import 'Taxaccountingpage17.dart';
import 'Taxaccountingpage18.dart';

class Taxaccountingtest17 extends StatefulWidget {
  const Taxaccountingtest17({super.key});

  @override
  Taxaccountingtest17State createState() => Taxaccountingtest17State();
}

class Taxaccountingtest17State extends State<Taxaccountingtest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage17(),
        ),
      );
    }
