...
import 'Taxaccountingpage21.dart';
import 'Taxaccountingpage22.dart';

class Taxaccountingtest21 extends StatefulWidget {
  const Taxaccountingtest21({super.key});

  @override
  Taxaccountingtest21State createState() => Taxaccountingtest21State();
}

class Taxaccountingtest21State extends State<Taxaccountingtest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const Taxaccountingpage21(),
        ),
      );
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Taxaccountingpage22()));
              },
