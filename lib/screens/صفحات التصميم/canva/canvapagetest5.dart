...
import 'canvapage6.dart';

class canvapagetest5 extends StatefulWidget {
  const canvapagetest5({super.key});

  @override
  _canvapagetest5State createState() => _canvapagetest5State();
}

class _canvapagetest5State extends State<canvapagetest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage6()));
              },
