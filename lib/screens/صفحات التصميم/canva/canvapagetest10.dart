...
import 'canvapage10.dart';
import 'canvapage11.dart';

class canvapagetest10 extends StatefulWidget {
  const canvapagetest10({super.key});

  @override
  _canvapagetest10State createState() => _canvapagetest10State();
}

class _canvapagetest10State extends State<canvapagetest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage11()));
              },
