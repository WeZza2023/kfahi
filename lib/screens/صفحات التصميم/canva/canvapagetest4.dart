...
import 'canvapage4.dart';
import 'canvapage5.dart';

class canvapagetest4 extends StatefulWidget {
  const canvapagetest4({super.key});

  @override
  _canvapagetest4State createState() => _canvapagetest4State();
}

class _canvapagetest4State extends State<canvapagetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage5()));
              },
