...
class canvapagetest13 extends StatefulWidget {
  const canvapagetest13({super.key});

  @override
  _canvapagetest13State createState() => _canvapagetest13State();
}

class _canvapagetest13State extends State<canvapagetest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage13()));
    }
