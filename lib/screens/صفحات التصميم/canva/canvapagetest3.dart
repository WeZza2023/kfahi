...
import 'canvapage3.dart';
import 'canvapage4.dart';

class canvapagetest3 extends StatefulWidget {
  const canvapagetest3({super.key});

  @override
  _canvapagetest3State createState() => _canvapagetest3State();
}

class _canvapagetest3State extends State<canvapagetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage4()));
              },
