...
class CanvaPagetest extends StatefulWidget {
  const CanvaPagetest({super.key});

  @override
  _CanvaPagetestState createState() => _CanvaPagetestState();
}

class _CanvaPagetestState extends State<CanvaPagetest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(CanvaQues)
      ..shuffle(random);
