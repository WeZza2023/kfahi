...
import 'canvapage11.dart';
import 'canvapage12.dart';

class canvapagetest11 extends StatefulWidget {
  const canvapagetest11({super.key});

  @override
  _canvapagetest11State createState() => _canvapagetest11State();
}

class _canvapagetest11State extends State<canvapagetest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage12()));
              },
