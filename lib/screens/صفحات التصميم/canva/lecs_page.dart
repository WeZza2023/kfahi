...
class CanvaLecsPage extends StatefulWidget {
  CanvaLecsPage({super.key});

  @override
  State<CanvaLecsPage> createState() => _CanvaLecsPageState();
}

class _CanvaLecsPageState extends State<CanvaLecsPage> {
