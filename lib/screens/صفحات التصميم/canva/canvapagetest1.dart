...
import 'canvapage.dart';
import 'canvapage2.dart';

class canvapagetest1 extends StatefulWidget {
  const canvapagetest1({super.key});

  @override
  _canvapagetest1State createState() => _canvapagetest1State();
}

class _canvapagetest1State extends State<canvapagetest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage2()));
              },
