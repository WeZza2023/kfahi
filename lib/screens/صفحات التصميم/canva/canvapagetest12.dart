...
import 'canvapage13.dart';

class canvapagetest12 extends StatefulWidget {
  const canvapagetest12({super.key});

  @override
  _canvapagetest12State createState() => _canvapagetest12State();
}

class _canvapagetest12State extends State<canvapagetest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage13()));
              },
