...
class canvapagetest8 extends StatefulWidget {
  const canvapagetest8({super.key});

  @override
  _canvapagetest8State createState() => _canvapagetest8State();
}

class _canvapagetest8State extends State<canvapagetest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage9()));
              },
