...
import 'canvapagetest3.dart';

class canvapage3 extends StatefulWidget {
  const canvapage3({super.key});

  @override
  _canvapage3State createState() => _canvapage3State();
}

class _canvapage3State extends State<canvapage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '7qJeRh7InZs', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const canvapagetest3(),
          ),
        );
      }
    });
