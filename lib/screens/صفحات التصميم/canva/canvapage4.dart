...
import 'canvapagetest4.dart';

class canvapage4 extends StatefulWidget {
  const canvapage4({super.key});

  @override
  _canvapage4State createState() => _canvapage4State();
}

class _canvapage4State extends State<canvapage4> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'pySVyu0_NvQ', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const canvapagetest4(),
          ),
        );
      }
    });
