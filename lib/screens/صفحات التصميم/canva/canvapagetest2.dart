...
import 'canvapage2.dart';
import 'canvapage3.dart';

class canvapagetest2 extends StatefulWidget {
  const canvapagetest2({super.key});

  @override
  _canvapagetest2State createState() => _canvapagetest2State();
}

class _canvapagetest2State extends State<canvapagetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage3()));
              },
