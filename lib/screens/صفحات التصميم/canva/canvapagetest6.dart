...
class canvapagetest6 extends StatefulWidget {
  const canvapagetest6({super.key});

  @override
  _canvapagetest6State createState() => _canvapagetest6State();
}

class _canvapagetest6State extends State<canvapagetest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage7()));
              },
