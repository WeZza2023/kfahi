...
import 'canvapage9.dart';

class canvapagetest9 extends StatefulWidget {
  const canvapagetest9({super.key});

  @override
  _canvapagetest9State createState() => _canvapagetest9State();
}

class _canvapagetest9State extends State<canvapagetest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage10()));
              },
