...
import 'canvapage7.dart';
import 'canvapage8.dart';

class canvapagetest7 extends StatefulWidget {
  const canvapagetest7({super.key});

  @override
  _canvapagetest7State createState() => _canvapagetest7State();
}

class _canvapagetest7State extends State<canvapagetest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const canvapage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const canvapage8()));
              },
