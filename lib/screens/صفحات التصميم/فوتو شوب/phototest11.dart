...
import 'photopage12.dart';

class phototest11 extends StatefulWidget {
  const phototest11({super.key});

  @override
  _phototest11State createState() => _phototest11State();
}

class _phototest11State extends State<phototest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage12()));
              },
