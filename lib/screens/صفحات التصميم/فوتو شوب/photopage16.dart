...
import 'phototest16.dart';

class photopage16 extends StatefulWidget {
  const photopage16({super.key});

  @override
  _photopage16State createState() => _photopage16State();
}

class _photopage16State extends State<photopage16> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'gzKazjXRvhk', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest16(),
          ),
        );
      }
    });
