...
import 'photopage8.dart';

class phototest7 extends StatefulWidget {
  const phototest7({super.key});

  @override
  _phototest7State createState() => _phototest7State();
}

class _phototest7State extends State<phototest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage8()));
              },
