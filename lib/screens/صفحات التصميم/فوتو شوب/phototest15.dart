...
class phototest15 extends StatefulWidget {
  const phototest15({super.key});

  @override
  _phototest15State createState() => _phototest15State();
}

class _phototest15State extends State<phototest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage16()));
              },
