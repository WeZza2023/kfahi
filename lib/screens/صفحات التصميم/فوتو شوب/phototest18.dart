...
class phototest18 extends StatefulWidget {
  const phototest18({super.key});

  @override
  _phototest18State createState() => _phototest18State();
}

class _phototest18State extends State<phototest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage19()));
              },
