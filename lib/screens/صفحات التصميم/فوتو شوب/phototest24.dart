...
import 'photopage24.dart';
import 'photopage25.dart';

class phototest24 extends StatefulWidget {
  const phototest24({super.key});

  @override
  _phototest24State createState() => _phototest24State();
}

class _phototest24State extends State<phototest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage25()));
              },
