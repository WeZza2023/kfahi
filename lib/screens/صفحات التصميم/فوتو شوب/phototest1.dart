...
class phototest1 extends StatefulWidget {
  const phototest1({super.key});

  @override
  _phototest1State createState() => _phototest1State();
}

class _phototest1State extends State<phototest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage2()));
              },
