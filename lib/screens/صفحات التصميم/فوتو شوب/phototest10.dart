...
import 'photopage10.dart';
import 'photopage11.dart';

class phototest10 extends StatefulWidget {
  const phototest10({super.key});

  @override
  _phototest10State createState() => _phototest10State();
}

class _phototest10State extends State<phototest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage11()));
              },
