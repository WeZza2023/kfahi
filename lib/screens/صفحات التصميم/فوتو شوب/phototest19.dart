...
import 'photopage19.dart';
import 'photopage20.dart';

class phototest19 extends StatefulWidget {
  const phototest19({super.key});

  @override
  _phototest19State createState() => _phototest19State();
}

class _phototest19State extends State<phototest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage20()));
              },
