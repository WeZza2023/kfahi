...
import 'phototest2.dart';

class photopage2 extends StatefulWidget {
  const photopage2({super.key});

  @override
  _photopage2State createState() => _photopage2State();
}
...
class _photopage2State extends State<photopage2> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'h1pmlI7l8zQ', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest2(),
          ),
        );
      }
    });
