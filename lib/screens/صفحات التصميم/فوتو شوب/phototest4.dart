...
import 'photopage5.dart';

class phototest4 extends StatefulWidget {
  const phototest4({super.key});

  @override
  _phototest4State createState() => _phototest4State();
}

class _phototest4State extends State<phototest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage5()));
              },
