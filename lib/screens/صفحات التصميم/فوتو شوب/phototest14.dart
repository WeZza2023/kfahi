...
import 'photopage15.dart';

class phototest14 extends StatefulWidget {
  const phototest14({super.key});

  @override
  _phototest14State createState() => _phototest14State();
}

class _phototest14State extends State<phototest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage15()));
              },
