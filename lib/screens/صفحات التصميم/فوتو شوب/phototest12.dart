...
class phototest12 extends StatefulWidget {
  const phototest12({super.key});

  @override
  _phototest12State createState() => _phototest12State();
}

class _phototest12State extends State<phototest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage13()));
              },
