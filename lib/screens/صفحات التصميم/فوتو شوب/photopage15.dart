...
import 'phototest15.dart';

class photopage15 extends StatefulWidget {
  const photopage15({super.key});

  @override
  _photopage15State createState() => _photopage15State();
}

class _photopage15State extends State<photopage15> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'Mq84GEmMlRc', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest15(),
          ),
        );
      }
    });
