...
import 'phototest3.dart';

class photopage3 extends StatefulWidget {
  const photopage3({super.key});

  @override
  _photopage3State createState() => _photopage3State();
}
...
class _photopage3State extends State<photopage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'b5Wzcbie_Y8', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest3(),
          ),
        );
      }
    });
