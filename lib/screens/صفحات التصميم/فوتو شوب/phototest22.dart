...
import 'photopage23.dart';

class phototest22 extends StatefulWidget {
  const phototest22({super.key});

  @override
  _phototest22State createState() => _phototest22State();
}

class _phototest22State extends State<phototest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage23()));
              },
