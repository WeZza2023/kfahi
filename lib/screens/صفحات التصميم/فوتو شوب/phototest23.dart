...
class phototest23 extends StatefulWidget {
  const phototest23({super.key});

  @override
  _phototest23State createState() => _phototest23State();
}

class _phototest23State extends State<phototest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage24()));
              },
