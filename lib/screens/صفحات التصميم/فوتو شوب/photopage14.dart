...
import 'phototest14.dart';

class photopage14 extends StatefulWidget {
  const photopage14({super.key});

  @override
  _photopage14State createState() => _photopage14State();
}

class _photopage14State extends State<photopage14> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'PQjZKRpvyc8', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest14(),
          ),
        );
      }
    });
