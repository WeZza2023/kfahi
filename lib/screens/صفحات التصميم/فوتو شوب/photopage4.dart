...
import 'phototest4.dart';

class photopage4 extends StatefulWidget {
  const photopage4({super.key});

  @override
  _photopage4State createState() => _photopage4State();
}

class _photopage4State extends State<photopage4> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'qZlYrz8bEdI', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest4(),
          ),
        );
      }
    });
