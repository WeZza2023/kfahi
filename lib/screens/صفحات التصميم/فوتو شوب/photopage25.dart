...
import 'phototest25.dart';

class photopage25 extends StatefulWidget {
  const photopage25({super.key});

  @override
  _photopage25State createState() => _photopage25State();
}

class _photopage25State extends State<photopage25> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'MnG2do39DkI', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest25(),
          ),
        );
      }
    });
