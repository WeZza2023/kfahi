...
import 'photopage6.dart';
import 'photopage7.dart';

class phototest6 extends StatefulWidget {
  const phototest6({super.key});

  @override
  _phototest6State createState() => _phototest6State();
}

class _phototest6State extends State<phototest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage7()));
              },
