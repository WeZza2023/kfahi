...
import 'photopage9.dart';

class phototest9 extends StatefulWidget {
  const phototest9({super.key});

  @override
  _phototest9State createState() => _phototest9State();
}

class _phototest9State extends State<phototest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage10()));
              },
