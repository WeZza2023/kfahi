...
import 'phototest17.dart';

class photopage17 extends StatefulWidget {
  const photopage17({super.key});

  @override
  _photopage17State createState() => _photopage17State();
}

class _photopage17State extends State<photopage17> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'PxMNfNwgfD0', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest17(),
          ),
        );
      }
    });
