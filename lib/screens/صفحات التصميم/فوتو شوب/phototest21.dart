...
import 'photopage21.dart';
import 'photopage22.dart';

class phototest21 extends StatefulWidget {
  const phototest21({super.key});

  @override
  _phototest21State createState() => _phototest21State();
}

class _phototest21State extends State<phototest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage22()));
              },
