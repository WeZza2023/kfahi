...
class phototest5 extends StatefulWidget {
  const phototest5({super.key});

  @override
  _phototest5State createState() => _phototest5State();
}

class _phototest5State extends State<phototest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage6()));
              },
