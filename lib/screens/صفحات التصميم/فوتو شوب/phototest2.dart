...
import 'photopage2.dart';
import 'photopage3.dart';

class phototest2 extends StatefulWidget {
  const phototest2({super.key});

  @override
  _phototest2State createState() => _phototest2State();
}

class _phototest2State extends State<phototest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage3()));
              },
