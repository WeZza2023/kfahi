...
import 'photopage13.dart';
import 'photopage14.dart';

class phototest13 extends StatefulWidget {
  const phototest13({super.key});

  @override
  _phototest13State createState() => _phototest13State();
}

class _phototest13State extends State<phototest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage14()));
              },
