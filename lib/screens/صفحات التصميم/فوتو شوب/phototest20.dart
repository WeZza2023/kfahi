...
class phototest20 extends StatefulWidget {
  const phototest20({super.key});

  @override
  _phototest20State createState() => _phototest20State();
}

class _phototest20State extends State<phototest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage21()));
              },
