...
import 'photopage16.dart';
import 'photopage17.dart';

class phototest16 extends StatefulWidget {
  const phototest16({super.key});

  @override
  _phototest16State createState() => _phototest16State();
}

class _phototest16State extends State<phototest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage17()));
              },
