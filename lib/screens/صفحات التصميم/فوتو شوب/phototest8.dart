...
class phototest8 extends StatefulWidget {
  const phototest8({super.key});

  @override
  _phototest8State createState() => _phototest8State();
}

class _phototest8State extends State<phototest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage9()));
              },
