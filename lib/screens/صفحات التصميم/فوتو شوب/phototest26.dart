...
class phototest26 extends StatefulWidget {
  const phototest26({super.key});

  @override
  _phototest26State createState() => _phototest26State();
}

class _phototest26State extends State<phototest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage26()));
    }
