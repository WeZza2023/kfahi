...
import 'phototest8.dart';

class photopage8 extends StatefulWidget {
  const photopage8({super.key});

  @override
  _photopage8State createState() => _photopage8State();
}

class _photopage8State extends State<photopage8> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '3HWI8zHv8ZI', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest8(),
          ),
        );
      }
    });
