...
import 'phototest6.dart';

class photopage6 extends StatefulWidget {
  const photopage6({super.key});

  @override
  _photopage6State createState() => _photopage6State();
}

class _photopage6State extends State<photopage6> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'DH8vLmknJ6I', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest6(),
          ),
        );
      }
    });
