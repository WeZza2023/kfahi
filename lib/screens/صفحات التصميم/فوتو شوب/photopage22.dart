...
import 'phototest22.dart';

class photopage22 extends StatefulWidget {
  const photopage22({super.key});

  @override
  _photopage22State createState() => _photopage22State();
}

class _photopage22State extends State<photopage22> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'PNY5NQ1YnEs', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const phototest22(),
          ),
        );
      }
    });
