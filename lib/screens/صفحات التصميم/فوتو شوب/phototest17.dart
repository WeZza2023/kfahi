...
import 'photopage17.dart';
import 'photopage18.dart';

class phototest17 extends StatefulWidget {
  const phototest17({super.key});

  @override
  _phototest17State createState() => _phototest17State();
}

class _phototest17State extends State<phototest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const photopage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const photopage18()));
              },
