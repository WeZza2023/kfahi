...
class PhotoShopTest extends StatefulWidget {
  const PhotoShopTest({super.key});

  @override
  _PhotoShopTestState createState() => _PhotoShopTestState();
}

class _PhotoShopTestState extends State<PhotoShopTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(PhotoShopQues)
      ..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار PhotoShop'),
      ),
      body: Center(
        child: Column(
