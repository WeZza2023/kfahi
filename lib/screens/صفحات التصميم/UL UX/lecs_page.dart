...
class UIUXLecsPage extends StatefulWidget {
  UIUXLecsPage({super.key});

  @override
  State<UIUXLecsPage> createState() => _UIUXLecsPageState();
}

class _UIUXLecsPageState extends State<UIUXLecsPage> {
