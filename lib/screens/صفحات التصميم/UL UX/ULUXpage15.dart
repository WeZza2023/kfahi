...
import 'ULUXtest15.dart';

class ULUXpage15 extends StatefulWidget {
  const ULUXpage15({super.key});

  @override
  _ULUXpage15State createState() => _ULUXpage15State();
}

class _ULUXpage15State extends State<ULUXpage15> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'y56NUWaTB7Q', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest15(),
          ),
        );
      }
    });
