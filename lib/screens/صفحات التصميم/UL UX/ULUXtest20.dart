...
class ULUXtest20 extends StatefulWidget {
  const ULUXtest20({super.key});

  @override
  _ULUXtest20State createState() => _ULUXtest20State();
}

class _ULUXtest20State extends State<ULUXtest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage21()));
              },
