...
class ULUXtest17 extends StatefulWidget {
  const ULUXtest17({super.key});

  @override
  _ULUXtest17State createState() => _ULUXtest17State();
}

class _ULUXtest17State extends State<ULUXtest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage18()));
              },
