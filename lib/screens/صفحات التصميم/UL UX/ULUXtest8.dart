...
class ULUXtest8 extends StatefulWidget {
  const ULUXtest8({super.key});

  @override
  _ULUXtest8State createState() => _ULUXtest8State();
}

class _ULUXtest8State extends State<ULUXtest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage9()));
              },
