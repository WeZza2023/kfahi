...
import 'ULUXpage10.dart';
import 'ULUXpage11.dart';

class ULUXtest10 extends StatefulWidget {
  const ULUXtest10({super.key});

  @override
  _ULUXtest10State createState() => _ULUXtest10State();
}

class _ULUXtest10State extends State<ULUXtest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage11()));
              },
