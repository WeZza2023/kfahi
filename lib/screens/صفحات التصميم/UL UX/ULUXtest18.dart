...
import 'ULUXpage18.dart';
import 'ULUXpage19.dart';

class ULUXtest18 extends StatefulWidget {
  const ULUXtest18({super.key});

  @override
  _ULUXtest18State createState() => _ULUXtest18State();
}

class _ULUXtest18State extends State<ULUXtest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage19()));
              },
