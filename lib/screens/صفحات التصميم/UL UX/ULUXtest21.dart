...
import 'ULUXpage21.dart';
import 'ULUXpage22.dart';

class ULUXtest21 extends StatefulWidget {
  const ULUXtest21({super.key});

  @override
  _ULUXtest21State createState() => _ULUXtest21State();
}

class _ULUXtest21State extends State<ULUXtest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage22()));
              },
