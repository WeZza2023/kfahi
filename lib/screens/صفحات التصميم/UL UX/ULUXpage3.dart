...
import 'ULUXtest3.dart';

class ULUXpage3 extends StatefulWidget {
  const ULUXpage3({super.key});

  @override
  _ULUXpage3State createState() => _ULUXpage3State();
}

class _ULUXpage3State extends State<ULUXpage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'cbqJ7knGBZo', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest3(),
          ),
        );
      }
    });
