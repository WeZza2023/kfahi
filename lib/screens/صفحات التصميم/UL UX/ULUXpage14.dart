...
import 'ULUXtest14.dart';

class ULUXpage14 extends StatefulWidget {
  const ULUXpage14({super.key});

  @override
  _ULUXpage14State createState() => _ULUXpage14State();
}

class _ULUXpage14State extends State<ULUXpage14> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'CbpyrtdnAq4', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest14(),
          ),
        );
      }
    });
