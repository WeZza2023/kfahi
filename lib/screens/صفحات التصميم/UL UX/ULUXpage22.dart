...
import 'ULUXtest22.dart';

class ULUXpage22 extends StatefulWidget {
  const ULUXpage22({super.key});

  @override
  _ULUXpage22State createState() => _ULUXpage22State();
}

class _ULUXpage22State extends State<ULUXpage22> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'npQvy8IB64o', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest22(),
          ),
        );
      }
    });
