...
import 'ULUXpage22.dart';
import 'ULUXpage23.dart';

class ULUXtest22 extends StatefulWidget {
  const ULUXtest22({super.key});

  @override
  _ULUXtest22State createState() => _ULUXtest22State();
}

class _ULUXtest22State extends State<ULUXtest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage23()));
              },
