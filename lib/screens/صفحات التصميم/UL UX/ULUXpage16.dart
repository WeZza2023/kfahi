...
import 'ULUXtest16.dart';

class ULUXpage16 extends StatefulWidget {
  const ULUXpage16({super.key});

  @override
  _ULUXpage16State createState() => _ULUXpage16State();
}

class _ULUXpage16State extends State<ULUXpage16> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'CA6hFqWG7is', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest16(),
          ),
        );
      }
    });
