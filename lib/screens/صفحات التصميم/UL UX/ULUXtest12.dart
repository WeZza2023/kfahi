...
class ULUXtest12 extends StatefulWidget {
  const ULUXtest12({super.key});

  @override
  _ULUXtest12State createState() => _ULUXtest12State();
}

class _ULUXtest12State extends State<ULUXtest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage13()));
              },
