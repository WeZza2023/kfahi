...
import 'ULUXpage24.dart';

class ULUXtest23 extends StatefulWidget {
  const ULUXtest23({super.key});

  @override
  _ULUXtest23State createState() => _ULUXtest23State();
}

class _ULUXtest23State extends State<ULUXtest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage24()));
              },
