...
import 'ULUXpage19.dart';
import 'ULUXpage20.dart';

class ULUXtest19 extends StatefulWidget {
  const ULUXtest19({super.key});

  @override
  _ULUXtest19State createState() => _ULUXtest19State();
}

class _ULUXtest19State extends State<ULUXtest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage20()));
              },
