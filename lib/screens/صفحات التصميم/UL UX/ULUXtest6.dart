...
class ULUXtest6 extends StatefulWidget {
  const ULUXtest6({super.key});

  @override
  _ULUXtest6State createState() => _ULUXtest6State();
}

class _ULUXtest6State extends State<ULUXtest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage7()));
              },
