...
class ULUXtest24 extends StatefulWidget {
  const ULUXtest24({super.key});

  @override
  _ULUXtest24State createState() => _ULUXtest24State();
}

class _ULUXtest24State extends State<ULUXtest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage24()));
    }
