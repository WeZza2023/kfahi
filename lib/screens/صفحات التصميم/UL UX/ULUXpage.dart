...
import 'ULUXtest1.dart';

class ULUXpage extends StatefulWidget {
  const ULUXpage({super.key});

  @override
  _ULUXpageState createState() => _ULUXpageState();
}

class _ULUXpageState extends State<ULUXpage> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'ZQObK6XkGHE', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest1(),
          ),
        );
      }
    });
