...
import 'ULUXpage4.dart';
import 'ULUXpage5.dart';

class ULUXtest4 extends StatefulWidget {
  const ULUXtest4({super.key});

  @override
  _ULUXtest4State createState() => _ULUXtest4State();
}

class _ULUXtest4State extends State<ULUXtest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage5()));
              },
