...
import 'ULUXpage15.dart';
import 'ULUXpage16.dart';

class ULUXtest15 extends StatefulWidget {
  const ULUXtest15({super.key});

  @override
  _ULUXtest15State createState() => _ULUXtest15State();
}

class _ULUXtest15State extends State<ULUXtest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage16()));
              },
