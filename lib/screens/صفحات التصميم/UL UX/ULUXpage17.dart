...
import 'ULUXtest17.dart';

class ULUXpage17 extends StatefulWidget {
  const ULUXpage17({super.key});

  @override
  _ULUXpage17State createState() => _ULUXpage17State();
}

class _ULUXpage17State extends State<ULUXpage17> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '6Ye_18Fy2Uc', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest17(),
          ),
        );
      }
    });
