...
import 'ULUXpage13.dart';
import 'ULUXpage14.dart';

class ULUXtest13 extends StatefulWidget {
  const ULUXtest13({super.key});

  @override
  _ULUXtest13State createState() => _ULUXtest13State();
}

class _ULUXtest13State extends State<ULUXtest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage14()));
              },
