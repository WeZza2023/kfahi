...
import 'ULUXtest20.dart';

class ULUXpage20 extends StatefulWidget {
  const ULUXpage20({super.key});

  @override
  _ULUXpage20State createState() => _ULUXpage20State();
}

class _ULUXpage20State extends State<ULUXpage20> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'Zs5pSicJQvM', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest20(),
          ),
        );
      }
    });
