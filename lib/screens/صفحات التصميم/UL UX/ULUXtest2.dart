...
import 'ULUXpage2.dart';
import 'ULUXpage3.dart';

class ULUXtest2 extends StatefulWidget {
  const ULUXtest2({super.key});

  @override
  _ULUXtest2State createState() => _ULUXtest2State();
}

class _ULUXtest2State extends State<ULUXtest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage3()));
              },
