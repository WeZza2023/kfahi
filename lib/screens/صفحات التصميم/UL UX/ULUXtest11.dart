...
import 'ULUXpage12.dart';

class ULUXtest11 extends StatefulWidget {
  const ULUXtest11({super.key});

  @override
  _ULUXtest11State createState() => _ULUXtest11State();
}

class _ULUXtest11State extends State<ULUXtest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage12()));
              },
