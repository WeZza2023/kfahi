...
import 'ULUXpage7.dart';
import 'ULUXpage8.dart';

class ULUXtest7 extends StatefulWidget {
  const ULUXtest7({super.key});

  @override
  _ULUXtest7State createState() => _ULUXtest7State();
}

class _ULUXtest7State extends State<ULUXtest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage8()));
              },
