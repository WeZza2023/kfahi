...
import 'ULUXpage6.dart';

class ULUXtest5 extends StatefulWidget {
  const ULUXtest5({super.key});

  @override
  _ULUXtest5State createState() => _ULUXtest5State();
}

class _ULUXtest5State extends State<ULUXtest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage6()));
              },
