...
import 'ULUXpage16.dart';
import 'ULUXpage17.dart';

class ULUXtest16 extends StatefulWidget {
  const ULUXtest16({super.key});

  @override
  _ULUXtest16State createState() => _ULUXtest16State();
}

class _ULUXtest16State extends State<ULUXtest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage17()));
              },
