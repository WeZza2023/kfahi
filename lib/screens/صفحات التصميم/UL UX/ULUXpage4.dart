...
import 'ULUXtest4.dart';

class ULUXpage4 extends StatefulWidget {
  const ULUXpage4({super.key});

  @override
  _ULUXpage4State createState() => _ULUXpage4State();
}

class _ULUXpage4State extends State<ULUXpage4> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'th1IuhJBoAA', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest4(),
          ),
        );
      }
    });
