...
import 'ULUXtest6.dart';

class ULUXpage6 extends StatefulWidget {
  const ULUXpage6({super.key});

  @override
  _ULUXpage6State createState() => _ULUXpage6State();
}

class _ULUXpage6State extends State<ULUXpage6> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'IWU7160UGlY', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const ULUXtest6(),
          ),
        );
      }
    });
