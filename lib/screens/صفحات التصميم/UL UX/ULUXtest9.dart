...
import 'ULUXpage9.dart';

class ULUXtest9 extends StatefulWidget {
  const ULUXtest9({super.key});

  @override
  _ULUXtest9State createState() => _ULUXtest9State();
}

class _ULUXtest9State extends State<ULUXtest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage10()));
              },
