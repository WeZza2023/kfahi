...
class UiUxTest extends StatefulWidget {
  const UiUxTest({super.key});

  @override
  _UiUxTestState createState() => _UiUxTestState();
}

class _UiUxTestState extends State<UiUxTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(UIUXQues)
      ..shuffle(random);
