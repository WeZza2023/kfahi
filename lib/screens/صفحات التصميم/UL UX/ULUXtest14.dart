...
class ULUXtest14 extends StatefulWidget {
  const ULUXtest14({super.key});

  @override
  _ULUXtest14State createState() => _ULUXtest14State();
}

class _ULUXtest14State extends State<ULUXtest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage15()));
              },
