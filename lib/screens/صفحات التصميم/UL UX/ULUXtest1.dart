...
import 'ULUXpage.dart';
import 'ULUXpage2.dart';

class ULUXtest1 extends StatefulWidget {
  const ULUXtest1({super.key});

  @override
  _ULUXtest1State createState() => _ULUXtest1State();
}

class _ULUXtest1State extends State<ULUXtest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage2()));
              },
