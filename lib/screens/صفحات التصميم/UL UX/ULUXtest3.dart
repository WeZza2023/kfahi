...
class ULUXtest3 extends StatefulWidget {
  const ULUXtest3({super.key});

  @override
  _ULUXtest3State createState() => _ULUXtest3State();
}

class _ULUXtest3State extends State<ULUXtest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ULUXpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ULUXpage4()));
              },
