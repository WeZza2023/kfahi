...
import 'Leadershippage4.dart';
import 'Leadershippage5.dart';

class Leadershiptest4 extends StatefulWidget {
  const Leadershiptest4({super.key});

  @override
  _Leadershiptest4State createState() => _Leadershiptest4State();
}

class _Leadershiptest4State extends State<Leadershiptest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const Leadershippage5()));
              },
