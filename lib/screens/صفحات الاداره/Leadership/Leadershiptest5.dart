...
import 'Leadershippage6.dart';

class Leadershiptest5 extends StatefulWidget {
  const Leadershiptest5({super.key});

  @override
  _Leadershiptest5State createState() => _Leadershiptest5State();
}

class _Leadershiptest5State extends State<Leadershiptest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const Leadershippage6()));
              },
