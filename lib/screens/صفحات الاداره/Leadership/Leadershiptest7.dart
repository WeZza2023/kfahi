...
class Leadershiptest7 extends StatefulWidget {
  const Leadershiptest7({super.key});

  @override
  _Leadershiptest7State createState() => _Leadershiptest7State();
}

class _Leadershiptest7State extends State<Leadershiptest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const Leadershippage8()));
              },
