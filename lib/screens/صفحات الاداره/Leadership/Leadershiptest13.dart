...
import 'Leadershippage13.dart';
import 'Leadershippage14.dart';

class Leadershiptest13 extends StatefulWidget {
  const Leadershiptest13({super.key});

  @override
  _Leadershiptest13State createState() => _Leadershiptest13State();
}

class _Leadershiptest13State extends State<Leadershiptest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Leadershippage14()));
              },
