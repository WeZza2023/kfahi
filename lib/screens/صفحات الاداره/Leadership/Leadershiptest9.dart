...
class Leadershiptest9 extends StatefulWidget {
  const Leadershiptest9({super.key});

  @override
  _Leadershiptest9State createState() => _Leadershiptest9State();
}

class _Leadershiptest9State extends State<Leadershiptest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Leadershippage10()));
              },
