...
import 'Leadershippage7.dart';

class Leadershiptest6 extends StatefulWidget {
  const Leadershiptest6({super.key});

  @override
  _Leadershiptest6State createState() => _Leadershiptest6State();
}

class _Leadershiptest6State extends State<Leadershiptest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const Leadershippage7()));
              },
