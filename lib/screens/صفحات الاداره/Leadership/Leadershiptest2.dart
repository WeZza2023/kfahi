...
import 'Leadershippage2.dart';
import 'Leadershippage3.dart';

class Leadershiptest2 extends StatefulWidget {
  const Leadershiptest2({super.key});

  @override
  _Leadershiptest2State createState() => _Leadershiptest2State();
}

class _Leadershiptest2State extends State<Leadershiptest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const Leadershippage3()));
              },
