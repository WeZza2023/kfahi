...
class Leadershiptest15 extends StatefulWidget {
  const Leadershiptest15({super.key});

  @override
  _Leadershiptest15State createState() => _Leadershiptest15State();
}

class _Leadershiptest15State extends State<Leadershiptest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage15()));
    }
