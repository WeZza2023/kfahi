...
import 'Leadershippage11.dart';
import 'Leadershippage12.dart';

class Leadershiptest11 extends StatefulWidget {
  const Leadershiptest11({super.key});

  @override
  _Leadershiptest11State createState() => _Leadershiptest11State();
}

class _Leadershiptest11State extends State<Leadershiptest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Leadershippage12()));
              },
