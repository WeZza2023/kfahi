...
import 'Leadershippage14.dart';
import 'Leadershippage15.dart';

class Leadershiptest14 extends StatefulWidget {
  const Leadershiptest14({super.key});

  @override
  _Leadershiptest14State createState() => _Leadershiptest14State();
}

class _Leadershiptest14State extends State<Leadershiptest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Leadershippage15()));
              },
