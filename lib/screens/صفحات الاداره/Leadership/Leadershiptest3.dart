...
class Leadershiptest3 extends StatefulWidget {
  const Leadershiptest3({super.key});

  @override
  _Leadershiptest3State createState() => _Leadershiptest3State();
}

class _Leadershiptest3State extends State<Leadershiptest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const Leadershippage4()));
              },
