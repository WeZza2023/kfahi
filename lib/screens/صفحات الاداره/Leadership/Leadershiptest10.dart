...
import 'Leadershippage10.dart';
import 'Leadershippage11.dart';

class Leadershiptest10 extends StatefulWidget {
  const Leadershiptest10({super.key});

  @override
  _Leadershiptest10State createState() => _Leadershiptest10State();
}

class _Leadershiptest10State extends State<Leadershiptest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Leadershippage11()));
              },
