...
class Leadershiptest12 extends StatefulWidget {
  const Leadershiptest12({super.key});

  @override
  _Leadershiptest12State createState() => _Leadershiptest12State();
}

class _Leadershiptest12State extends State<Leadershiptest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Leadershippage13()));
              },
