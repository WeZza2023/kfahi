...
class Leadershiptest extends StatefulWidget {
  const Leadershiptest({super.key});

  @override
  _LeadershiptesttState createState() => _LeadershiptesttState();
}

class _LeadershiptesttState extends State<Leadershiptest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(LeaderShipQues)
      ..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار Leadership'),
      ),
      body: Center(
        child: Column(
