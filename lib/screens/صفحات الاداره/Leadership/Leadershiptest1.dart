...
class Leadershiptest1 extends StatefulWidget {
  const Leadershiptest1({super.key});

  @override
  _Leadershiptest1State createState() => _Leadershiptest1State();
}

class _Leadershiptest1State extends State<Leadershiptest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Leadershippage()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const Leadershippage2()));
              },
