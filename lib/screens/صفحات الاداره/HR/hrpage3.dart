...
import 'hrpagetest3.dart';

class hrpage3 extends StatefulWidget {
  const hrpage3({super.key});

  @override
  _hrpage3State createState() => _hrpage3State();
}

class _hrpage3State extends State<hrpage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'hDL-Fk7TiQE', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const hrpagetest3(),
          ),
        );
      }
    });
