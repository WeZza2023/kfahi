...
class hrpagetest3 extends StatefulWidget {
  const hrpagetest3({super.key});

  @override
  _hrpagetest3State createState() => _hrpagetest3State();
}

class _hrpagetest3State extends State<hrpagetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage4()));
              },
