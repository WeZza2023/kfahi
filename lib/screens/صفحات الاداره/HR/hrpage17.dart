...
import 'hrpagetest17.dart';

class hrpage17 extends StatefulWidget {
  const hrpage17({super.key});

  @override
  _hrpage17State createState() => _hrpage17State();
}

class _hrpage17State extends State<hrpage17> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'DuAIcCSEOX0', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const hrpagetest17(),
          ),
        );
      }
    });
