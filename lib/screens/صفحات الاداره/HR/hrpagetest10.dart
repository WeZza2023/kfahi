...
import 'hrpage10.dart';
import 'hrpage11.dart';

class hrpagetest10 extends StatefulWidget {
  const hrpagetest10({super.key});

  @override
  _hrpagetest10State createState() => _hrpagetest10State();
}

class _hrpagetest10State extends State<hrpagetest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage11()));
              },
