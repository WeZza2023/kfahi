...
import 'hrpagetest16.dart';

class hrpage16 extends StatefulWidget {
  const hrpage16({super.key});

  @override
  _hrpage16State createState() => _hrpage16State();
}

class _hrpage16State extends State<hrpage16> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'R3e4ahjaQwU', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const hrpagetest16(),
          ),
        );
      }
    });
