...
import 'hrpage13.dart';
import 'hrpage14.dart';

class hrpagetest13 extends StatefulWidget {
  const hrpagetest13({super.key});

  @override
  _hrpagetest13State createState() => _hrpagetest13State();
}

class _hrpagetest13State extends State<hrpagetest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage14()));
              },
