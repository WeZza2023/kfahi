...
import 'hrpagetest4.dart';

class hrpage4 extends StatefulWidget {
  const hrpage4({super.key});

  @override
  _hrpage4State createState() => _hrpage4State();
}

class _hrpage4State extends State<hrpage4> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'LOnhY-batEI', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const hrpagetest4(),
          ),
        );
      }
    });
