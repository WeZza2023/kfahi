...
class hrpagetest12 extends StatefulWidget {
  const hrpagetest12({super.key});

  @override
  _hrpagetest12State createState() => _hrpagetest12State();
}

class _hrpagetest12State extends State<hrpagetest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage13()));
              },
