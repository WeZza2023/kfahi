...
import 'hrpagetest14.dart';

class hrpage14 extends StatefulWidget {
  const hrpage14({super.key});

  @override
  _hrpage14State createState() => _hrpage14State();
}

class _hrpage14State extends State<hrpage14> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'Z6EJWXQ5uEE', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const hrpagetest14(),
          ),
        );
      }
    });
