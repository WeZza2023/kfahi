...
import 'hrpage14.dart';
import 'hrpage15.dart';

class hrpagetest14 extends StatefulWidget {
  const hrpagetest14({super.key});

  @override
  _hrpagetest14State createState() => _hrpagetest14State();
}

class _hrpagetest14State extends State<hrpagetest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage15()));
              },
