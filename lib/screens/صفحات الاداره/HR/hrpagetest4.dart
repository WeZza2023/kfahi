...
class hrpagetest4 extends StatefulWidget {
  const hrpagetest4({super.key});

  @override
  _hrpagetest4State createState() => _hrpagetest4State();
}

class _hrpagetest4State extends State<hrpagetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage5()));
              },
