...
class hrpagetest18 extends StatefulWidget {
  const hrpagetest18({super.key});

  @override
  _hrpagetest18State createState() => _hrpagetest18State();
}

class _hrpagetest18State extends State<hrpagetest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage19()));
              },
