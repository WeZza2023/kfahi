...
import 'hrpage12.dart';

class hrpagetest11 extends StatefulWidget {
  const hrpagetest11({super.key});

  @override
  _hrpagetest11State createState() => _hrpagetest11State();
}

class _hrpagetest11State extends State<hrpagetest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage12()));
              },
