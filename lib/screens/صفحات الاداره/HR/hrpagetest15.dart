...
class hrpagetest15 extends StatefulWidget {
  const hrpagetest15({super.key});

  @override
  _hrpagetest15State createState() => _hrpagetest15State();
}

class _hrpagetest15State extends State<hrpagetest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage16()));
              },
