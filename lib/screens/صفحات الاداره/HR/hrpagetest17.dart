...
import 'hrpage17.dart';
import 'hrpage18.dart';

class hrpagetest17 extends StatefulWidget {
  const hrpagetest17({super.key});

  @override
  _hrpagetest17State createState() => _hrpagetest17State();
}

class _hrpagetest17State extends State<hrpagetest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage18()));
              },
