...
import 'hrpage23.dart';

class hrpagetest22 extends StatefulWidget {
  const hrpagetest22({super.key});

  @override
  _hrpagetest22State createState() => _hrpagetest22State();
}

class _hrpagetest22State extends State<hrpagetest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage23()));
              },
