...
class hrpagetest9 extends StatefulWidget {
  const hrpagetest9({super.key});

  @override
  _hrpagetest9State createState() => _hrpagetest9State();
}

class _hrpagetest9State extends State<hrpagetest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage10()));
              },
