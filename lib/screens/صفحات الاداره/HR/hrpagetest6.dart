...
class hrpagetest6 extends StatefulWidget {
  const hrpagetest6({super.key});

  @override
  _hrpagetest6State createState() => _hrpagetest6State();
}

class _hrpagetest6State extends State<hrpagetest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage7()));
              },
