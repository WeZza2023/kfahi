...
import 'hrpagetest22.dart';

class hrpage22 extends StatefulWidget {
  const hrpage22({super.key});

  @override
  _hrpage22State createState() => _hrpage22State();
}

class _hrpage22State extends State<hrpage22> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'sw0RtDcKHs0', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const hrpagetest22(),
          ),
        );
      }
    });
