...
import 'hrpage20.dart';
import 'hrpage21.dart';

class hrpagetest20 extends StatefulWidget {
  const hrpagetest20({super.key});

  @override
  _hrpagetest20State createState() => _hrpagetest20State();
}

class _hrpagetest20State extends State<hrpagetest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage21()));
              },
