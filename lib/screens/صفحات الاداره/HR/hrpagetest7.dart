...
class hrpagetest7 extends StatefulWidget {
  const hrpagetest7({super.key});

  @override
  _hrpagetest7State createState() => _hrpagetest7State();
}

class _hrpagetest7State extends State<hrpagetest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage8()));
              },
