...
class hrpagetest5 extends StatefulWidget {
  const hrpagetest5({super.key});

  @override
  _hrpagetest5State createState() => _hrpagetest5State();
}

class _hrpagetest5State extends State<hrpagetest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage6()));
              },
