...
class hrpagetest2 extends StatefulWidget {
  const hrpagetest2({super.key});

  @override
  _hrpagetest2State createState() => _hrpagetest2State();
}

class _hrpagetest2State extends State<hrpagetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage3()));
              },
