...
class hrpagetest1 extends StatefulWidget {
  const hrpagetest1({super.key});

  @override
  _hrpagetest1State createState() => _hrpagetest1State();
}

class _hrpagetest1State extends State<hrpagetest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage2()));
              },
