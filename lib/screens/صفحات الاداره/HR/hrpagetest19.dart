...
import 'hrpage19.dart';
import 'hrpage20.dart';

class hrpagetest19 extends StatefulWidget {
  const hrpagetest19({super.key});

  @override
  _hrpagetest19State createState() => _hrpagetest19State();
}

class _hrpagetest19State extends State<hrpagetest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage20()));
              },
