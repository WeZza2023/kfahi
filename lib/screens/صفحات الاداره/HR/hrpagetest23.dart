...
class hrpagetest23 extends StatefulWidget {
  const hrpagetest23({super.key});

  @override
  _hrpagetest23State createState() => _hrpagetest23State();
}

class _hrpagetest23State extends State<hrpagetest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage23()));
    }
