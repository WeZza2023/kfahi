...
import 'hrpagetest15.dart';

class hrpage15 extends StatefulWidget {
  const hrpage15({super.key});

  @override
  _hrpage15State createState() => _hrpage15State();
}

class _hrpage15State extends State<hrpage15> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'azzhyg-soXg', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const hrpagetest15(),
          ),
        );
      }
    });
