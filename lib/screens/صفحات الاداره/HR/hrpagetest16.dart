...
import 'hrpage16.dart';
import 'hrpage17.dart';

class hrpagetest16 extends StatefulWidget {
  const hrpagetest16({super.key});

  @override
  _hrpagetest16State createState() => _hrpagetest16State();
}

class _hrpagetest16State extends State<hrpagetest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage17()));
              },
