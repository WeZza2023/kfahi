...
import 'hrpage22.dart';

class hrpagetest21 extends StatefulWidget {
  const hrpagetest21({super.key});

  @override
  _hrpagetest21State createState() => _hrpagetest21State();
}

class _hrpagetest21State extends State<hrpagetest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage22()));
              },
