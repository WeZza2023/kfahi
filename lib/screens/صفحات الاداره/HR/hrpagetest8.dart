...
class hrpagetest8 extends StatefulWidget {
  const hrpagetest8({super.key});

  @override
  _hrpagetest8State createState() => _hrpagetest8State();
}

class _hrpagetest8State extends State<hrpagetest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const hrpage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const hrpage9()));
              },
