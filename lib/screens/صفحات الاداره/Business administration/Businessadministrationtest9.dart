...
import 'Businessadministration10.dart';
import 'Businessadministration9.dart';

class Businessadministrationtest9 extends StatefulWidget {
  const Businessadministrationtest9({super.key});

  @override
  _Businessadministrationtest9State createState() =>
      _Businessadministrationtest9State();
}

class _Businessadministrationtest9State
    extends State<Businessadministrationtest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration10()));
              },
