...
import 'Businessadministration.dart';
import 'Businessadministration2.dart';

class Businessadministrationtest1 extends StatefulWidget {
  const Businessadministrationtest1({super.key});

  @override
  _Businessadministrationtest1State createState() =>
      _Businessadministrationtest1State();
}

class _Businessadministrationtest1State
    extends State<Businessadministrationtest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration2()));
              },
