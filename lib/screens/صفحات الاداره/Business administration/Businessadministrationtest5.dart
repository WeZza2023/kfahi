...
import 'Businessadministration5.dart';
import 'Businessadministration6.dart';

class Businessadministrationtest5 extends StatefulWidget {
  const Businessadministrationtest5({super.key});

  @override
  _Businessadministrationtest5State createState() =>
      _Businessadministrationtest5State();
}

class _Businessadministrationtest5State
    extends State<Businessadministrationtest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration6()));
              },
