...
class Businessadministrationtest8 extends StatefulWidget {
  const Businessadministrationtest8({super.key});

  @override
  _Businessadministrationtest8State createState() =>
      _Businessadministrationtest8State();
}

class _Businessadministrationtest8State
    extends State<Businessadministrationtest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration9()));
              },
