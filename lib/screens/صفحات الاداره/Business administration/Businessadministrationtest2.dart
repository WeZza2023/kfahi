...
import 'Businessadministration2.dart';
import 'Businessadministration3.dart';

class Businessadministrationtest2 extends StatefulWidget {
  const Businessadministrationtest2({super.key});

  @override
  _Businessadministrationtest2State createState() =>
      _Businessadministrationtest2State();
}

class _Businessadministrationtest2State
    extends State<Businessadministrationtest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration2()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 2'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration3()));
              },
