...
import 'Businessadministration8.dart';

class Businessadministrationtest7 extends StatefulWidget {
  const Businessadministrationtest7({super.key});

  @override
  _Businessadministrationtest7State createState() =>
      _Businessadministrationtest7State();
}

class _Businessadministrationtest7State
    extends State<Businessadministrationtest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration8()));
              },
