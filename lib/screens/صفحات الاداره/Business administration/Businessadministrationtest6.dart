...
import 'Businessadministration7.dart';

class Businessadministrationtest6 extends StatefulWidget {
  const Businessadministrationtest6({super.key});

  @override
  _Businessadministrationtest6State createState() =>
      _Businessadministrationtest6State();
}

class _Businessadministrationtest6State
    extends State<Businessadministrationtest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration7()));
              },
