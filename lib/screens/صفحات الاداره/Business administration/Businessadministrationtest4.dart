...
class Businessadministrationtest4 extends StatefulWidget {
  const Businessadministrationtest4({super.key});

  @override
  _Businessadministrationtest4State createState() =>
      _Businessadministrationtest4State();
}

class _Businessadministrationtest4State
    extends State<Businessadministrationtest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration5()));
              },
