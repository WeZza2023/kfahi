...
class Businessadministrationtest10 extends StatefulWidget {
  const Businessadministrationtest10({super.key});

  @override
  _Businessadministrationtest10State createState() =>
      _Businessadministrationtest10State();
}

class _Businessadministrationtest10State
    extends State<Businessadministrationtest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration10()));
    }
