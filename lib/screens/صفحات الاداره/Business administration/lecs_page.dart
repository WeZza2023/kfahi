...
class BusinessLecsPage extends StatefulWidget {
  BusinessLecsPage({super.key});

  @override
  State<BusinessLecsPage> createState() => _BusinessLecsPageState();
}

class _BusinessLecsPageState extends State<BusinessLecsPage> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(
                        builder: (context) {
                          return BusinessadministrationPage(
