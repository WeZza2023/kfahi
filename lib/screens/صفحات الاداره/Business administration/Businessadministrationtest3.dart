...
import 'Businessadministration3.dart';
import 'Businessadministration4.dart';

class Businessadministrationtest3 extends StatefulWidget {
  const Businessadministrationtest3({super.key});

  @override
  _Businessadministrationtest3State createState() =>
      _Businessadministrationtest3State();
}

class _Businessadministrationtest3State
    extends State<Businessadministrationtest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Businessadministration3()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 3'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Businessadministration4()));
              },
