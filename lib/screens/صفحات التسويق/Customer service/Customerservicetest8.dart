...
import 'Customerservicepage9.dart';

class Customerservicetest8 extends StatefulWidget {
  const Customerservicetest8({super.key});

  @override
  _Customerservicetest8State createState() => _Customerservicetest8State();
}

class _Customerservicetest8State extends State<Customerservicetest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage9()));
              },
