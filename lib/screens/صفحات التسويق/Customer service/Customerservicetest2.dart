...
import 'Customerservicepage2.dart';
import 'Customerservicepage3.dart';

class Customerservicetest2 extends StatefulWidget {
  const Customerservicetest2({super.key});

  @override
  _Customerservicetest2State createState() => _Customerservicetest2State();
}

class _Customerservicetest2State extends State<Customerservicetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage3()));
              },
