...
class Customerservicetest extends StatefulWidget {
  const Customerservicetest({super.key});

  @override
  _CustomerservicetestState createState() => _CustomerservicetestState();
}

class _CustomerservicetestState extends State<Customerservicetest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    ...
    final shuffledQuestions =
        List<Map<String, dynamic>>.from(CustomerServicesQues)..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار Customer Service'),
      ),
      body: Center(
        child: Column(
