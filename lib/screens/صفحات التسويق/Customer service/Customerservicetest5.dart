...
class Customerservicetest5 extends StatefulWidget {
  const Customerservicetest5({super.key});

  @override
  _Customerservicetest5State createState() => _Customerservicetest5State();
}

class _Customerservicetest5State extends State<Customerservicetest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage6()));
              },
