...
import 'Customerservicepage7.dart';
import 'Customerservicepage8.dart';

class Customerservicetest7 extends StatefulWidget {
  const Customerservicetest7({super.key});

  @override
  _Customerservicetest7State createState() => _Customerservicetest7State();
}

class _Customerservicetest7State extends State<Customerservicetest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage8()));
              },
