...
import 'Customerservicepage6.dart';
import 'Customerservicepage7.dart';

class Customerservicetest6 extends StatefulWidget {
  const Customerservicetest6({super.key});

  @override
  _Customerservicetest6State createState() => _Customerservicetest6State();
}

class _Customerservicetest6State extends State<Customerservicetest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage7()));
              },
