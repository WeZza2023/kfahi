...
class Customerservicetest9 extends StatefulWidget {
  const Customerservicetest9({super.key});

  @override
  _Customerservicetest9State createState() => _Customerservicetest9State();
}

class _Customerservicetest9State extends State<Customerservicetest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage9()));
    }
