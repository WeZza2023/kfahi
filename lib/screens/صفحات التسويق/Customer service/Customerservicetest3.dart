...
import 'Customerservicepage4.dart';

class Customerservicetest3 extends StatefulWidget {
  const Customerservicetest3({super.key});

  @override
  _Customerservicetest3State createState() => _Customerservicetest3State();
}

class _Customerservicetest3State extends State<Customerservicetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage4()));
              },
