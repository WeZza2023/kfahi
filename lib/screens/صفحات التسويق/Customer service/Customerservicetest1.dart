...
import 'Customerservicepage.dart';
import 'Customerservicepage2.dart';

class Customerservicetest1 extends StatefulWidget {
  const Customerservicetest1({super.key});

  @override
  _Customerservicetest1State createState() => _Customerservicetest1State();
}

class _Customerservicetest1State extends State<Customerservicetest1> {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage2()));
              },
