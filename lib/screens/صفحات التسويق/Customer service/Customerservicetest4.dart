...
import 'Customerservicepage5.dart';

class Customerservicetest4 extends StatefulWidget {
  const Customerservicetest4({super.key});

  @override
  _Customerservicetest4State createState() => _Customerservicetest4State();
}

class _Customerservicetest4State extends State<Customerservicetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Customerservicepage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Customerservicepage5()));
              },
