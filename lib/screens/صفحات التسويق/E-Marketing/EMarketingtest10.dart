...
import 'EMarketingpage10.dart';
import 'EMarketingpage11.dart';

class EMarketingtest10 extends StatefulWidget {
  const EMarketingtest10({super.key});

  @override
  _EMarketingtest10State createState() => _EMarketingtest10State();
}

class _EMarketingtest10State extends State<EMarketingtest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage11()));
              },
