...
class EMarketingLecsPage extends StatefulWidget {
  EMarketingLecsPage({super.key});

  @override
  State<EMarketingLecsPage> createState() => _EMarketingLecsPageState();
}

class _EMarketingLecsPageState extends State<EMarketingLecsPage> {
