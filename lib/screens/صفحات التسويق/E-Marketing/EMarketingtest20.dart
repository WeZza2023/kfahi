...
class EMarketingtest20 extends StatefulWidget {
  const EMarketingtest20({super.key});

  @override
  _EMarketingtest20State createState() => _EMarketingtest20State();
}

class _EMarketingtest20State extends State<EMarketingtest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage21()));
              },
