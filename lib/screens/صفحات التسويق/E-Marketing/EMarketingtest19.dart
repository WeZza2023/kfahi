...
import 'EMarketingpage19.dart';
import 'EMarketingpage20.dart';

class EMarketingtest19 extends StatefulWidget {
  const EMarketingtest19({super.key});

  @override
  _EMarketingtest19State createState() => _EMarketingtest19State();
}

class _EMarketingtest19State extends State<EMarketingtest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage20()));
              },
