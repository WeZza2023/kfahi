...
import 'EMarketingpage.dart';
import 'EMarketingpage2.dart';

class EMarketingtest1 extends StatefulWidget {
  const EMarketingtest1({super.key});

  @override
  _EMarketingtest1State createState() => _EMarketingtest1State();
}

class _EMarketingtest1State extends State<EMarketingtest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage2()));
              },
