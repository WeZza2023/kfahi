...
import 'EMarketingpage11.dart';
import 'EMarketingpage12.dart';

class EMarketingtest11 extends StatefulWidget {
  const EMarketingtest11({super.key});

  @override
  _EMarketingtest11State createState() => _EMarketingtest11State();
}

class _EMarketingtest11State extends State<EMarketingtest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage12()));
              },
