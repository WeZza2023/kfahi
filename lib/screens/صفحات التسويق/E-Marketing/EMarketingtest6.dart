...
import 'EMarketingpage6.dart';
import 'EMarketingpage7.dart';

class EMarketingtest6 extends StatefulWidget {
  const EMarketingtest6({super.key});

  @override
  _EMarketingtest6State createState() => _EMarketingtest6State();
}

class _EMarketingtest6State extends State<EMarketingtest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage7()));
              },
