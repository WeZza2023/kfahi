...
import 'EMarketingpage13.dart';
import 'EMarketingpage14.dart';

class EMarketingtest13 extends StatefulWidget {
  const EMarketingtest13({super.key});

  @override
  _EMarketingtest13State createState() => _EMarketingtest13State();
}

class _EMarketingtest13State extends State<EMarketingtest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage14()));
              },
