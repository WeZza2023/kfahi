...
import 'EMarketingpage3.dart';
import 'EMarketingpage4.dart';

class EMarketingtest3 extends StatefulWidget {
  const EMarketingtest3({super.key});

  @override
  _EMarketingtest3State createState() => _EMarketingtest3State();
}

class _EMarketingtest3State extends State<EMarketingtest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage4()));
              },
