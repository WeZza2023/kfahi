...
import 'EMarketingpage14.dart';
import 'EMarketingpage15.dart';

class EMarketingtest14 extends StatefulWidget {
  const EMarketingtest14({super.key});

  @override
  _EMarketingtest14State createState() => _EMarketingtest14State();
}

class _EMarketingtest14State extends State<EMarketingtest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage15()));
              },
