...
class EMarketingtest5 extends StatefulWidget {
  const EMarketingtest5({super.key});

  @override
  _EMarketingtest5State createState() => _EMarketingtest5State();
}

class _EMarketingtest5State extends State<EMarketingtest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage6()));
              },
