...
import 'EMarketingpage17.dart';
import 'EMarketingpage18.dart';

class EMarketingtest17 extends StatefulWidget {
  const EMarketingtest17({super.key});

  @override
  _EMarketingtest17State createState() => _EMarketingtest17State();
}

class _EMarketingtest17State extends State<EMarketingtest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage18()));
              },
