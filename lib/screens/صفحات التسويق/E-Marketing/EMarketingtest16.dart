...
class EMarketingtest16 extends StatefulWidget {
  const EMarketingtest16({super.key});

  @override
  _EMarketingtest16State createState() => _EMarketingtest16State();
}

class _EMarketingtest16State extends State<EMarketingtest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage17()));
              },
