...
import 'EMarketingpage5.dart';

class EMarketingtest4 extends StatefulWidget {
  const EMarketingtest4({super.key});

  @override
  _EMarketingtest4State createState() => _EMarketingtest4State();
}

class _EMarketingtest4State extends State<EMarketingtest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage5()));
              },
