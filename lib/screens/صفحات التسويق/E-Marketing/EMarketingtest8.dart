...
class EMarketingtest8 extends StatefulWidget {
  const EMarketingtest8({super.key});

  @override
  _EMarketingtest8State createState() => _EMarketingtest8State();
}

class _EMarketingtest8State extends State<EMarketingtest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage9()));
              },
