...
class Emarketingtest extends StatefulWidget {
  const Emarketingtest({super.key});

  @override
  _EmarketingtestState createState() => _EmarketingtestState();
}

class _EmarketingtestState extends State<Emarketingtest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(MarketingQues)
      ..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار E-Marketing'),
      ),
      body: Center(
        child: Column(
