...
import 'EMarketingpage16.dart';

class EMarketingtest15 extends StatefulWidget {
  const EMarketingtest15({super.key});

  @override
  _EMarketingtest15State createState() => _EMarketingtest15State();
}

class _EMarketingtest15State extends State<EMarketingtest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage16()));
              },
