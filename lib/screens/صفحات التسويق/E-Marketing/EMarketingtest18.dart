...
import 'EMarketingpage18.dart';
import 'EMarketingpage19.dart';

class EMarketingtest18 extends StatefulWidget {
  const EMarketingtest18({super.key});

  @override
  _EMarketingtest18State createState() => _EMarketingtest18State();
}

class _EMarketingtest18State extends State<EMarketingtest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage19()));
              },
