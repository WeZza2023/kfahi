...
import 'EMarketingpage9.dart';

class EMarketingtest9 extends StatefulWidget {
  const EMarketingtest9({super.key});

  @override
  _EMarketingtest9State createState() => _EMarketingtest9State();
}

class _EMarketingtest9State extends State<EMarketingtest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage10()));
              },
