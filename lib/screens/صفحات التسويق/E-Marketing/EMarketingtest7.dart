...
import 'EMarketingpage8.dart';

class EMarketingtest7 extends StatefulWidget {
  const EMarketingtest7({super.key});

  @override
  _EMarketingtest7State createState() => _EMarketingtest7State();
}

class _EMarketingtest7State extends State<EMarketingtest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage8()));
              },
