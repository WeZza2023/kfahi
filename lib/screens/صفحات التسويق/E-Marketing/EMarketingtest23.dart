...
import 'EMarketingpage23.dart';

class EMarketingtest23 extends StatefulWidget {
  const EMarketingtest23({super.key});

  @override
  _EMarketingtest23State createState() => _EMarketingtest23State();
}

class _EMarketingtest23State extends State<EMarketingtest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage23()));
    }
