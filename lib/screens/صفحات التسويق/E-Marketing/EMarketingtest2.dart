...
import 'EMarketingpage2.dart';
import 'EMarketingpage3.dart';

class EMarketingtest2 extends StatefulWidget {
  const EMarketingtest2({super.key});

  @override
  _EMarketingtest2State createState() => _EMarketingtest2State();
}

class _EMarketingtest2State extends State<EMarketingtest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const EMarketingpage3()));
              },
