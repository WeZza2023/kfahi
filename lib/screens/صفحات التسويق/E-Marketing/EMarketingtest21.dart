...
import 'EMarketingpage21.dart';
import 'EMarketingpage22.dart';

class EMarketingtest21 extends StatefulWidget {
  const EMarketingtest21({super.key});

  @override
  _EMarketingtest21State createState() => _EMarketingtest21State();
}

class _EMarketingtest21State extends State<EMarketingtest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage22()));
              },
