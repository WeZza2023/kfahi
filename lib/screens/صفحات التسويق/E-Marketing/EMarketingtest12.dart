...
class EMarketingtest12 extends StatefulWidget {
  const EMarketingtest12({super.key});

  @override
  _EMarketingtest12State createState() => _EMarketingtest12State();
}

class _EMarketingtest12State extends State<EMarketingtest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const EMarketingpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EMarketingpage13()));
              },
