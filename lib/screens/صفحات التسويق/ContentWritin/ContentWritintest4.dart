...
import 'ContentWritin4.dart';
import 'ContentWritin5.dart';

class ContentWritintest4 extends StatefulWidget {
  const ContentWritintest4({super.key});

  @override
  _ContentWritintest4State createState() => _ContentWritintest4State();
}

class _ContentWritintest4State extends State<ContentWritintest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin5()));
              },
