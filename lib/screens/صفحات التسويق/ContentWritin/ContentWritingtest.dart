...
class Contentwritingtest extends StatefulWidget {
  const Contentwritingtest({super.key});

  @override
  _ContentwritingtestState createState() => _ContentwritingtestState();
}

class _ContentwritingtestState extends State<Contentwritingtest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    ...
    final shuffledQuestions =
        List<Map<String, dynamic>>.from(ContentWritingQues)..shuffle(random);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار Content Writing'),
      ),
      body: Center(
        child: Column(
