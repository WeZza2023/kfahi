...
import 'ContentWritin6.dart';

class ContentWritintest5 extends StatefulWidget {
  const ContentWritintest5({super.key});

  @override
  _ContentWritintest5State createState() => _ContentWritintest5State();
}

class _ContentWritintest5State extends State<ContentWritintest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin6()));
              },
