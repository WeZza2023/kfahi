...
import 'ContentWritin13.dart';
import 'ContentWritin14.dart';

class ContentWritintest13 extends StatefulWidget {
  const ContentWritintest13({super.key});

  @override
  _ContentWritintest13State createState() => _ContentWritintest13State();
}

class _ContentWritintest13State extends State<ContentWritintest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin14()));
              },
