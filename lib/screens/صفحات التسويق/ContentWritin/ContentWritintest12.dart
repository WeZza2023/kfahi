...
class ContentWritintest12 extends StatefulWidget {
  const ContentWritintest12({super.key});

  @override
  _ContentWritintest12State createState() => _ContentWritintest12State();
}

class _ContentWritintest12State extends State<ContentWritintest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin13()));
              },
