...
import 'ContentWritin21.dart';
import 'ContentWritin22.dart';

class ContentWritintest21 extends StatefulWidget {
  const ContentWritintest21({super.key});

  @override
  _ContentWritintest21State createState() => _ContentWritintest21State();
}

class _ContentWritintest21State extends State<ContentWritintest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin22()));
              },
