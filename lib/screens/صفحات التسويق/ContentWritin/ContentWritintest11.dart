...
import 'ContentWritin12.dart';

class ContentWritintest11 extends StatefulWidget {
  const ContentWritintest11({super.key});

  @override
  _ContentWritintest11State createState() => _ContentWritintest11State();
}

class _ContentWritintest11State extends State<ContentWritintest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin12()));
              },
