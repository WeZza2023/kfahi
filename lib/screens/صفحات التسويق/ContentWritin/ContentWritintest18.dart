...
class ContentWritintest18 extends StatefulWidget {
  const ContentWritintest18({super.key});

  @override
  _ContentWritintest18State createState() => _ContentWritintest18State();
}

class _ContentWritintest18State extends State<ContentWritintest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin19()));
              },
