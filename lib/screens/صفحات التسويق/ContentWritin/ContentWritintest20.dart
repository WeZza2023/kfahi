...
import 'ContentWritin20.dart';
import 'ContentWritin21.dart';

class ContentWritintest20 extends StatefulWidget {
  const ContentWritintest20({super.key});

  @override
  _ContentWritintest20State createState() => _ContentWritintest20State();
}

class _ContentWritintest20State extends State<ContentWritintest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin21()));
              },
