...
import 'ContentWritin8.dart';

class ContentWritintest7 extends StatefulWidget {
  const ContentWritintest7({super.key});

  @override
  _ContentWritintest7State createState() => _ContentWritintest7State();
}

class _ContentWritintest7State extends State<ContentWritintest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin8()));
              },
