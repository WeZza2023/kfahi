...
class ContentWritintest23 extends StatefulWidget {
  const ContentWritintest23({super.key});

  @override
  _ContentWritintest23State createState() => _ContentWritintest23State();
}

class _ContentWritintest23State extends State<ContentWritintest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin23()));
    }
