...
import 'ContentWritin16.dart';

class ContentWritintest15 extends StatefulWidget {
  const ContentWritintest15({super.key});

  @override
  _ContentWritintest15State createState() => _ContentWritintest15State();
}

class _ContentWritintest15State extends State<ContentWritintest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin16()));
              },
