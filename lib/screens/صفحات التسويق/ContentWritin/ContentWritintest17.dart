...
import 'ContentWritin18.dart';

class ContentWritintest17 extends StatefulWidget {
  const ContentWritintest17({super.key});

  @override
  _ContentWritintest17State createState() => _ContentWritintest17State();
}

class _ContentWritintest17State extends State<ContentWritintest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin18()));
              },
