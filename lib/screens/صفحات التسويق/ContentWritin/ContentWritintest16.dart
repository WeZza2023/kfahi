...
import 'ContentWritin17.dart';

class ContentWritintest16 extends StatefulWidget {
  const ContentWritintest16({super.key});

  @override
  _ContentWritintest16State createState() => _ContentWritintest16State();
}

class _ContentWritintest16State extends State<ContentWritintest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin17()));
              },
