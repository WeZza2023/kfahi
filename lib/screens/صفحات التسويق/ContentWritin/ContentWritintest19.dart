...
import 'ContentWritin19.dart';
import 'ContentWritin20.dart';

class ContentWritintest19 extends StatefulWidget {
  const ContentWritintest19({super.key});

  @override
  _ContentWritintest19State createState() => _ContentWritintest19State();
}

class _ContentWritintest19State extends State<ContentWritintest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin20()));
              },
