...
import 'ContentWritin23.dart';

class ContentWritintest22 extends StatefulWidget {
  const ContentWritintest22({super.key});

  @override
  _ContentWritintest22State createState() => _ContentWritintest22State();
}

class _ContentWritintest22State extends State<ContentWritintest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin23()));
              },
