...
import 'ContentWritin9.dart';

class ContentWritintest9 extends StatefulWidget {
  const ContentWritintest9({super.key});

  @override
  _ContentWritintest9State createState() => _ContentWritintest9State();
}

class _ContentWritintest9State extends State<ContentWritintest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin10()));
              },
