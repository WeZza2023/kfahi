...
import 'ContentWritin2.dart';
import 'ContentWritin3.dart';

class ContentWritintest2 extends StatefulWidget {
  const ContentWritintest2({super.key});

  @override
  _ContentWritintest2State createState() => _ContentWritintest2State();
}

class _ContentWritintest2State extends State<ContentWritintest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin3()));
              },
