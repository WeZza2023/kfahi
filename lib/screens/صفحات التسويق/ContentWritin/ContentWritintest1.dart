...
import 'ContentWritin.dart';
import 'ContentWritin2.dart';

class ContentWritintest1 extends StatefulWidget {
  const ContentWritintest1({super.key});

  @override
  _ContentWritintest1State createState() => _ContentWritintest1State();
}

class _ContentWritintest1State extends State<ContentWritintest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin2()));
              },
