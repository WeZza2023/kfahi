...
class ContentWritintest3 extends StatefulWidget {
  const ContentWritintest3({super.key});

  @override
  _ContentWritintest3State createState() => _ContentWritintest3State();
}

class _ContentWritintest3State extends State<ContentWritintest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin4()));
              },
