...
import 'ContentWritin10.dart';
import 'ContentWritin11.dart';

class ContentWritintest10 extends StatefulWidget {
  const ContentWritintest10({super.key});

  @override
  _ContentWritintest10State createState() => _ContentWritintest10State();
}

class _ContentWritintest10State extends State<ContentWritintest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin11()));
              },
