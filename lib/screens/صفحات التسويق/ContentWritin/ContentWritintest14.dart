...
import 'ContentWritin14.dart';
import 'ContentWritin15.dart';

class ContentWritintest14 extends StatefulWidget {
  const ContentWritintest14({super.key});

  @override
  _ContentWritintest14State createState() => _ContentWritintest14State();
}

class _ContentWritintest14State extends State<ContentWritintest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin15()));
              },
