...
class ContentWritintest8 extends StatefulWidget {
  const ContentWritintest8({super.key});

  @override
  _ContentWritintest8State createState() => _ContentWritintest8State();
}

class _ContentWritintest8State extends State<ContentWritintest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const ContentWritin8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const ContentWritin9()));
              },
