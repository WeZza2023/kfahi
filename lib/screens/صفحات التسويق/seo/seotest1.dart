...
class seotest1 extends StatefulWidget {
  const seotest1({super.key});

  @override
  _seotest1State createState() => _seotest1State();
}

class _seotest1State extends State<seotest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo()));
    }
