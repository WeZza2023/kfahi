...
class seotest13 extends StatefulWidget {
  const seotest13({super.key});

  @override
  _seotest13State createState() => _seotest13State();
}

class _seotest13State extends State<seotest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo13()));
    }
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => const seo14()));
              },
