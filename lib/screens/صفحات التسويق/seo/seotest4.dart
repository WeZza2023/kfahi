...
class seotest4 extends StatefulWidget {
  const seotest4({super.key});

  @override
  _seotest4State createState() => _seotest4State();
}

class _seotest4State extends State<seotest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo4()));
    }
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => const seo5()));
              },
