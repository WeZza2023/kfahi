...
class SeoTest extends StatefulWidget {
  const SeoTest({super.key});

  @override
  _SeoTestState createState() => _SeoTestState();
}

class _SeoTestState extends State<SeoTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(SEOQues)
      ..shuffle(random);
