...
class seotest10 extends StatefulWidget {
  const seotest10({super.key});

  @override
  _seotest10State createState() => _seotest10State();
}

class _seotest10State extends State<seotest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo10()));
    }
