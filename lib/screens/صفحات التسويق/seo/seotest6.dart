...
class seotest6 extends StatefulWidget {
  const seotest6({super.key});

  @override
  _seotest6State createState() => _seotest6State();
}

class _seotest6State extends State<seotest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo6()));
    }
