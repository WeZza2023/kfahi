...
import 'seotest7.dart';

class seo7 extends StatefulWidget {
  const seo7({super.key});

  @override
  _seo7State createState() => _seo7State();
}

class _seo7State extends State<seo7> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '0Ck8X3Y-9T0', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const seotest7(),
          ),
        );
      }
    });
