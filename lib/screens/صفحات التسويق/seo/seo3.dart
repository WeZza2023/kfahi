...
import 'seotest3.dart';

class seo3 extends StatefulWidget {
  const seo3({super.key});

  @override
  _seo3State createState() => _seo3State();
}

class _seo3State extends State<seo3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'GutTZQHEIX4', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const seotest3(),
          ),
        );
      }
    });
