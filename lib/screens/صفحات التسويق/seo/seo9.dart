...
import 'seotest9.dart';

class seo9 extends StatefulWidget {
  const seo9({super.key});

  @override
  _seo9State createState() => _seo9State();
}

class _seo9State extends State<seo9> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'ZFe9FfnlZZc', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const seotest9(),
          ),
        );
      }
    });
