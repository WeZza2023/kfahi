...
import 'seotest5.dart';

class seo5 extends StatefulWidget {
  const seo5({super.key});

  @override
  _seo5State createState() => _seo5State();
}

class _seo5State extends State<seo5> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'vZXRRpeqZKQ', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const seotest5(),
          ),
        );
      }
    });
