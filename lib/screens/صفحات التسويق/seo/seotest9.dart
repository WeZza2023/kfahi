...
class seotest9 extends StatefulWidget {
  const seotest9({super.key});

  @override
  _seotest9State createState() => _seotest9State();
}

class _seotest9State extends State<seotest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo9()));
    }
