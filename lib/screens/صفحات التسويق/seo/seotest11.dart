...
class seotest11 extends StatefulWidget {
  const seotest11({super.key});

  @override
  _seotest11State createState() => _seotest11State();
}

class _seotest11State extends State<seotest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo11()));
    }
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => const seo12()));
              },
