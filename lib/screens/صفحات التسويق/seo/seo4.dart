...
import 'seotest4.dart';

class seo4 extends StatefulWidget {
  const seo4({super.key});

  @override
  _seo4State createState() => _seo4State();
}

class _seo4State extends State<seo4> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'Z_DOKwcrgjo', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const seotest4(),
          ),
        );
      }
    });
