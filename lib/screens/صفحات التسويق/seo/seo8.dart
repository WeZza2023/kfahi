...
import 'seotest8.dart';

class seo8 extends StatefulWidget {
  const seo8({super.key});

  @override
  _seo8State createState() => _seo8State();
}

class _seo8State extends State<seo8> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '7XQ7l_osvpg', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const seotest8(),
          ),
        );
      }
    });
