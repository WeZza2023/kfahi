...
import 'seotest6.dart';

class seo6 extends StatefulWidget {
  const seo6({super.key});

  @override
  _seo6State createState() => _seo6State();
}

class _seo6State extends State<seo6> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'D7gLgu4xVqw', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const seotest6(),
          ),
        );
      }
    });
