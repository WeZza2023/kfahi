...
class seotest7 extends StatefulWidget {
  const seotest7({super.key});

  @override
  _seotest7State createState() => _seotest7State();
}

class _seotest7State extends State<seotest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo7()));
    }
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => const seo8()));
              },
