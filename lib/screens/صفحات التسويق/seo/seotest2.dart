...
class seotest2 extends StatefulWidget {
  const seotest2({super.key});

  @override
  _seotest2State createState() => _seotest2State();
}

class _seotest2State extends State<seotest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const seo2()));
    }
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => const seo3()));
              },
