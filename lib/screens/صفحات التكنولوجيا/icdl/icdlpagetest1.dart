...
import 'icdlpage.dart';
import 'icdlpage2.dart';

class icdlpagetest1 extends StatefulWidget {
  const icdlpagetest1({super.key});

  @override
  icdlpagetest1State createState() => icdlpagetest1State();
}

class icdlpagetest1State extends State<icdlpagetest1> {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage2()));
              },
