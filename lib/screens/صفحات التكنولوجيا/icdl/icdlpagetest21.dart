...
import 'icdlpage22.dart';

class icdlpagetest21 extends StatefulWidget {
  const icdlpagetest21({super.key});

  @override
  _icdlpagetest21State createState() => _icdlpagetest21State();
}

class _icdlpagetest21State extends State<icdlpagetest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage22()));
              },
