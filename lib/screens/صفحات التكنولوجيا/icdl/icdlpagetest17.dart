...
class icdlpagetest17 extends StatefulWidget {
  const icdlpagetest17({super.key});

  @override
  _icdlpagetest17State createState() => _icdlpagetest17State();
}

class _icdlpagetest17State extends State<icdlpagetest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage18()));
              },
