...
import 'icdlpage13.dart';
import 'icdlpage14.dart';

class icdlpagetest13 extends StatefulWidget {
  const icdlpagetest13({super.key});

  @override
  _icdlpagetest13State createState() => _icdlpagetest13State();
}

class _icdlpagetest13State extends State<icdlpagetest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage14()));
              },
