...
import 'icdlpage2.dart';
import 'icdlpage3.dart';

class icdlpagetest2 extends StatefulWidget {
  const icdlpagetest2({super.key});

  @override
  _icdlpagetest2State createState() => _icdlpagetest2State();
}

class _icdlpagetest2State extends State<icdlpagetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage3()));
              },
