...
class icdlpagetest22 extends StatefulWidget {
  const icdlpagetest22({super.key});

  @override
  _icdlpagetest22State createState() => _icdlpagetest22State();
}

class _icdlpagetest22State extends State<icdlpagetest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage23()));
              },
