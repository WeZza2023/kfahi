...
import 'icdlpage29.dart';
import 'icdlpage30.dart';

class icdlpagetest29 extends StatefulWidget {
  const icdlpagetest29({super.key});

  @override
  _icdlpagetest29State createState() => _icdlpagetest29State();
}

class _icdlpagetest29State extends State<icdlpagetest29> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage29()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage30()));
              },
