...
import 'icdlpage3.dart';
import 'icdlpage4.dart';

class icdlpagetest3 extends StatefulWidget {
  const icdlpagetest3({super.key});

  @override
  _icdlpagetest3State createState() => _icdlpagetest3State();
}

class _icdlpagetest3State extends State<icdlpagetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage4()));
              },
