...
import 'icdlpagetest20.dart';

class icdlpage20 extends StatefulWidget {
  const icdlpage20({super.key});

  @override
  _icdlpage20State createState() => _icdlpage20State();
}

class _icdlpage20State extends State<icdlpage20> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'IE9KDFCt8BU', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest20(),
          ),
        );
      }
    });
