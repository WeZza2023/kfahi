...
import 'icdlpage20.dart';
import 'icdlpage21.dart';

class icdlpagetest20 extends StatefulWidget {
  const icdlpagetest20({super.key});

  @override
  _icdlpagetest20State createState() => _icdlpagetest20State();
}

class _icdlpagetest20State extends State<icdlpagetest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage21()));
              },
