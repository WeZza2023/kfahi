...
import 'icdlpagetest25.dart';

class icdlpage25 extends StatefulWidget {
  const icdlpage25({super.key});

  @override
  _icdlpage25State createState() => _icdlpage25State();
}

class _icdlpage25State extends State<icdlpage25> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '2yvI6iks1zA', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest25(),
          ),
        );
      }
    });
