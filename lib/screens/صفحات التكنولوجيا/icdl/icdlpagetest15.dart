...
class icdlpagetest15 extends StatefulWidget {
  const icdlpagetest15({super.key});

  @override
  _icdlpagetest15State createState() => _icdlpagetest15State();
}

class _icdlpagetest15State extends State<icdlpagetest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage16()));
              },
