...
import 'icdlpagetest3.dart';

class icdlpage3 extends StatefulWidget {
  const icdlpage3({super.key});

  @override
  _icdlpage3State createState() => _icdlpage3State();
}

class _icdlpage3State extends State<icdlpage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'kqLgg3YLBek', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest3(),
          ),
        );
      }
    });
