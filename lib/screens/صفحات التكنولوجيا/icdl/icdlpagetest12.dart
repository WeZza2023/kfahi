...
class icdlpagetest12 extends StatefulWidget {
  const icdlpagetest12({super.key});

  @override
  _icdlpagetest12State createState() => _icdlpagetest12State();
}

class _icdlpagetest12State extends State<icdlpagetest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage13()));
              },
