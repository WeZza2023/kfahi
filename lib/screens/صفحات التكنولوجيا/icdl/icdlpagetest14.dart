...
import 'icdlpage15.dart';

class icdlpagetest14 extends StatefulWidget {
  const icdlpagetest14({super.key});

  @override
  _icdlpagetest14State createState() => _icdlpagetest14State();
}

class _icdlpagetest14State extends State<icdlpagetest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage15()));
              },
