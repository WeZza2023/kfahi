...
class icdlpagetest8 extends StatefulWidget {
  const icdlpagetest8({super.key});

  @override
  _icdlpagetest8State createState() => _icdlpagetest8State();
}

class _icdlpagetest8State extends State<icdlpagetest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage9()));
              },
