...
class icdlpagetest28 extends StatefulWidget {
  const icdlpagetest28({super.key});

  @override
  _icdlpagetest28State createState() => _icdlpagetest28State();
}

class _icdlpagetest28State extends State<icdlpagetest28> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage28()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage29()));
              },
