...
import 'icdlpagetest16.dart';

class icdlpage16 extends StatefulWidget {
  const icdlpage16({super.key});

  @override
  _icdlpage16State createState() => _icdlpage16State();
}

class _icdlpage16State extends State<icdlpage16> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '7anuzA-_ZOQ', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest16(),
          ),
        );
      }
    });
