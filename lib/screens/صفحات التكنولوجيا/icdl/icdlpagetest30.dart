...
import 'icdlpage31.dart';

class icdlpagetest30 extends StatefulWidget {
  const icdlpagetest30({super.key});

  @override
  _icdlpagetest30State createState() => _icdlpagetest30State();
}

class _icdlpagetest30State extends State<icdlpagetest30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage30()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage31()));
              },
