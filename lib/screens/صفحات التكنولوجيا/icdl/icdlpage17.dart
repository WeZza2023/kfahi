...
import 'icdlpagetest7.dart';

class icdlpage17 extends StatefulWidget {
  const icdlpage17({super.key});

  @override
  _icdlpage17State createState() => _icdlpage17State();
}

class _icdlpage17State extends State<icdlpage17> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'KDAGRYUyi_k', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest7(),
          ),
        );
      }
    });
