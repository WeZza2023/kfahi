...
import 'icdlpage19.dart';
import 'icdlpage20.dart';

class icdlpagetest19 extends StatefulWidget {
  const icdlpagetest19({super.key});

  @override
  _icdlpagetest19State createState() => _icdlpagetest19State();
}

class _icdlpagetest19State extends State<icdlpagetest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage20()));
              },
