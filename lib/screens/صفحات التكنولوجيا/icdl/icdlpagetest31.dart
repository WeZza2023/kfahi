...
class icdlpagetest31 extends StatefulWidget {
  const icdlpagetest31({super.key});

  @override
  _icdlpagetest31State createState() => _icdlpagetest31State();
}

class _icdlpagetest31State extends State<icdlpagetest31> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage31()));
    }
