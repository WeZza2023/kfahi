...
import 'icdlpagetest27.dart';

class icdlpage27 extends StatefulWidget {
  const icdlpage27({super.key});

  @override
  _icdlpage27State createState() => _icdlpage27State();
}

class _icdlpage27State extends State<icdlpage27> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'V4BIEMODLeU', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest27(),
          ),
        );
      }
    });
