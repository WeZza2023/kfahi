...
class ICDLTest extends StatefulWidget {
  const ICDLTest({super.key});

  @override
  _ICDLTestState createState() => _ICDLTestState();
}

class _ICDLTestState extends State<ICDLTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(ICDLQues)
      ..shuffle(random);
