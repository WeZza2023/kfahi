...
import 'icdlpage23.dart';
import 'icdlpage24.dart';

class icdlpagetest23 extends StatefulWidget {
  const icdlpagetest23({super.key});

  @override
  _icdlpagetest23State createState() => _icdlpagetest23State();
}

class _icdlpagetest23State extends State<icdlpagetest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage24()));
              },
