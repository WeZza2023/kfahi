...
import 'icdlpage7.dart';
import 'icdlpage8.dart';

class icdlpagetest7 extends StatefulWidget {
  const icdlpagetest7({super.key});

  @override
  _icdlpagetest7State createState() => _icdlpagetest7State();
}

class _icdlpagetest7State extends State<icdlpagetest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage8()));
              },
