...
import 'icdlpagetest6.dart';

class icdlpage6 extends StatefulWidget {
  const icdlpage6({super.key});

  @override
  _icdlpage6State createState() => _icdlpage6State();
}

class _icdlpage6State extends State<icdlpage6> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'yGB07HIwI2U', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest6(),
          ),
        );
      }
    });
