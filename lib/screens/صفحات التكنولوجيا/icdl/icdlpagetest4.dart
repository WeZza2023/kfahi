...
import 'icdlpage4.dart';
import 'icdlpage5.dart';

class icdlpagetest4 extends StatefulWidget {
  const icdlpagetest4({super.key});

  @override
  _icdlpagetest4State createState() => _icdlpagetest4State();
}

class _icdlpagetest4State extends State<icdlpagetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage5()));
              },
