...
import 'icdlpage10.dart';
import 'icdlpage11.dart';

class icdlpagetest10 extends StatefulWidget {
  const icdlpagetest10({super.key});

  @override
  _icdlpagetest10State createState() => _icdlpagetest10State();
}

class _icdlpagetest10State extends State<icdlpagetest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage11()));
              },
