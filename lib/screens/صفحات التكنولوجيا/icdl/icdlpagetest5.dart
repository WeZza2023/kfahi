...
import 'icdlpage6.dart';

class icdlpagetest5 extends StatefulWidget {
  const icdlpagetest5({super.key});

  @override
  _icdlpagetest5State createState() => _icdlpagetest5State();
}

class _icdlpagetest5State extends State<icdlpagetest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage6()));
              },
