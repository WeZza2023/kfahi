...
import 'icdlpage28.dart';

class icdlpagetest27 extends StatefulWidget {
  const icdlpagetest27({super.key});

  @override
  _icdlpagetest27State createState() => _icdlpagetest27State();
}

class _icdlpagetest27State extends State<icdlpagetest27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage27()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage28()));
              },
