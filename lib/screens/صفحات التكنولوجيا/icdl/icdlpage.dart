...
import 'icdlpagetest1.dart';

class icdlpage extends StatefulWidget {
  const icdlpage({super.key});

  @override
  _icdlpageState createState() => _icdlpageState();
}

class _icdlpageState extends State<icdlpage> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'sPBlDYVDjLU', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest1(),
          ),
        );
      }
    });
