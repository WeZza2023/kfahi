...
import 'icdlpagetest14.dart';

class icdlpage14 extends StatefulWidget {
  const icdlpage14({super.key});

  @override
  _icdlpage14State createState() => _icdlpage14State();
}

class _icdlpage14State extends State<icdlpage14> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'ef8cw3A-OgE', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const icdlpagetest14(),
          ),
        );
      }
    });
