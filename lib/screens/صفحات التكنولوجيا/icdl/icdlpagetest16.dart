...
import 'icdlpage16.dart';
import 'icdlpage17.dart';

class icdlpagetest16 extends StatefulWidget {
  const icdlpagetest16({super.key});

  @override
  _icdlpagetest16State createState() => _icdlpagetest16State();
}

class _icdlpagetest16State extends State<icdlpagetest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage17()));
              },
