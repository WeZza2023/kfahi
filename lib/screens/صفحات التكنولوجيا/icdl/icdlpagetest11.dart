...
import 'icdlpage11.dart';
import 'icdlpage12.dart';

class icdlpagetest11 extends StatefulWidget {
  const icdlpagetest11({super.key});

  @override
  _icdlpagetest11State createState() => _icdlpagetest11State();
}

class _icdlpagetest11State extends State<icdlpagetest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage12()));
              },
