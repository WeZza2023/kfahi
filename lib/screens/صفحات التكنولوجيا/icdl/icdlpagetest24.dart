...
class icdlpagetest24 extends StatefulWidget {
  const icdlpagetest24({super.key});

  @override
  _icdlpagetest24State createState() => _icdlpagetest24State();
}

class _icdlpagetest24State extends State<icdlpagetest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage25()));
              },
