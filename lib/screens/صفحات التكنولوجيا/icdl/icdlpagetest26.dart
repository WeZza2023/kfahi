...
import 'icdlpage26.dart';
import 'icdlpage27.dart';

class icdlpagetest26 extends StatefulWidget {
  const icdlpagetest26({super.key});

  @override
  _icdlpagetest26State createState() => _icdlpagetest26State();
}

class _icdlpagetest26State extends State<icdlpagetest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage26()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage27()));
              },
