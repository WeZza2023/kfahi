...
import 'icdlpage18.dart';
import 'icdlpage19.dart';

class icdlpagetest18 extends StatefulWidget {
  const icdlpagetest18({super.key});

  @override
  _icdlpagetest18State createState() => _icdlpagetest18State();
}

class _icdlpagetest18State extends State<icdlpagetest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage19()));
              },
