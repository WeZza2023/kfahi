...
class ICDLLecsPage extends StatefulWidget {
  ICDLLecsPage({super.key});

  @override
  State<ICDLLecsPage> createState() => _ICDLLecsPageState();
}

class _ICDLLecsPageState extends State<ICDLLecsPage> {
  ...
  Future<void> getDoneLecs() async {
    ...
    final docRef =
        db.collection('users').doc(userUid).collection("courses").doc("ICDL");
