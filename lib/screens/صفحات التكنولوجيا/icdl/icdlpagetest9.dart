...
import 'icdlpage9.dart';

class icdlpagetest9 extends StatefulWidget {
  const icdlpagetest9({super.key});

  @override
  _icdlpagetest9State createState() => _icdlpagetest9State();
}

class _icdlpagetest9State extends State<icdlpagetest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage10()));
              },
