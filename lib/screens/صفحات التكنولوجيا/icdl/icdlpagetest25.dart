...
import 'icdlpage25.dart';
import 'icdlpage26.dart';

class icdlpagetest25 extends StatefulWidget {
  const icdlpagetest25({super.key});

  @override
  _icdlpagetest25State createState() => _icdlpagetest25State();
}

class _icdlpagetest25State extends State<icdlpagetest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const icdlpage25()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const icdlpage26()));
              },
