...
class itpagetest45 extends StatefulWidget {
  const itpagetest45({super.key});

  @override
  _itpagetest45State createState() => _itpagetest45State();
}

class _itpagetest45State extends State<itpagetest45> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage45()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage46()));
              },
