...
import 'itpagetest4.dart';

class itpage4 extends StatefulWidget {
  const itpage4({super.key});

  @override
  _itpage4State createState() => _itpage4State();
}

class _itpage4State extends State<itpage4> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'uc5GKkX-ENI', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest4(),
          ),
        );
      }
    });
