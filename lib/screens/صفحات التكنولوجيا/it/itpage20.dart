...
import 'itpagetest20.dart';

class itpage20 extends StatefulWidget {
  const itpage20({super.key});

  @override
  _itpage20State createState() => _itpage20State();
}

class _itpage20State extends State<itpage20> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'uxS1yaiNNOs', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest20(),
          ),
        );
      }
    });
