...
import 'itpagetest15.dart';

class itpage15 extends StatefulWidget {
  const itpage15({super.key});

  @override
  _itpage15State createState() => _itpage15State();
}

class _itpage15State extends State<itpage15> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '5v_cQ880Mis', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest15(),
          ),
        );
      }
    });
