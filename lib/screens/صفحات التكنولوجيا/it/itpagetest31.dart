...
class itpagetest31 extends StatefulWidget {
  const itpagetest31({super.key});

  @override
  _itpagetest31State createState() => _itpagetest31State();
}

class _itpagetest31State extends State<itpagetest31> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage31()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage32()));
              },
