...
import 'itpage28.dart';
import 'itpage29.dart';

class itpagetest28 extends StatefulWidget {
  const itpagetest28({super.key});

  @override
  _itpagetest28State createState() => _itpagetest28State();
}

class _itpagetest28State extends State<itpagetest28> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage28()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage29()));
              },
