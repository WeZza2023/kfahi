...
import 'itpage15.dart';
import 'itpage16.dart';

class itpagetest15 extends StatefulWidget {
  const itpagetest15({super.key});

  @override
  _itpagetest15State createState() => _itpagetest15State();
}

class _itpagetest15State extends State<itpagetest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage16()));
              },
