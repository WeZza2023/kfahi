...
import 'itpage32.dart';
import 'itpage33.dart';

class itpagetest32 extends StatefulWidget {
  const itpagetest32({super.key});

  @override
  _itpagetest32State createState() => _itpagetest32State();
}

class _itpagetest32State extends State<itpagetest32> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage32()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage33()));
              },
