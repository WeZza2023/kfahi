...
class itpagetest18 extends StatefulWidget {
  const itpagetest18({super.key});

  @override
  _itpagetest18State createState() => _itpagetest18State();
}

class _itpagetest18State extends State<itpagetest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage19()));
              },
