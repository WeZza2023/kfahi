...
class itpagetest4 extends StatefulWidget {
  const itpagetest4({super.key});

  @override
  _itpagetest4State createState() => _itpagetest4State();
}

class _itpagetest4State extends State<itpagetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage5()));
              },
