...
import 'itpage39.dart';

class itpagetest38 extends StatefulWidget {
  const itpagetest38({super.key});

  @override
  _itpagetest38State createState() => _itpagetest38State();
}

class _itpagetest38State extends State<itpagetest38> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage38()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage39()));
              },
