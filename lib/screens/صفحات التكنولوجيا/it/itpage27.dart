...
import 'itpagetest27.dart';

class itpage27 extends StatefulWidget {
  const itpage27({super.key});

  @override
  _itpage27State createState() => _itpage27State();
}

class _itpage27State extends State<itpage27> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '0kFkq9u_eqQ', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest27(),
          ),
        );
      }
    });
