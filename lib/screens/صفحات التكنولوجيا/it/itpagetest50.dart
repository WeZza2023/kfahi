...
class itpagetest50 extends StatefulWidget {
  const itpagetest50({super.key});

  @override
  _itpagetest50State createState() => _itpagetest50State();
}

class _itpagetest50State extends State<itpagetest50> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage50()));
    }
