...
class itpagetest7 extends StatefulWidget {
  const itpagetest7({super.key});

  @override
  _itpagetest7State createState() => _itpagetest7State();
}

class _itpagetest7State extends State<itpagetest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage8()));
              },
