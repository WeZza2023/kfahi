...
class itpagetest2 extends StatefulWidget {
  const itpagetest2({super.key});

  @override
  _itpagetest2State createState() => _itpagetest2State();
}

class _itpagetest2State extends State<itpagetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage3()));
              },
