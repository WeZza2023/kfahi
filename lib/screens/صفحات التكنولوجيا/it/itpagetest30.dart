...
import 'itpage31.dart';

class itpagetest30 extends StatefulWidget {
  const itpagetest30({super.key});

  @override
  _itpagetest30State createState() => _itpagetest30State();
}

class _itpagetest30State extends State<itpagetest30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage30()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage31()));
              },
