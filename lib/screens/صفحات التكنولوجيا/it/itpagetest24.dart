...
import 'itpage24.dart';
import 'itpage25.dart';

class itpagetest24 extends StatefulWidget {
  const itpagetest24({super.key});

  @override
  _itpagetest24State createState() => _itpagetest24State();
}

class _itpagetest24State extends State<itpagetest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage25()));
              },
