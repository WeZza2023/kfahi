...
import 'itpagetest6.dart';

class itpage6 extends StatefulWidget {
  const itpage6({super.key});

  @override
  _itpage6State createState() => _itpage6State();
}

class _itpage6State extends State<itpage6> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '1S0iUTey8Gw', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest6(),
          ),
        );
      }
    });
