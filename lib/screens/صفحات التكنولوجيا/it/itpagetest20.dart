...
class itpagetest20 extends StatefulWidget {
  const itpagetest20({super.key});

  @override
  _itpagetest20State createState() => _itpagetest20State();
}

class _itpagetest20State extends State<itpagetest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage21()));
              },
