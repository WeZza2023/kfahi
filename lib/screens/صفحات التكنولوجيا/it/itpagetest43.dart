...
class itpagetest43 extends StatefulWidget {
  const itpagetest43({super.key});

  @override
  _itpagetest43State createState() => _itpagetest43State();
}

class _itpagetest43State extends State<itpagetest43> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage43()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage44()));
              },
