...
import 'itpage44.dart';
import 'itpage45.dart';

class itpagetest44 extends StatefulWidget {
  const itpagetest44({super.key});

  @override
  _itpagetest44State createState() => _itpagetest44State();
}

class _itpagetest44State extends State<itpagetest44> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage44()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage45()));
              },
