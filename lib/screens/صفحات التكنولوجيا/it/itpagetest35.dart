...
import 'itpage35.dart';
import 'itpage36.dart';

class itpagetest35 extends StatefulWidget {
  const itpagetest35({super.key});

  @override
  _itpagetest35State createState() => _itpagetest35State();
}

class _itpagetest35State extends State<itpagetest35> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage35()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage36()));
              },
