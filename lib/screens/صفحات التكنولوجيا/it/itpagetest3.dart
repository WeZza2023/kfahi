...
class itpagetest3 extends StatefulWidget {
  const itpagetest3({super.key});

  @override
  _itpagetest3State createState() => _itpagetest3State();
}

class _itpagetest3State extends State<itpagetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage4()));
              },
