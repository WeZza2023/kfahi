...
import 'itpage12.dart';

class itpagetest11 extends StatefulWidget {
  const itpagetest11({super.key});

  @override
  _itpagetest11State createState() => _itpagetest11State();
}

class _itpagetest11State extends State<itpagetest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage12()));
              },
