...
class itpagetest5 extends StatefulWidget {
  const itpagetest5({super.key});

  @override
  _itpagetest5State createState() => _itpagetest5State();
}

class _itpagetest5State extends State<itpagetest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage6()));
              },
