...
class itpagetest27 extends StatefulWidget {
  const itpagetest27({super.key});

  @override
  _itpagetest27State createState() => _itpagetest27State();
}

class _itpagetest27State extends State<itpagetest27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage27()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage28()));
              },
