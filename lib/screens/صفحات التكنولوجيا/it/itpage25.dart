...
import 'itpagetest25.dart';

class itpage25 extends StatefulWidget {
  const itpage25({super.key});

  @override
  _itpage25State createState() => _itpage25State();
}

class _itpage25State extends State<itpage25> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'cLz2d0aXObo', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest25(),
          ),
        );
      }
    });
