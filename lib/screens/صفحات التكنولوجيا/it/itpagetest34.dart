...
class itpagetest34 extends StatefulWidget {
  const itpagetest34({super.key});

  @override
  _itpagetest34State createState() => _itpagetest34State();
}

class _itpagetest34State extends State<itpagetest34> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage34()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage35()));
              },
