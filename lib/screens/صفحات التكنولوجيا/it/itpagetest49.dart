...
import 'itpage49.dart';
import 'itpage50.dart';

class itpagetest49 extends StatefulWidget {
  const itpagetest49({super.key});

  @override
  _itpagetest49State createState() => _itpagetest49State();
}

class _itpagetest49State extends State<itpagetest49> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage49()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage50()));
              },
