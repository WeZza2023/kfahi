...
import 'itpage33.dart';
import 'itpage34.dart';

class itpagetest33 extends StatefulWidget {
  const itpagetest33({super.key});

  @override
  _itpagetest33State createState() => _itpagetest33State();
}

class _itpagetest33State extends State<itpagetest33> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage33()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage34()));
              },
