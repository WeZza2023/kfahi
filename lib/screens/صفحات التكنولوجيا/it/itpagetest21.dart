...
import 'itpage21.dart';
import 'itpage22.dart';

class itpagetest21 extends StatefulWidget {
  const itpagetest21({super.key});

  @override
  _itpagetest21State createState() => _itpagetest21State();
}

class _itpagetest21State extends State<itpagetest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage22()));
              },
