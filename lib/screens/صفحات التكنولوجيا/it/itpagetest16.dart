...
class itpagetest16 extends StatefulWidget {
  const itpagetest16({super.key});

  @override
  _itpagetest16State createState() => _itpagetest16State();
}

class _itpagetest16State extends State<itpagetest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage17()));
              },
