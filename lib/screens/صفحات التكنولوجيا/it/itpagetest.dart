...
class ITPageTest extends StatefulWidget {
  const ITPageTest({super.key});

  @override
  _ITPageTestState createState() => _ITPageTestState();
}

class _ITPageTestState extends State<ITPageTest> {
  ...
  List<Map<String, dynamic>> _getRandomQuestions(int count) {
    final random = Random();
    final shuffledQuestions = List<Map<String, dynamic>>.from(ITQues)
      ..shuffle(random);
