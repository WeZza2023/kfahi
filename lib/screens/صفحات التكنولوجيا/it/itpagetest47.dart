...
import 'itpage47.dart';
import 'itpage48.dart';

class itpagetest47 extends StatefulWidget {
  const itpagetest47({super.key});

  @override
  _itpagetest47State createState() => _itpagetest47State();
}

class _itpagetest47State extends State<itpagetest47> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage47()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage48()));
              },
