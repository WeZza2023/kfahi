...
import 'itpage10.dart';
import 'itpage11.dart';

class itpagetest10 extends StatefulWidget {
  const itpagetest10({super.key});

  @override
  _itpagetest10State createState() => _itpagetest10State();
}

class _itpagetest10State extends State<itpagetest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage11()));
              },
