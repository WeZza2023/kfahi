...
import 'itpage17.dart';
import 'itpage18.dart';

class itpagetest17 extends StatefulWidget {
  const itpagetest17({super.key});

  @override
  _itpagetest17State createState() => _itpagetest17State();
}

class _itpagetest17State extends State<itpagetest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage18()));
              },
