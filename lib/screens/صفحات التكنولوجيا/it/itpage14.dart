...
import 'itpagetest14.dart';

class itpage14 extends StatefulWidget {
  const itpage14({super.key});

  @override
  _itpage14State createState() => _itpage14State();
}

class _itpage14State extends State<itpage14> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'akbA4ENTSJE', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest14(),
          ),
        );
      }
    });
