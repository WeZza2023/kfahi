...
import 'itpage30.dart';

class itpagetest29 extends StatefulWidget {
  const itpagetest29({super.key});

  @override
  _itpagetest29State createState() => _itpagetest29State();
}

class _itpagetest29State extends State<itpagetest29> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage29()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage30()));
              },
