...
class itpagetest12 extends StatefulWidget {
  const itpagetest12({super.key});

  @override
  _itpagetest12State createState() => _itpagetest12State();
}

class _itpagetest12State extends State<itpagetest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage13()));
              },
