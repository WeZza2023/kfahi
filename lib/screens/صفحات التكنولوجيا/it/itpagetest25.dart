...
import 'itpage26.dart';

class itpagetest25 extends StatefulWidget {
  const itpagetest25({super.key});

  @override
  _itpagetest25State createState() => _itpagetest25State();
}

class _itpagetest25State extends State<itpagetest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage25()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage26()));
              },
