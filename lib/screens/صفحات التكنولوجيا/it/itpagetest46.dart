...
import 'itpage46.dart';
import 'itpage47.dart';

class itpagetest46 extends StatefulWidget {
  const itpagetest46({super.key});

  @override
  _itpagetest46State createState() => _itpagetest46State();
}

class _itpagetest46State extends State<itpagetest46> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage46()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage47()));
              },
