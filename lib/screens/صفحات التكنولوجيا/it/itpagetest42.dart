...
import 'itpage42.dart';
import 'itpage43.dart';

class itpagetest42 extends StatefulWidget {
  const itpagetest42({super.key});

  @override
  _itpagetest42State createState() => _itpagetest42State();
}

class _itpagetest42State extends State<itpagetest42> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage42()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage43()));
              },
