...
class itpagetest39 extends StatefulWidget {
  const itpagetest39({super.key});

  @override
  _itpagetest39State createState() => _itpagetest39State();
}

class _itpagetest39State extends State<itpagetest39> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage39()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage40()));
              },
