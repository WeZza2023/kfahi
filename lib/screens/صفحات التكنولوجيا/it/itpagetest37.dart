...
import 'itpage37.dart';
import 'itpage38.dart';

class itpagetest37 extends StatefulWidget {
  const itpagetest37({super.key});

  @override
  _itpagetest37State createState() => _itpagetest37State();
}

class _itpagetest37State extends State<itpagetest37> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage37()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage38()));
              },
