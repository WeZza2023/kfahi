...
class itpagetest6 extends StatefulWidget {
  const itpagetest6({super.key});

  @override
  _itpagetest6State createState() => _itpagetest6State();
}

class _itpagetest6State extends State<itpagetest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage7()));
              },
