...
import 'itpage22.dart';
import 'itpage23.dart';

class itpagetest22 extends StatefulWidget {
  const itpagetest22({super.key});

  @override
  _itpagetest22State createState() => _itpagetest22State();
}

class _itpagetest22State extends State<itpagetest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage23()));
              },
