...
class itpagetest36 extends StatefulWidget {
  const itpagetest36({super.key});

  @override
  _itpagetest36State createState() => _itpagetest36State();
}

class _itpagetest36State extends State<itpagetest36> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage36()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage37()));
              },
