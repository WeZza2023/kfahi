...
import 'itpage27.dart';

class itpagetest26 extends StatefulWidget {
  const itpagetest26({super.key});

  @override
  _itpagetest26State createState() => _itpagetest26State();
}

class _itpagetest26State extends State<itpagetest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage26()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage27()));
              },
