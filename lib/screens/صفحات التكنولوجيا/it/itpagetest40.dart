...
import 'itpage40.dart';
import 'itpage41.dart';

class itpagetest40 extends StatefulWidget {
  const itpagetest40({super.key});

  @override
  _itpagetest40State createState() => _itpagetest40State();
}

class _itpagetest40State extends State<itpagetest40> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage40()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage41()));
              },
