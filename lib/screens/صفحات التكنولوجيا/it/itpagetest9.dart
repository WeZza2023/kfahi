...
class itpagetest9 extends StatefulWidget {
  const itpagetest9({super.key});

  @override
  _itpagetest9State createState() => _itpagetest9State();
}

class _itpagetest9State extends State<itpagetest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage10()));
              },
