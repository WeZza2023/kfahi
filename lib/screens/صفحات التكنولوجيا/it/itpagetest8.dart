...
class itpagetest8 extends StatefulWidget {
  const itpagetest8({super.key});

  @override
  _itpagetest8State createState() => _itpagetest8State();
}

class _itpagetest8State extends State<itpagetest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage9()));
              },
