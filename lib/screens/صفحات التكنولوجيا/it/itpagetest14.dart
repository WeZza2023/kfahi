...
class itpagetest14 extends StatefulWidget {
  const itpagetest14({super.key});

  @override
  _itpagetest14State createState() => _itpagetest14State();
}

class _itpagetest14State extends State<itpagetest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage15()));
              },
