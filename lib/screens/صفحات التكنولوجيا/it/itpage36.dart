...
import 'itpagetest36.dart';

class itpage36 extends StatefulWidget {
  const itpage36({super.key});

  @override
  _itpage36State createState() => _itpage36State();
}

class _itpage36State extends State<itpage36> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'Vk5Gm87TBOQ', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest36(),
          ),
        );
      }
    });
