...
import 'itpagetest22.dart';

class itpage22 extends StatefulWidget {
  const itpage22({super.key});

  @override
  _itpage22State createState() => _itpage22State();
}

class _itpage22State extends State<itpage22> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '5iuIbeOMVsY', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest22(),
          ),
        );
      }
    });
