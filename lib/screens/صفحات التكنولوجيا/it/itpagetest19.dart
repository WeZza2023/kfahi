...
import 'itpage19.dart';
import 'itpage20.dart';

class itpagetest19 extends StatefulWidget {
  const itpagetest19({super.key});

  @override
  _itpagetest19State createState() => _itpagetest19State();
}

class _itpagetest19State extends State<itpagetest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage20()));
              },
