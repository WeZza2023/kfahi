...
import 'itpagetest3.dart';

class itpage3 extends StatefulWidget {
  const itpage3({super.key});

  @override
  _itpage3State createState() => _itpage3State();
}

class _itpage3State extends State<itpage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: '2Hl_ZVvB8S8', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest3(),
          ),
        );
      }
    });
