...
import 'itpage23.dart';
import 'itpage24.dart';

class itpagetest23 extends StatefulWidget {
  const itpagetest23({super.key});

  @override
  _itpagetest23State createState() => _itpagetest23State();
}

class _itpagetest23State extends State<itpagetest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage24()));
              },
