...
class itpagetest41 extends StatefulWidget {
  const itpagetest41({super.key});

  @override
  _itpagetest41State createState() => _itpagetest41State();
}

class _itpagetest41State extends State<itpagetest41> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage41()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage42()));
              },
