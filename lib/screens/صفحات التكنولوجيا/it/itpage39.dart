...
import 'itpagetest39.dart';

class itpage39 extends StatefulWidget {
  const itpage39({super.key});

  @override
  _itpage39State createState() => _itpage39State();
}

class _itpage39State extends State<itpage39> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'oYC9ymuQw5g', // Update the video ID here
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const itpagetest39(),
          ),
        );
      }
    });
