...
class itpagetest48 extends StatefulWidget {
  const itpagetest48({super.key});

  @override
  _itpagetest48State createState() => _itpagetest48State();
}

class _itpagetest48State extends State<itpagetest48> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const itpage48()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const itpage49()));
              },
