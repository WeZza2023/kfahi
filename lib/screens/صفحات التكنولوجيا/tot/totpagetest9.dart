...
import 'totpage9.dart';

class totpagetest9 extends StatefulWidget {
  const totpagetest9({super.key});

  @override
  _totpagetest9State createState() => _totpagetest9State();
}

class _totpagetest9State extends State<totpagetest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage10()));
              },
