...
class totpagetest1 extends StatefulWidget {
  const totpagetest1({super.key});

  @override
  _totpagetest1State createState() => _totpagetest1State();
}

class _totpagetest1State extends State<totpagetest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage2()));
              },
