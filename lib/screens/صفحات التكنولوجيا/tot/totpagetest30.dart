...
import 'totpage30.dart';
import 'totpage31.dart';

class totpagetest30 extends StatefulWidget {
  const totpagetest30({super.key});

  @override
  _totpagetest30State createState() => _totpagetest30State();
}

class _totpagetest30State extends State<totpagetest30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage30()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage31()));
              },
