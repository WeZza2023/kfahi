...
import 'totpage2.dart';
import 'totpage3.dart';

class totpagetest2 extends StatefulWidget {
  const totpagetest2({super.key});

  @override
  _totpagetest2State createState() => _totpagetest2State();
}

class _totpagetest2State extends State<totpagetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage3()));
              },
