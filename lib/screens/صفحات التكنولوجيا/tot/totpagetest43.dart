...
import 'totpage43.dart';
import 'totpage44.dart';

class totpagetest43 extends StatefulWidget {
  const totpagetest43({super.key});

  @override
  _totpagetest43State createState() => _totpagetest43State();
}

class _totpagetest43State extends State<totpagetest43> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage43()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage44()));
              },
