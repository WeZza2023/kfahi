...
import 'totpage37.dart';

class totpagetest36 extends StatefulWidget {
  const totpagetest36({super.key});

  @override
  _totpagetest36State createState() => _totpagetest36State();
}

class _totpagetest36State extends State<totpagetest36> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage36()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage37()));
              },
