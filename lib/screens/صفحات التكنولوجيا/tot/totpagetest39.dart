...
import 'totpage40.dart';

class totpagetest39 extends StatefulWidget {
  const totpagetest39({super.key});

  @override
  _totpagetest39State createState() => _totpagetest39State();
}

class _totpagetest39State extends State<totpagetest39> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage39()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage40()));
              },
