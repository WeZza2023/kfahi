...
class totpagetest37 extends StatefulWidget {
  const totpagetest37({super.key});

  @override
  _totpagetest37State createState() => _totpagetest37State();
}

class _totpagetest37State extends State<totpagetest37> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage37()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage38()));
              },
