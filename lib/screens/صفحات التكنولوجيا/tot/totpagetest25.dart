...
import 'totpage25.dart';
import 'totpage26.dart';

class totpagetest25 extends StatefulWidget {
  const totpagetest25({super.key});

  @override
  _totpagetest25State createState() => _totpagetest25State();
}

class _totpagetest25State extends State<totpagetest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage25()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage26()));
              },
