...
import 'totpage10.dart';
import 'totpage11.dart';

class totpagetest10 extends StatefulWidget {
  const totpagetest10({super.key});

  @override
  _totpagetest10State createState() => _totpagetest10State();
}

class _totpagetest10State extends State<totpagetest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage11()));
              },
