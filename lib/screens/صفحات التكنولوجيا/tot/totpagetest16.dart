...
import 'totpage16.dart';
import 'totpage17.dart';

class totpagetest16 extends StatefulWidget {
  const totpagetest16({super.key});

  @override
  _totpagetest16State createState() => _totpagetest16State();
}

class _totpagetest16State extends State<totpagetest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage17()));
              },
