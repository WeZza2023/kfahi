...
class totpagetest5 extends StatefulWidget {
  const totpagetest5({super.key});

  @override
  _totpagetest5State createState() => _totpagetest5State();
}

class _totpagetest5State extends State<totpagetest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage6()));
              },
