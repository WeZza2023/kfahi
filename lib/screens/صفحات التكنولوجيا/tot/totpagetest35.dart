...
import 'totpage35.dart';
import 'totpage36.dart';

class totpagetest35 extends StatefulWidget {
  const totpagetest35({super.key});

  @override
  _totpagetest35State createState() => _totpagetest35State();
}

class _totpagetest35State extends State<totpagetest35> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage35()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage36()));
              },
