...
class totpagetest28 extends StatefulWidget {
  const totpagetest28({super.key});

  @override
  _totpagetest28State createState() => _totpagetest28State();
}

class _totpagetest28State extends State<totpagetest28> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage28()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage29()));
              },
