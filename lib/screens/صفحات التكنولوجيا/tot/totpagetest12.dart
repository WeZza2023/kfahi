...
class totpagetest12 extends StatefulWidget {
  const totpagetest12({super.key});

  @override
  _totpagetest12State createState() => _totpagetest12State();
}

class _totpagetest12State extends State<totpagetest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage13()));
              },
