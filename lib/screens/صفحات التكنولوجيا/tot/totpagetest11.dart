...
import 'totpage11.dart';
import 'totpage12.dart';

class totpagetest11 extends StatefulWidget {
  const totpagetest11({super.key});

  @override
  _totpagetest11State createState() => _totpagetest11State();
}

class _totpagetest11State extends State<totpagetest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage12()));
              },
