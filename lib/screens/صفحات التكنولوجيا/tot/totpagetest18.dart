...
class totpagetest18 extends StatefulWidget {
  const totpagetest18({super.key});

  @override
  _totpagetest18State createState() => _totpagetest18State();
}

class _totpagetest18State extends State<totpagetest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage19()));
              },
