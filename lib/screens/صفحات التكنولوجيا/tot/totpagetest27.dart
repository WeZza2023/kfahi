...
import 'totpage28.dart';

class totpagetest27 extends StatefulWidget {
  const totpagetest27({super.key});

  @override
  _totpagetest27State createState() => _totpagetest27State();
}

class _totpagetest27State extends State<totpagetest27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage27()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage28()));
              },
