...
import 'totpage29.dart';
import 'totpage30.dart';

class totpagetest29 extends StatefulWidget {
  const totpagetest29({super.key});

  @override
  _totpagetest29State createState() => _totpagetest29State();
}

class _totpagetest29State extends State<totpagetest29> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage29()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage30()));
              },
