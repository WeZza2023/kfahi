...
import 'totpage33.dart';

class totpagetest32 extends StatefulWidget {
  const totpagetest32({super.key});

  @override
  _totpagetest32State createState() => _totpagetest32State();
}

class _totpagetest32State extends State<totpagetest32> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage32()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage33()));
              },
