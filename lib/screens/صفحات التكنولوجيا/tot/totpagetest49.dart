...
class totpagetest49 extends StatefulWidget {
  const totpagetest49({super.key});

  @override
  _totpagetest49State createState() => _totpagetest49State();
}

class _totpagetest49State extends State<totpagetest49> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage49()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage50()));
              },
