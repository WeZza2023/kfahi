...
import 'totpage19.dart';
import 'totpage20.dart';

class totpagetest19 extends StatefulWidget {
  const totpagetest19({super.key});

  @override
  _totpagetest19State createState() => _totpagetest19State();
}

class _totpagetest19State extends State<totpagetest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage20()));
              },
