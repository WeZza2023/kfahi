...
import 'totpage13.dart';
import 'totpage14.dart';

class totpagetest13 extends StatefulWidget {
  const totpagetest13({super.key});

  @override
  _totpagetest13State createState() => _totpagetest13State();
}

class _totpagetest13State extends State<totpagetest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage14()));
              },
