...
class totpagetest42 extends StatefulWidget {
  const totpagetest42({super.key});

  @override
  _totpagetest42State createState() => _totpagetest42State();
}

class _totpagetest42State extends State<totpagetest42> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage42()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage43()));
              },
