...
import 'totpage6.dart';
import 'totpage7.dart';

class totpagetest6 extends StatefulWidget {
  const totpagetest6({super.key});

  @override
  _totpagetest6State createState() => _totpagetest6State();
}

class _totpagetest6State extends State<totpagetest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage7()));
              },
