...
import 'totpage27.dart';

class totpagetest26 extends StatefulWidget {
  const totpagetest26({super.key});

  @override
  _totpagetest26State createState() => _totpagetest26State();
}

class _totpagetest26State extends State<totpagetest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage26()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage27()));
              },
