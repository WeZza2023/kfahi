...
import 'totpagetest4.dart';

class totpage4 extends StatefulWidget {
  const totpage4({super.key});

  @override
  _totpage4State createState() => _totpage4State();
}

class _totpage4State extends State<totpage4> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'uSoZ2N41_3g', // تغيير الرمز المميز للفيديو الجديد هنا
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const totpagetest4(),
          ),
        );
      }
    });
