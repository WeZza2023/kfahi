...
import 'totpage18.dart';

class totpagetest17 extends StatefulWidget {
  const totpagetest17({super.key});

  @override
  _totpagetest17State createState() => _totpagetest17State();
}

class _totpagetest17State extends State<totpagetest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage18()));
              },
