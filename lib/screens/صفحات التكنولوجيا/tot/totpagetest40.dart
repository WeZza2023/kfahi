...
class totpagetest40 extends StatefulWidget {
  const totpagetest40({super.key});

  @override
  _totpagetest40State createState() => _totpagetest40State();
}

class _totpagetest40State extends State<totpagetest40> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage40()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage41()));
              },
