...
import 'totpagetest3.dart';

class totpage3 extends StatefulWidget {
  const totpage3({super.key});

  @override
  _totpage3State createState() => _totpage3State();
}

class _totpage3State extends State<totpage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'mXMsJ1gATSw', // تغيير الرمز المميز للفيديو الجديد هنا
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const totpagetest3(),
          ),
        );
      }
    });
