...
import 'totpage41.dart';
import 'totpage42.dart';

class totpagetest41 extends StatefulWidget {
  const totpagetest41({super.key});

  @override
  _totpagetest41State createState() => _totpagetest41State();
}

class _totpagetest41State extends State<totpagetest41> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage41()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage42()));
              },
