...
import 'totpage7.dart';
import 'totpage8.dart';

class totpagetest7 extends StatefulWidget {
  const totpagetest7({super.key});

  @override
  _totpagetest7State createState() => _totpagetest7State();
}

class _totpagetest7State extends State<totpagetest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage8()));
              },
