...
import 'totpage4.dart';
import 'totpage5.dart';

class totpagetest4 extends StatefulWidget {
  const totpagetest4({super.key});

  @override
  _totpagetest4State createState() => _totpagetest4State();
}

class _totpagetest4State extends State<totpagetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage5()));
              },
