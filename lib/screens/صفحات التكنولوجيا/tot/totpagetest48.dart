...
import 'totpage49.dart';

class totpagetest48 extends StatefulWidget {
  const totpagetest48({super.key});

  @override
  _totpagetest48State createState() => _totpagetest48State();
}

class _totpagetest48State extends State<totpagetest48> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage48()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage49()));
              },
