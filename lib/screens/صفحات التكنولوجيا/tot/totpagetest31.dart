...
import 'totpage32.dart';

class totpagetest31 extends StatefulWidget {
  const totpagetest31({super.key});

  @override
  _totpagetest31State createState() => _totpagetest31State();
}

class _totpagetest31State extends State<totpagetest31> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage31()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage32()));
              },
