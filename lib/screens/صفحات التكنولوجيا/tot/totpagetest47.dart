...
import 'totpage47.dart';
import 'totpage48.dart';

class totpagetest47 extends StatefulWidget {
  const totpagetest47({super.key});

  @override
  _totpagetest47State createState() => _totpagetest47State();
}

class _totpagetest47State extends State<totpagetest47> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage47()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage48()));
              },
