...
class totpagetest21 extends StatefulWidget {
  const totpagetest21({super.key});

  @override
  _totpagetest21State createState() => _totpagetest21State();
}

class _totpagetest21State extends State<totpagetest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage22()));
              },
