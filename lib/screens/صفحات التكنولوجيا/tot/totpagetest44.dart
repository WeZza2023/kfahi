...
import 'totpage44.dart';
import 'totpage45.dart';

class totpagetest44 extends StatefulWidget {
  const totpagetest44({super.key});

  @override
  _totpagetest44State createState() => _totpagetest44State();
}

class _totpagetest44State extends State<totpagetest44> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage44()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage45()));
              },
