...
import 'totpage34.dart';
import 'totpage35.dart';

class totpagetest34 extends StatefulWidget {
  const totpagetest34({super.key});

  @override
  _totpagetest34State createState() => _totpagetest34State();
}

class _totpagetest34State extends State<totpagetest34> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage34()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage35()));
              },
