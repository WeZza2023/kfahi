...
import 'totpage24.dart';

class totpagetest23 extends StatefulWidget {
  const totpagetest23({super.key});

  @override
  _totpagetest23State createState() => _totpagetest23State();
}

class _totpagetest23State extends State<totpagetest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage24()));
              },
