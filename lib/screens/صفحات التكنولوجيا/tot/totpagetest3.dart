...
class totpagetest3 extends StatefulWidget {
  const totpagetest3({super.key});

  @override
  _totpagetest3State createState() => _totpagetest3State();
}

class _totpagetest3State extends State<totpagetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage4()));
              },
