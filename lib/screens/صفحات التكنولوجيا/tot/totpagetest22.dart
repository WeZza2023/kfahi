...
import 'totpage22.dart';
import 'totpage23.dart';

class totpagetest22 extends StatefulWidget {
  const totpagetest22({super.key});

  @override
  _totpagetest22State createState() => _totpagetest22State();
}

class _totpagetest22State extends State<totpagetest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage23()));
              },
