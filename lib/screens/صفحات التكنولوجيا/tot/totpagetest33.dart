...
class totpagetest33 extends StatefulWidget {
  const totpagetest33({super.key});

  @override
  _totpagetest33State createState() => _totpagetest33State();
}

class _totpagetest33State extends State<totpagetest33> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage33()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage34()));
              },
