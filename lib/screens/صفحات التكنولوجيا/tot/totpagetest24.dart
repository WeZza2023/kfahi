...
class totpagetest24 extends StatefulWidget {
  const totpagetest24({super.key});

  @override
  _totpagetest24State createState() => _totpagetest24State();
}

class _totpagetest24State extends State<totpagetest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage25()));
              },
