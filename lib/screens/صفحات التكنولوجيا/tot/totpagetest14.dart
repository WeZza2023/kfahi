...
import 'totpage15.dart';

class totpagetest14 extends StatefulWidget {
  const totpagetest14({super.key});

  @override
  _totpagetest14State createState() => _totpagetest14State();
}

class _totpagetest14State extends State<totpagetest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage15()));
              },
