...
import 'totpage21.dart';

class totpagetest20 extends StatefulWidget {
  const totpagetest20({super.key});

  @override
  _totpagetest20State createState() => _totpagetest20State();
}

class _totpagetest20State extends State<totpagetest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage21()));
              },
