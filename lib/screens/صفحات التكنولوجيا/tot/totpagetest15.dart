...
class totpagetest15 extends StatefulWidget {
  const totpagetest15({super.key});

  @override
  _totpagetest15State createState() => _totpagetest15State();
}

class _totpagetest15State extends State<totpagetest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage16()));
              },
