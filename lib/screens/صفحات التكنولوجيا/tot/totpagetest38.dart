...
import 'totpage38.dart';
import 'totpage39.dart';

class totpagetest38 extends StatefulWidget {
  const totpagetest38({super.key});

  @override
  _totpagetest38State createState() => _totpagetest38State();
}

class _totpagetest38State extends State<totpagetest38> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage38()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage39()));
              },
