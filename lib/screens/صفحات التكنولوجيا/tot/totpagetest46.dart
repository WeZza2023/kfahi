...
class totpagetest46 extends StatefulWidget {
  const totpagetest46({super.key});

  @override
  _totpagetest46State createState() => _totpagetest46State();
}

class _totpagetest46State extends State<totpagetest46> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage46()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage47()));
              },
