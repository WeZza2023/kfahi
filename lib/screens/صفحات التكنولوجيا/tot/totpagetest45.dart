...
import 'totpage46.dart';

class totpagetest45 extends StatefulWidget {
  const totpagetest45({super.key});

  @override
  _totpagetest45State createState() => _totpagetest45State();
}

class _totpagetest45State extends State<totpagetest45> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage45()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage46()));
              },
