...
class totpagetest8 extends StatefulWidget {
  const totpagetest8({super.key});

  @override
  _totpagetest8State createState() => _totpagetest8State();
}

class _totpagetest8State extends State<totpagetest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const totpage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const totpage9()));
              },
