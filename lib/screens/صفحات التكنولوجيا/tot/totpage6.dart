...
import 'totpagetest6.dart';

class totpage6 extends StatefulWidget {
  const totpage6({super.key});

  @override
  _totpage6State createState() => _totpage6State();
}

class _totpage6State extends State<totpage6> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'F6wK_G3dQWQ', // تغيير الرمز المميز للفيديو الجديد هنا
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const totpagetest6(),
          ),
        );
      }
    });
