...
class WordPressDeveloperPageexam40 extends StatefulWidget {
  const WordPressDeveloperPageexam40({super.key});

  @override
  _WordPressDeveloperPageexam40State createState() =>
      _WordPressDeveloperPageexam40State();
}

class _WordPressDeveloperPageexam40State
    extends State<WordPressDeveloperPageexam40> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage40()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage41()));
              },
