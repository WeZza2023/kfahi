...
import 'WordPressDeveloperPage106.dart';

class WordPressDeveloperPageexam105 extends StatefulWidget {
  const WordPressDeveloperPageexam105({super.key});

  @override
  _WordPressDeveloperPageexam105State createState() =>
      _WordPressDeveloperPageexam105State();
}

class _WordPressDeveloperPageexam105State
    extends State<WordPressDeveloperPageexam105> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage105()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 105'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage106()));
              },
