...
import 'WordPressDeveloperPage97.dart';
import 'WordPressDeveloperPage98.dart';

class WordPressDeveloperPageexam97 extends StatefulWidget {
  const WordPressDeveloperPageexam97({super.key});

  @override
  _WordPressDeveloperPageexam97State createState() =>
      _WordPressDeveloperPageexam97State();
}

class _WordPressDeveloperPageexam97State
    extends State<WordPressDeveloperPageexam97> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage97()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 97'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage98()));
              },
