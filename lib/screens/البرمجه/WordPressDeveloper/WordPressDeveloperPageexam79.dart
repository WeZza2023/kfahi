...
import 'WordPressDeveloperPage80.dart';

class WordPressDeveloperPageexam79 extends StatefulWidget {
  const WordPressDeveloperPageexam79({super.key});

  @override
  _WordPressDeveloperPageexam79State createState() =>
      _WordPressDeveloperPageexam79State();
}

class _WordPressDeveloperPageexam79State
    extends State<WordPressDeveloperPageexam79> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage79()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 79'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage80()));
              },
