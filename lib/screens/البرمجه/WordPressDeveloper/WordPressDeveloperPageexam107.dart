...
import 'WordPressDeveloperPage107.dart';
import 'WordPressDeveloperPage108.dart';

class WordPressDeveloperPageexam107 extends StatefulWidget {
  const WordPressDeveloperPageexam107({super.key});

  @override
  _WordPressDeveloperPageexam107State createState() =>
      _WordPressDeveloperPageexam107State();
}

class _WordPressDeveloperPageexam107State
    extends State<WordPressDeveloperPageexam107> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage107()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 107'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage108()));
              },
