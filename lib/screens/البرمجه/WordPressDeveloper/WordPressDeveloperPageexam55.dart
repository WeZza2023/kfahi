...
import 'WordPressDeveloperPage55.dart';
import 'WordPressDeveloperPage56.dart';

class WordPressDeveloperPageexam55 extends StatefulWidget {
  const WordPressDeveloperPageexam55({super.key});

  @override
  _WordPressDeveloperPageexam55State createState() =>
      _WordPressDeveloperPageexam55State();
}

class _WordPressDeveloperPageexam55State
    extends State<WordPressDeveloperPageexam55> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage55()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 55'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage56()));
              },
