...
import 'WordPressDeveloperPage73.dart';
import 'WordPressDeveloperPage74.dart';

class WordPressDeveloperPageexam73 extends StatefulWidget {
  const WordPressDeveloperPageexam73({super.key});

  @override
  _WordPressDeveloperPageexam73State createState() =>
      _WordPressDeveloperPageexam73State();
}

class _WordPressDeveloperPageexam73State
    extends State<WordPressDeveloperPageexam73> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage73()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 73'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage74()));
              },
