...
class WordPressDeveloperPageexam31 extends StatefulWidget {
  const WordPressDeveloperPageexam31({super.key});

  @override
  _WordPressDeveloperPageexam31State createState() =>
      _WordPressDeveloperPageexam31State();
}

class _WordPressDeveloperPageexam31State
    extends State<WordPressDeveloperPageexam31> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage31()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage32()));
              },
