...
class WordPressDeveloperPageexam12 extends StatefulWidget {
  const WordPressDeveloperPageexam12({super.key});

  @override
  _WordPressDeveloperPageexam12State createState() =>
      _WordPressDeveloperPageexam12State();
}

class _WordPressDeveloperPageexam12State
    extends State<WordPressDeveloperPageexam12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage13()));
              },
