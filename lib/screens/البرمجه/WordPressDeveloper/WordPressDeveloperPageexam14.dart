...
class WordPressDeveloperPageexam14 extends StatefulWidget {
  const WordPressDeveloperPageexam14({super.key});

  @override
  _WordPressDeveloperPageexam14State createState() =>
      _WordPressDeveloperPageexam14State();
}

class _WordPressDeveloperPageexam14State
    extends State<WordPressDeveloperPageexam14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage15()));
              },
