...
import 'WordPressDeveloperPage102.dart';
import 'WordPressDeveloperPage103.dart';

class WordPressDeveloperPageexam102 extends StatefulWidget {
  const WordPressDeveloperPageexam102({super.key});

  @override
  _WordPressDeveloperPageexam102State createState() =>
      _WordPressDeveloperPageexam102State();
}

class _WordPressDeveloperPageexam102State
    extends State<WordPressDeveloperPageexam102> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage102()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 102'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage103()));
              },
