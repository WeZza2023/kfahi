...
class WordPressDeveloperPageexam30 extends StatefulWidget {
  const WordPressDeveloperPageexam30({super.key});

  @override
  _WordPressDeveloperPageexam30State createState() =>
      _WordPressDeveloperPageexam30State();
}

class _WordPressDeveloperPageexam30State
    extends State<WordPressDeveloperPageexam30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage30()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage31()));
              },
