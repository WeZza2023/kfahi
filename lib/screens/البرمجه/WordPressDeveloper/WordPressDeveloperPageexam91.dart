...
class WordPressDeveloperPageexam91 extends StatefulWidget {
  const WordPressDeveloperPageexam91({super.key});

  @override
  _WordPressDeveloperPageexam91State createState() =>
      _WordPressDeveloperPageexam91State();
}

class _WordPressDeveloperPageexam91State
    extends State<WordPressDeveloperPageexam91> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage91()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 91'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage92()));
              },
