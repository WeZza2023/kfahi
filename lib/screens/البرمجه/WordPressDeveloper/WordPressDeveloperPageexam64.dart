...
import 'WordPressDeveloperPage64.dart';
import 'WordPressDeveloperPage65.dart';

class WordPressDeveloperPageexam64 extends StatefulWidget {
  const WordPressDeveloperPageexam64({super.key});

  @override
  _WordPressDeveloperPageexam64State createState() =>
      _WordPressDeveloperPageexam64State();
}

class _WordPressDeveloperPageexam64State
    extends State<WordPressDeveloperPageexam64> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage64()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 64'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage65()));
              },
