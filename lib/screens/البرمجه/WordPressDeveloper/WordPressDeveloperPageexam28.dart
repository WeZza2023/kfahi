...
class WordPressDeveloperPageexam28 extends StatefulWidget {
  const WordPressDeveloperPageexam28({super.key});

  @override
  _WordPressDeveloperPageexam28State createState() =>
      _WordPressDeveloperPageexam28State();
}

class _WordPressDeveloperPageexam28State
    extends State<WordPressDeveloperPageexam28> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage28()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage29()));
              },
