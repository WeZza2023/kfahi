...
import 'WordPressDeveloperPage77.dart';
import 'WordPressDeveloperPage78.dart';

class WordPressDeveloperPageexam77 extends StatefulWidget {
  const WordPressDeveloperPageexam77({super.key});

  @override
  _WordPressDeveloperPageexam77State createState() =>
      _WordPressDeveloperPageexam77State();
}

class _WordPressDeveloperPageexam77State
    extends State<WordPressDeveloperPageexam77> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage77()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 77'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage78()));
              },
