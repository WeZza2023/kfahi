...
import 'WordPressDeveloperPage75.dart';
import 'WordPressDeveloperPage76.dart';

class WordPressDeveloperPageexam75 extends StatefulWidget {
  const WordPressDeveloperPageexam75({super.key});

  @override
  _WordPressDeveloperPageexam75State createState() =>
      _WordPressDeveloperPageexam75State();
}

class _WordPressDeveloperPageexam75State
    extends State<WordPressDeveloperPageexam75> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage75()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 75'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage76()));
              },
