...
import 'WordPressDeveloperPage98.dart';
import 'WordPressDeveloperPage99.dart';

class WordPressDeveloperPageexam98 extends StatefulWidget {
  const WordPressDeveloperPageexam98({super.key});

  @override
  _WordPressDeveloperPageexam98State createState() =>
      _WordPressDeveloperPageexam98State();
}

class _WordPressDeveloperPageexam98State
    extends State<WordPressDeveloperPageexam98> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage98()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 98'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage99()));
              },
