...
import 'WordPressDeveloperPage66.dart';
import 'WordPressDeveloperPage67.dart';

class WordPressDeveloperPageexam66 extends StatefulWidget {
  const WordPressDeveloperPageexam66({super.key});

  @override
  _WordPressDeveloperPageexam66State createState() =>
      _WordPressDeveloperPageexam66State();
}

class _WordPressDeveloperPageexam66State
    extends State<WordPressDeveloperPageexam66> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage66()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 66'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage67()));
              },
