...
import 'WordPressDeveloperPage2.dart';
import 'WordPressDeveloperPage3.dart';

class WordPressDeveloperPageexam2 extends StatefulWidget {
  const WordPressDeveloperPageexam2({super.key});

  @override
  _WordPressDeveloperPageexam2State createState() =>
      _WordPressDeveloperPageexam2State();
}

class _WordPressDeveloperPageexam2State
    extends State<WordPressDeveloperPageexam2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage2()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره الثانيه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage3()));
              },
