...
import 'WordPressDeveloperPage81.dart';
import 'WordPressDeveloperPage82.dart';

class WordPressDeveloperPageexam81 extends StatefulWidget {
  const WordPressDeveloperPageexam81({super.key});

  @override
  _WordPressDeveloperPageexam81State createState() =>
      _WordPressDeveloperPageexam81State();
}

class _WordPressDeveloperPageexam81State
    extends State<WordPressDeveloperPageexam81> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage81()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 81'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage82()));
              },
