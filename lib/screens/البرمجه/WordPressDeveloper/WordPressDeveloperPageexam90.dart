...
import 'WordPressDeveloperPage90.dart';
import 'WordPressDeveloperPage91.dart';

class WordPressDeveloperPageexam90 extends StatefulWidget {
  const WordPressDeveloperPageexam90({super.key});

  @override
  _WordPressDeveloperPageexam90State createState() =>
      _WordPressDeveloperPageexam90State();
}

class _WordPressDeveloperPageexam90State
    extends State<WordPressDeveloperPageexam90> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage90()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 90'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage91()));
              },
