...
class WordPressDeveloperPageexam10 extends StatefulWidget {
  const WordPressDeveloperPageexam10({super.key});

  @override
  _WordPressDeveloperPageexam10State createState() =>
      _WordPressDeveloperPageexam10State();
}

class _WordPressDeveloperPageexam10State
    extends State<WordPressDeveloperPageexam10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage11()));
              },
