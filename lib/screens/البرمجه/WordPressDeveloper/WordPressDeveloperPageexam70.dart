...
import 'WordPressDeveloperPage70.dart';
import 'WordPressDeveloperPage71.dart';

class WordPressDeveloperPageexam70 extends StatefulWidget {
  const WordPressDeveloperPageexam70({super.key});

  @override
  _WordPressDeveloperPageexam70State createState() =>
      _WordPressDeveloperPageexam70State();
}

class _WordPressDeveloperPageexam70State
    extends State<WordPressDeveloperPageexam70> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage70()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 70'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage71()));
              },
