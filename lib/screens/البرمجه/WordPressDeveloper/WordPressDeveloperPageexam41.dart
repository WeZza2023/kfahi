...
class WordPressDeveloperPageexam41 extends StatefulWidget {
  const WordPressDeveloperPageexam41({super.key});

  @override
  _WordPressDeveloperPageexam41State createState() =>
      _WordPressDeveloperPageexam41State();
}

class _WordPressDeveloperPageexam41State
    extends State<WordPressDeveloperPageexam41> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage41()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage42()));
              },
