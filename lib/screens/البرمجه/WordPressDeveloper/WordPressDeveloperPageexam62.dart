...
import 'WordPressDeveloperPage63.dart';

class WordPressDeveloperPageexam62 extends StatefulWidget {
  const WordPressDeveloperPageexam62({super.key});

  @override
  _WordPressDeveloperPageexam62State createState() =>
      _WordPressDeveloperPageexam62State();
}

class _WordPressDeveloperPageexam62State
    extends State<WordPressDeveloperPageexam62> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage62()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 62'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage63()));
              },
