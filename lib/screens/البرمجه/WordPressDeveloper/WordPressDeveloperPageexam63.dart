...
class WordPressDeveloperPageexam63 extends StatefulWidget {
  const WordPressDeveloperPageexam63({super.key});

  @override
  _WordPressDeveloperPageexam63State createState() =>
      _WordPressDeveloperPageexam63State();
}

class _WordPressDeveloperPageexam63State
    extends State<WordPressDeveloperPageexam63> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage63()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 63'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage64()));
              },
