...
class WordPressDeveloperPageexam43 extends StatefulWidget {
  const WordPressDeveloperPageexam43({super.key});

  @override
  _WordPressDeveloperPageexam43State createState() =>
      _WordPressDeveloperPageexam43State();
}

class _WordPressDeveloperPageexam43State
    extends State<WordPressDeveloperPageexam43> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage43()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage44()));
              },
