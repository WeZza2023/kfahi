...
class WordPressDeveloperPageexam26 extends StatefulWidget {
  const WordPressDeveloperPageexam26({super.key});

  @override
  _WordPressDeveloperPageexam26State createState() =>
      _WordPressDeveloperPageexam26State();
}

class _WordPressDeveloperPageexam26State
    extends State<WordPressDeveloperPageexam26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage26()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage27()));
              },
