...
import 'WordPressDeveloperPage85.dart';
import 'WordPressDeveloperPage86.dart';

class WordPressDeveloperPageexam85 extends StatefulWidget {
  const WordPressDeveloperPageexam85({super.key});

  @override
  _WordPressDeveloperPageexam85State createState() =>
      _WordPressDeveloperPageexam85State();
}

class _WordPressDeveloperPageexam85State
    extends State<WordPressDeveloperPageexam85> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage85()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 85'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage86()));
              },
