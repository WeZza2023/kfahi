...
import 'WordPressDeveloperPage94.dart';
import 'WordPressDeveloperPage95.dart';

class WordPressDeveloperPageexam94 extends StatefulWidget {
  const WordPressDeveloperPageexam94({super.key});

  @override
  _WordPressDeveloperPageexam94State createState() =>
      _WordPressDeveloperPageexam94State();
}

class _WordPressDeveloperPageexam94State
    extends State<WordPressDeveloperPageexam94> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage94()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 94'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage95()));
              },
