...
class WordPressDeveloperPageexam47 extends StatefulWidget {
  const WordPressDeveloperPageexam47({super.key});

  @override
  _WordPressDeveloperPageexam47State createState() =>
      _WordPressDeveloperPageexam47State();
}

class _WordPressDeveloperPageexam47State
    extends State<WordPressDeveloperPageexam47> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage47()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage48()));
              },
