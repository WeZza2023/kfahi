...
import 'WordPressDeveloperPage87.dart';
import 'WordPressDeveloperPage88.dart';

class WordPressDeveloperPageexam87 extends StatefulWidget {
  const WordPressDeveloperPageexam87({super.key});

  @override
  _WordPressDeveloperPageexam87State createState() =>
      _WordPressDeveloperPageexam87State();
}

class _WordPressDeveloperPageexam87State
    extends State<WordPressDeveloperPageexam87> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage87()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 87'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage88()));
              },
