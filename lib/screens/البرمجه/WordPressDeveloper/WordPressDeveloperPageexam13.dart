...
class WordPressDeveloperPageexam13 extends StatefulWidget {
  const WordPressDeveloperPageexam13({super.key});

  @override
  _WordPressDeveloperPageexam13State createState() =>
      _WordPressDeveloperPageexam13State();
}

class _WordPressDeveloperPageexam13State
    extends State<WordPressDeveloperPageexam13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage14()));
              },
