...
class WordPressDeveloperPageexam83 extends StatefulWidget {
  const WordPressDeveloperPageexam83({super.key});

  @override
  _WordPressDeveloperPageexam83State createState() =>
      _WordPressDeveloperPageexam83State();
}

class _WordPressDeveloperPageexam83State
    extends State<WordPressDeveloperPageexam83> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage83()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 83'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage84()));
              },
