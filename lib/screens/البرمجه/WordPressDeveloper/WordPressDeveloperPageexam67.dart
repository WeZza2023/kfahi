...
import 'WordPressDeveloperPage67.dart';
import 'WordPressDeveloperPage68.dart';

class WordPressDeveloperPageexam67 extends StatefulWidget {
  const WordPressDeveloperPageexam67({super.key});

  @override
  _WordPressDeveloperPageexam67State createState() =>
      _WordPressDeveloperPageexam67State();
}

class _WordPressDeveloperPageexam67State
    extends State<WordPressDeveloperPageexam67> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage67()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 67'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage68()));
              },
