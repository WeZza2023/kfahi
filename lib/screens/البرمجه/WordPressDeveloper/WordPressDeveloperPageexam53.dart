...
import 'WordPressDeveloperPage53.dart';
import 'WordPressDeveloperPage54.dart';

class WordPressDeveloperPageexam53 extends StatefulWidget {
  const WordPressDeveloperPageexam53({super.key});

  @override
  _WordPressDeveloperPageexam53State createState() =>
      _WordPressDeveloperPageexam53State();
}

class _WordPressDeveloperPageexam53State
    extends State<WordPressDeveloperPageexam53> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage53()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage54()));
              },
