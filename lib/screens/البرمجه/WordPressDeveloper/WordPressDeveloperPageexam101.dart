...
import 'WordPressDeveloperPage101.dart';
import 'WordPressDeveloperPage102.dart';

class WordPressDeveloperPageexam101 extends StatefulWidget {
  const WordPressDeveloperPageexam101({super.key});

  @override
  _WordPressDeveloperPageexam101State createState() =>
      _WordPressDeveloperPageexam101State();
}

class _WordPressDeveloperPageexam101State
    extends State<WordPressDeveloperPageexam101> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage101()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 101'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage102()));
              },
