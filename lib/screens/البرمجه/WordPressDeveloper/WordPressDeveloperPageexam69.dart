...
class WordPressDeveloperPageexam69 extends StatefulWidget {
  const WordPressDeveloperPageexam69({super.key});

  @override
  _WordPressDeveloperPageexam69State createState() =>
      _WordPressDeveloperPageexam69State();
}

class _WordPressDeveloperPageexam69State
    extends State<WordPressDeveloperPageexam69> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage69()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 69'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage70()));
              },
