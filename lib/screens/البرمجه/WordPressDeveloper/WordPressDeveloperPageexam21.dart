...
class WordPressDeveloperPageexam21 extends StatefulWidget {
  const WordPressDeveloperPageexam21({super.key});

  @override
  _WordPressDeveloperPageexam21State createState() =>
      _WordPressDeveloperPageexam21State();
}

class _WordPressDeveloperPageexam21State
    extends State<WordPressDeveloperPageexam21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage22()));
              },
