...
import 'WordPressDeveloperPage100.dart';
import 'WordPressDeveloperPage101.dart';

class WordPressDeveloperPageexam100 extends StatefulWidget {
  const WordPressDeveloperPageexam100({super.key});

  @override
  _WordPressDeveloperPageexam100State createState() =>
      _WordPressDeveloperPageexam100State();
}

class _WordPressDeveloperPageexam100State
    extends State<WordPressDeveloperPageexam100> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage100()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 100'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage101()));
              },
