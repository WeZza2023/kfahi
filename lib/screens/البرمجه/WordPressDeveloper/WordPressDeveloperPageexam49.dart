...
import 'WordPressDeveloperPage49.dart';
import 'WordPressDeveloperPage50.dart';

class WordPressDeveloperPageexam49 extends StatefulWidget {
  const WordPressDeveloperPageexam49({super.key});

  @override
  _WordPressDeveloperPageexam49State createState() =>
      _WordPressDeveloperPageexam49State();
}

class _WordPressDeveloperPageexam49State
    extends State<WordPressDeveloperPageexam49> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage49()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage50()));
              },
