...
import 'WordPressDeveloperPage56.dart';
import 'WordPressDeveloperPage57.dart';

class WordPressDeveloperPageexam56 extends StatefulWidget {
  const WordPressDeveloperPageexam56({super.key});

  @override
  _WordPressDeveloperPageexam56State createState() =>
      _WordPressDeveloperPageexam56State();
}

class _WordPressDeveloperPageexam56State
    extends State<WordPressDeveloperPageexam56> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage56()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 56'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage57()));
              },
