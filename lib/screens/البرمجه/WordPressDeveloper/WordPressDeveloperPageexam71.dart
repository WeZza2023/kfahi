...
import 'WordPressDeveloperPage71.dart';
import 'WordPressDeveloperPage72.dart';

class WordPressDeveloperPageexam71 extends StatefulWidget {
  const WordPressDeveloperPageexam71({super.key});

  @override
  _WordPressDeveloperPageexam71State createState() =>
      _WordPressDeveloperPageexam71State();
}

class _WordPressDeveloperPageexam71State
    extends State<WordPressDeveloperPageexam71> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage71()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 71'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage72()));
              },
