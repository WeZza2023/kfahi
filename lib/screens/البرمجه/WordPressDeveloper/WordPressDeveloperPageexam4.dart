...
class WordPressDeveloperPageexam4 extends StatefulWidget {
  const WordPressDeveloperPageexam4({super.key});

  @override
  _WordPressDeveloperPageexam4State createState() =>
      _WordPressDeveloperPageexam4State();
}

class _WordPressDeveloperPageexam4State
    extends State<WordPressDeveloperPageexam4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage5()));
              },
