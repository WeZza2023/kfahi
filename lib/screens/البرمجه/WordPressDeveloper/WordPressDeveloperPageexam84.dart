...
import 'WordPressDeveloperPage84.dart';
import 'WordPressDeveloperPage85.dart';

class WordPressDeveloperPageexam84 extends StatefulWidget {
  const WordPressDeveloperPageexam84({super.key});

  @override
  _WordPressDeveloperPageexam84State createState() =>
      _WordPressDeveloperPageexam84State();
}

class _WordPressDeveloperPageexam84State
    extends State<WordPressDeveloperPageexam84> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage84()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage85()));
              },
