...
class WordPressDeveloperPageexam106 extends StatefulWidget {
  const WordPressDeveloperPageexam106({super.key});

  @override
  _WordPressDeveloperPageexam106State createState() =>
      _WordPressDeveloperPageexam106State();
}

class _WordPressDeveloperPageexam106State
    extends State<WordPressDeveloperPageexam106> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage106()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 106'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage107()));
              },
