...
import 'WordPressDeveloperPage58.dart';
import 'WordPressDeveloperPage59.dart';

class WordPressDeveloperPageexam58 extends StatefulWidget {
  const WordPressDeveloperPageexam58({super.key});

  @override
  _WordPressDeveloperPageexam58State createState() =>
      _WordPressDeveloperPageexam58State();
}

class _WordPressDeveloperPageexam58State
    extends State<WordPressDeveloperPageexam58> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage58()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 58'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage59()));
              },
