...
class WordPressDeveloperPageexam3 extends StatefulWidget {
  const WordPressDeveloperPageexam3({super.key});

  @override
  _WordPressDeveloperPageexam3State createState() =>
      _WordPressDeveloperPageexam3State();
}

class _WordPressDeveloperPageexam3State
    extends State<WordPressDeveloperPageexam3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage3()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره الثالثه'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage4()));
              },
