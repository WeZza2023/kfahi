...
import 'WordPressDeveloperPage96.dart';
import 'WordPressDeveloperPage97.dart';

class WordPressDeveloperPageexam96 extends StatefulWidget {
  const WordPressDeveloperPageexam96({super.key});

  @override
  _WordPressDeveloperPageexam96State createState() =>
      _WordPressDeveloperPageexam96State();
}

class _WordPressDeveloperPageexam96State
    extends State<WordPressDeveloperPageexam96> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage96()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 96'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage97()));
              },
