...
import 'WordPressDeveloperPage51.dart';
import 'WordPressDeveloperPage52.dart';

class WordPressDeveloperPageexam51 extends StatefulWidget {
  const WordPressDeveloperPageexam51({super.key});

  @override
  _WordPressDeveloperPageexam51State createState() =>
      _WordPressDeveloperPageexam51State();
}

class _WordPressDeveloperPageexam51State
    extends State<WordPressDeveloperPageexam51> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage51()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage52()));
              },
