...
class WordPressDeveloperPageexam8 extends StatefulWidget {
  const WordPressDeveloperPageexam8({super.key});

  @override
  _WordPressDeveloperPageexam8State createState() =>
      _WordPressDeveloperPageexam8State();
}

class _WordPressDeveloperPageexam8State
    extends State<WordPressDeveloperPageexam8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage9()));
              },
