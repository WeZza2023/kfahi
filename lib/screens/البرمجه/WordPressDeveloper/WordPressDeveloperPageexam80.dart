...
class WordPressDeveloperPageexam80 extends StatefulWidget {
  const WordPressDeveloperPageexam80({super.key});

  @override
  _WordPressDeveloperPageexam80State createState() =>
      _WordPressDeveloperPageexam80State();
}

class _WordPressDeveloperPageexam80State
    extends State<WordPressDeveloperPageexam80> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage80()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 80'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage81()));
              },
