...
import 'WordPressDeveloperPage111.dart';
import 'WordPressDeveloperPage112.dart';

class WordPressDeveloperPageexam111 extends StatefulWidget {
  const WordPressDeveloperPageexam111({super.key});

  @override
  _WordPressDeveloperPageexam111State createState() =>
      _WordPressDeveloperPageexam111State();
}

class _WordPressDeveloperPageexam111State
    extends State<WordPressDeveloperPageexam111> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage111()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 111'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage112()));
              },
