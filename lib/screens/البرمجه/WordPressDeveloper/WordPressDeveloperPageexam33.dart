...
class WordPressDeveloperPageexam33 extends StatefulWidget {
  const WordPressDeveloperPageexam33({super.key});

  @override
  _WordPressDeveloperPageexam33State createState() =>
      _WordPressDeveloperPageexam33State();
}

class _WordPressDeveloperPageexam33State
    extends State<WordPressDeveloperPageexam33> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage33()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage34()));
              },
