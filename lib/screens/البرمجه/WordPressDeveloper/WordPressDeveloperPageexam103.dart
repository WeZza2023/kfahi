...
class WordPressDeveloperPageexam103 extends StatefulWidget {
  const WordPressDeveloperPageexam103({super.key});

  @override
  _WordPressDeveloperPageexam103State createState() =>
      _WordPressDeveloperPageexam103State();
}

class _WordPressDeveloperPageexam103State
    extends State<WordPressDeveloperPageexam103> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage103()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 103'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage104()));
              },
