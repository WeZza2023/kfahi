...
class WordPressDeveloperPageexam32 extends StatefulWidget {
  const WordPressDeveloperPageexam32({super.key});

  @override
  _WordPressDeveloperPageexam32State createState() =>
      _WordPressDeveloperPageexam32State();
}

class _WordPressDeveloperPageexam32State
    extends State<WordPressDeveloperPageexam32> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage32()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage33()));
              },
