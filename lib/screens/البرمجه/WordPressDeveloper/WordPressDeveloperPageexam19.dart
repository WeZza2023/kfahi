...
class WordPressDeveloperPageexam19 extends StatefulWidget {
  const WordPressDeveloperPageexam19({super.key});

  @override
  _WordPressDeveloperPageexam19State createState() =>
      _WordPressDeveloperPageexam19State();
}

class _WordPressDeveloperPageexam19State
    extends State<WordPressDeveloperPageexam19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage20()));
              },
