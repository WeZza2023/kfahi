...
class WordPressDeveloperPageexam44 extends StatefulWidget {
  const WordPressDeveloperPageexam44({super.key});

  @override
  _WordPressDeveloperPageexam44State createState() =>
      _WordPressDeveloperPageexam44State();
}

class _WordPressDeveloperPageexam44State
    extends State<WordPressDeveloperPageexam44> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage44()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage45()));
              },
