...
import 'WordPressDeveloperPage109.dart';
import 'WordPressDeveloperPage110.dart';

class WordPressDeveloperPageexam109 extends StatefulWidget {
  const WordPressDeveloperPageexam109({super.key});

  @override
  _WordPressDeveloperPageexam109State createState() =>
      _WordPressDeveloperPageexam109State();
}

class _WordPressDeveloperPageexam109State
    extends State<WordPressDeveloperPageexam109> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage109()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 109'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage110()));
              },
