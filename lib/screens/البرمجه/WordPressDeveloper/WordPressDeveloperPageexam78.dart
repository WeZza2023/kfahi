...
import 'WordPressDeveloperPage78.dart';
import 'WordPressDeveloperPage79.dart';

class WordPressDeveloperPageexam78 extends StatefulWidget {
  const WordPressDeveloperPageexam78({super.key});

  @override
  _WordPressDeveloperPageexam78State createState() =>
      _WordPressDeveloperPageexam78State();
}

class _WordPressDeveloperPageexam78State
    extends State<WordPressDeveloperPageexam78> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage78()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 78'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage79()));
              },
