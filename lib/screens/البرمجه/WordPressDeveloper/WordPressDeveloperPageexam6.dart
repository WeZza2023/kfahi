...
class WordPressDeveloperPageexam6 extends StatefulWidget {
  const WordPressDeveloperPageexam6({super.key});

  @override
  _WordPressDeveloperPageexam6State createState() =>
      _WordPressDeveloperPageexam6State();
}

class _WordPressDeveloperPageexam6State
    extends State<WordPressDeveloperPageexam6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage7()));
              },
