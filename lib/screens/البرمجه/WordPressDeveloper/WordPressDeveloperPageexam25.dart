...
class WordPressDeveloperPageexam25 extends StatefulWidget {
  const WordPressDeveloperPageexam25({super.key});

  @override
  _WordPressDeveloperPageexam25State createState() =>
      _WordPressDeveloperPageexam25State();
}

class _WordPressDeveloperPageexam25State
    extends State<WordPressDeveloperPageexam25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage25()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage26()));
              },
