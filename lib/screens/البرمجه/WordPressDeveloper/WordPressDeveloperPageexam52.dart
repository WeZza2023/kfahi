...
class WordPressDeveloperPageexam52 extends StatefulWidget {
  const WordPressDeveloperPageexam52({super.key});

  @override
  _WordPressDeveloperPageexam52State createState() =>
      _WordPressDeveloperPageexam52State();
}

class _WordPressDeveloperPageexam52State
    extends State<WordPressDeveloperPageexam52> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage52()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage53()));
              },
