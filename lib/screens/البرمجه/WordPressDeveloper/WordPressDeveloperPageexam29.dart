...
class WordPressDeveloperPageexam29 extends StatefulWidget {
  const WordPressDeveloperPageexam29({super.key});

  @override
  _WordPressDeveloperPageexam29State createState() =>
      _WordPressDeveloperPageexam29State();
}

class _WordPressDeveloperPageexam29State
    extends State<WordPressDeveloperPageexam29> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage29()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage30()));
              },
