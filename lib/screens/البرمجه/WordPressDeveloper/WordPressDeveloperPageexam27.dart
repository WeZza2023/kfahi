...
class WordPressDeveloperPageexam27 extends StatefulWidget {
  const WordPressDeveloperPageexam27({super.key});

  @override
  _WordPressDeveloperPageexam27State createState() =>
      _WordPressDeveloperPageexam27State();
}

class _WordPressDeveloperPageexam27State
    extends State<WordPressDeveloperPageexam27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage27()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage28()));
              },
