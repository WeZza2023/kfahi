...
class WordPressDeveloperPageexam50 extends StatefulWidget {
  const WordPressDeveloperPageexam50({super.key});

  @override
  _WordPressDeveloperPageexam50State createState() =>
      _WordPressDeveloperPageexam50State();
}

class _WordPressDeveloperPageexam50State
    extends State<WordPressDeveloperPageexam50> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage50()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage51()));
              },
