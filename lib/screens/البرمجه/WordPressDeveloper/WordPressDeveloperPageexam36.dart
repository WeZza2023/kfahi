...
class WordPressDeveloperPageexam36 extends StatefulWidget {
  const WordPressDeveloperPageexam36({super.key});

  @override
  _WordPressDeveloperPageexam36State createState() =>
      _WordPressDeveloperPageexam36State();
}

class _WordPressDeveloperPageexam36State
    extends State<WordPressDeveloperPageexam36> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage36()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage37()));
              },
