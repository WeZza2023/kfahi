...
class WordPressDeveloperPageexam42 extends StatefulWidget {
  const WordPressDeveloperPageexam42({super.key});

  @override
  _WordPressDeveloperPageexam42State createState() =>
      _WordPressDeveloperPageexam42State();
}

class _WordPressDeveloperPageexam42State
    extends State<WordPressDeveloperPageexam42> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage42()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage43()));
              },
