...
class WordPressDeveloperPageexam93 extends StatefulWidget {
  const WordPressDeveloperPageexam93({super.key});

  @override
  _WordPressDeveloperPageexam93State createState() =>
      _WordPressDeveloperPageexam93State();
}

class _WordPressDeveloperPageexam93State
    extends State<WordPressDeveloperPageexam93> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage93()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 93'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage94()));
              },
