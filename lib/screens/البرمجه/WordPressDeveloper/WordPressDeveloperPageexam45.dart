...
class WordPressDeveloperPageexam45 extends StatefulWidget {
  const WordPressDeveloperPageexam45({super.key});

  @override
  _WordPressDeveloperPageexam45State createState() =>
      _WordPressDeveloperPageexam45State();
}

class _WordPressDeveloperPageexam45State
    extends State<WordPressDeveloperPageexam45> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage45()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage46()));
              },
