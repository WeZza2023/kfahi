...
class WordPressDeveloperPageexam5 extends StatefulWidget {
  const WordPressDeveloperPageexam5({super.key});

  @override
  _WordPressDeveloperPageexam5State createState() =>
      _WordPressDeveloperPageexam5State();
}

class _WordPressDeveloperPageexam5State
    extends State<WordPressDeveloperPageexam5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage6()));
              },
