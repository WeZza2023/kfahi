...
class WordPressDeveloperPageexam113 extends StatefulWidget {
  const WordPressDeveloperPageexam113({super.key});

  @override
  _WordPressDeveloperPageexam113State createState() =>
      _WordPressDeveloperPageexam113State();
}

class _WordPressDeveloperPageexam113State
    extends State<WordPressDeveloperPageexam113> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage113()));
    }
