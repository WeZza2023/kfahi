...
import 'WordPressDeveloperPage60.dart';

class WordPressDeveloperPageexam59 extends StatefulWidget {
  const WordPressDeveloperPageexam59({super.key});

  @override
  _WordPressDeveloperPageexam59State createState() =>
      _WordPressDeveloperPageexam59State();
}

class _WordPressDeveloperPageexam59State
    extends State<WordPressDeveloperPageexam59> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage59()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 59'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage60()));
              },
