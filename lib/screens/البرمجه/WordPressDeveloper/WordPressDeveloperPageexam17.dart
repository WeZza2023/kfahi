...
class WordPressDeveloperPageexam17 extends StatefulWidget {
  const WordPressDeveloperPageexam17({super.key});

  @override
  _WordPressDeveloperPageexam17State createState() =>
      _WordPressDeveloperPageexam17State();
}

class _WordPressDeveloperPageexam17State
    extends State<WordPressDeveloperPageexam17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage18()));
              },
