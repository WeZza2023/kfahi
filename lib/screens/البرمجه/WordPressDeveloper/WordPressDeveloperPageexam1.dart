...
import 'WordPressDeveloperPage1.dart';
import 'WordPressDeveloperPage2.dart';

class WordPressDeveloperPageexam1 extends StatefulWidget {
  const WordPressDeveloperPageexam1({super.key});

  @override
  _WordPressDeveloperPageexam1State createState() =>
      _WordPressDeveloperPageexam1State();
}

class _WordPressDeveloperPageexam1State
    extends State<WordPressDeveloperPageexam1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage1()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره الاولي'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage2()));
              },
