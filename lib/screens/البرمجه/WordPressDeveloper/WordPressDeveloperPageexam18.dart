...
class WordPressDeveloperPageexam18 extends StatefulWidget {
  const WordPressDeveloperPageexam18({super.key});

  @override
  _WordPressDeveloperPageexam18State createState() =>
      _WordPressDeveloperPageexam18State();
}

class _WordPressDeveloperPageexam18State
    extends State<WordPressDeveloperPageexam18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage19()));
              },
