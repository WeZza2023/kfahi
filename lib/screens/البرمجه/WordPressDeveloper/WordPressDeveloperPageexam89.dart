...
class WordPressDeveloperPageexam89 extends StatefulWidget {
  const WordPressDeveloperPageexam89({super.key});

  @override
  _WordPressDeveloperPageexam89State createState() =>
      _WordPressDeveloperPageexam89State();
}

class _WordPressDeveloperPageexam89State
    extends State<WordPressDeveloperPageexam89> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage89()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 89'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage90()));
              },
