...
class WordPressDeveloperPageexam35 extends StatefulWidget {
  const WordPressDeveloperPageexam35({super.key});

  @override
  _WordPressDeveloperPageexam35State createState() =>
      _WordPressDeveloperPageexam35State();
}

class _WordPressDeveloperPageexam35State
    extends State<WordPressDeveloperPageexam35> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage35()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage36()));
              },
