...
import 'WordPressDeveloperPage83.dart';

class WordPressDeveloperPageexam82 extends StatefulWidget {
  const WordPressDeveloperPageexam82({super.key});

  @override
  _WordPressDeveloperPageexam82State createState() =>
      _WordPressDeveloperPageexam82State();
}

class _WordPressDeveloperPageexam82State
    extends State<WordPressDeveloperPageexam82> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage82()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 82'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage83()));
              },
