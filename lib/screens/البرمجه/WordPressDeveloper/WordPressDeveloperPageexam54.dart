...
class WordPressDeveloperPageexam54 extends StatefulWidget {
  const WordPressDeveloperPageexam54({super.key});

  @override
  _WordPressDeveloperPageexam54State createState() =>
      _WordPressDeveloperPageexam54State();
}

class _WordPressDeveloperPageexam54State
    extends State<WordPressDeveloperPageexam54> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage54()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 54'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage55()));
              },
