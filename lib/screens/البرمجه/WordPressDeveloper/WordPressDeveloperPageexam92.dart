...
import 'WordPressDeveloperPage92.dart';
import 'WordPressDeveloperPage93.dart';

class WordPressDeveloperPageexam92 extends StatefulWidget {
  const WordPressDeveloperPageexam92({super.key});

  @override
  _WordPressDeveloperPageexam92State createState() =>
      _WordPressDeveloperPageexam92State();
}

class _WordPressDeveloperPageexam92State
    extends State<WordPressDeveloperPageexam92> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage92()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 92'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage93()));
              },
