...
class WordPressDeveloperPageexam76 extends StatefulWidget {
  const WordPressDeveloperPageexam76({super.key});

  @override
  _WordPressDeveloperPageexam76State createState() =>
      _WordPressDeveloperPageexam76State();
}

class _WordPressDeveloperPageexam76State
    extends State<WordPressDeveloperPageexam76> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage76()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 76'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage77()));
              },
