...
class WordPressDeveloperPageexam38 extends StatefulWidget {
  const WordPressDeveloperPageexam38({super.key});

  @override
  _WordPressDeveloperPageexam38State createState() =>
      _WordPressDeveloperPageexam38State();
}

class _WordPressDeveloperPageexam38State
    extends State<WordPressDeveloperPageexam38> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage38()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage39()));
              },
