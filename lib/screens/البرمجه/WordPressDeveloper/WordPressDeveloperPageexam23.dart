...
class WordPressDeveloperPageexam23 extends StatefulWidget {
  const WordPressDeveloperPageexam23({super.key});

  @override
  _WordPressDeveloperPageexam23State createState() =>
      _WordPressDeveloperPageexam23State();
}

class _WordPressDeveloperPageexam23State
    extends State<WordPressDeveloperPageexam23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage24()));
              },
