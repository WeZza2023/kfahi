...
import 'WordPressDeveloperPage72.dart';
import 'WordPressDeveloperPage73.dart';

class WordPressDeveloperPageexam72 extends StatefulWidget {
  const WordPressDeveloperPageexam72({super.key});

  @override
  _WordPressDeveloperPageexam72State createState() =>
      _WordPressDeveloperPageexam72State();
}

class _WordPressDeveloperPageexam72State
    extends State<WordPressDeveloperPageexam72> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage72()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 72'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage73()));
              },
