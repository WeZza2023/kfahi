...
import 'WordPressDeveloperPage104.dart';
import 'WordPressDeveloperPage105.dart';

class WordPressDeveloperPageexam104 extends StatefulWidget {
  const WordPressDeveloperPageexam104({super.key});

  @override
  _WordPressDeveloperPageexam104State createState() =>
      _WordPressDeveloperPageexam104State();
}

class _WordPressDeveloperPageexam104State
    extends State<WordPressDeveloperPageexam104> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage104()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 104'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage105()));
              },
