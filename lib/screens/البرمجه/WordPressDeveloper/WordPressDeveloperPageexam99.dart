...
import 'WordPressDeveloperPage99.dart';

class WordPressDeveloperPageexam99 extends StatefulWidget {
  const WordPressDeveloperPageexam99({super.key});

  @override
  _WordPressDeveloperPageexam99State createState() =>
      _WordPressDeveloperPageexam99State();
}

class _WordPressDeveloperPageexam99State
    extends State<WordPressDeveloperPageexam99> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage99()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 99'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage100()));
              },
