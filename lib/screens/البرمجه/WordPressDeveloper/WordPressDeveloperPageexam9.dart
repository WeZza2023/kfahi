...
class WordPressDeveloperPageexam9 extends StatefulWidget {
  const WordPressDeveloperPageexam9({super.key});

  @override
  _WordPressDeveloperPageexam9State createState() =>
      _WordPressDeveloperPageexam9State();
}

class _WordPressDeveloperPageexam9State
    extends State<WordPressDeveloperPageexam9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage10()));
              },
