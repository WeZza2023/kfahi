...
class WordPressDeveloperPageexam86 extends StatefulWidget {
  const WordPressDeveloperPageexam86({super.key});

  @override
  _WordPressDeveloperPageexam86State createState() =>
      _WordPressDeveloperPageexam86State();
}

class _WordPressDeveloperPageexam86State
    extends State<WordPressDeveloperPageexam86> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage86()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 86'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage87()));
              },
