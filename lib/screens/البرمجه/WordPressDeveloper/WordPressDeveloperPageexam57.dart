...
class WordPressDeveloperPageexam57 extends StatefulWidget {
  const WordPressDeveloperPageexam57({super.key});

  @override
  _WordPressDeveloperPageexam57State createState() =>
      _WordPressDeveloperPageexam57State();
}

class _WordPressDeveloperPageexam57State
    extends State<WordPressDeveloperPageexam57> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage57()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 57'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage58()));
              },
