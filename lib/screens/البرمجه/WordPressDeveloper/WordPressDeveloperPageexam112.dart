...
import 'WordPressDeveloperPage113.dart';

class WordPressDeveloperPageexam112 extends StatefulWidget {
  const WordPressDeveloperPageexam112({super.key});

  @override
  _WordPressDeveloperPageexam112State createState() =>
      _WordPressDeveloperPageexam112State();
}

class _WordPressDeveloperPageexam112State
    extends State<WordPressDeveloperPageexam112> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage112()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 112'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage113()));
              },
