...
class WordPressDeveloperPageexam48 extends StatefulWidget {
  const WordPressDeveloperPageexam48({super.key});

  @override
  _WordPressDeveloperPageexam48State createState() =>
      _WordPressDeveloperPageexam48State();
}

class _WordPressDeveloperPageexam48State
    extends State<WordPressDeveloperPageexam48> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage48()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage49()));
              },
