...
import 'WordPressDeveloperPage95.dart';
import 'WordPressDeveloperPage96.dart';

class WordPressDeveloperPageexam95 extends StatefulWidget {
  const WordPressDeveloperPageexam95({super.key});

  @override
  _WordPressDeveloperPageexam95State createState() =>
      _WordPressDeveloperPageexam95State();
}

class _WordPressDeveloperPageexam95State
    extends State<WordPressDeveloperPageexam95> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage95()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 95'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage96()));
              },
