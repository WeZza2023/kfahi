...
import 'WordPressDeveloperPage65.dart';
import 'WordPressDeveloperPage66.dart';

class WordPressDeveloperPageexam65 extends StatefulWidget {
  const WordPressDeveloperPageexam65({super.key});

  @override
  _WordPressDeveloperPageexam65State createState() =>
      _WordPressDeveloperPageexam65State();
}

class _WordPressDeveloperPageexam65State
    extends State<WordPressDeveloperPageexam65> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage65()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 65'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage66()));
              },
