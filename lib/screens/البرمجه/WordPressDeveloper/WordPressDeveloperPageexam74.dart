...
class WordPressDeveloperPageexam74 extends StatefulWidget {
  const WordPressDeveloperPageexam74({super.key});

  @override
  _WordPressDeveloperPageexam74State createState() =>
      _WordPressDeveloperPageexam74State();
}

class _WordPressDeveloperPageexam74State
    extends State<WordPressDeveloperPageexam74> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage74()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 74'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage75()));
              },
