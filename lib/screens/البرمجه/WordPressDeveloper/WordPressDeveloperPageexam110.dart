...
class WordPressDeveloperPageexam110 extends StatefulWidget {
  const WordPressDeveloperPageexam110({super.key});

  @override
  _WordPressDeveloperPageexam110State createState() =>
      _WordPressDeveloperPageexam110State();
}

class _WordPressDeveloperPageexam110State
    extends State<WordPressDeveloperPageexam110> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage110()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 110'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage111()));
              },
