...
class WordPressDeveloperPageexam20 extends StatefulWidget {
  const WordPressDeveloperPageexam20({super.key});

  @override
  _WordPressDeveloperPageexam20State createState() =>
      _WordPressDeveloperPageexam20State();
}

class _WordPressDeveloperPageexam20State
    extends State<WordPressDeveloperPageexam20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage21()));
              },
