...
class WordPressDeveloperPageexam60 extends StatefulWidget {
  const WordPressDeveloperPageexam60({super.key});

  @override
  _WordPressDeveloperPageexam60State createState() =>
      _WordPressDeveloperPageexam60State();
}

class _WordPressDeveloperPageexam60State
    extends State<WordPressDeveloperPageexam60> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage60()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 60'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage61()));
              },
