...
class WordPressDeveloperPageexam7 extends StatefulWidget {
  const WordPressDeveloperPageexam7({super.key});

  @override
  _WordPressDeveloperPageexam7State createState() =>
      _WordPressDeveloperPageexam7State();
}

class _WordPressDeveloperPageexam7State
    extends State<WordPressDeveloperPageexam7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage8()));
              },
