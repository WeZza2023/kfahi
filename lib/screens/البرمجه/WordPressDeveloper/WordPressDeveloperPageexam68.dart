...
import 'WordPressDeveloperPage69.dart';

class WordPressDeveloperPageexam68 extends StatefulWidget {
  const WordPressDeveloperPageexam68({super.key});

  @override
  _WordPressDeveloperPageexam68State createState() =>
      _WordPressDeveloperPageexam68State();
}

class _WordPressDeveloperPageexam68State
    extends State<WordPressDeveloperPageexam68> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage68()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 68'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage69()));
              },
