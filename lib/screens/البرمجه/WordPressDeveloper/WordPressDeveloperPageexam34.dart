...
class WordPressDeveloperPageexam34 extends StatefulWidget {
  const WordPressDeveloperPageexam34({super.key});

  @override
  _WordPressDeveloperPageexam34State createState() =>
      _WordPressDeveloperPageexam34State();
}

class _WordPressDeveloperPageexam34State
    extends State<WordPressDeveloperPageexam34> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage34()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage35()));
              },
