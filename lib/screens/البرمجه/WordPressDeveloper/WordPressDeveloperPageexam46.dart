...
class WordPressDeveloperPageexam46 extends StatefulWidget {
  const WordPressDeveloperPageexam46({super.key});

  @override
  _WordPressDeveloperPageexam46State createState() =>
      _WordPressDeveloperPageexam46State();
}

class _WordPressDeveloperPageexam46State
    extends State<WordPressDeveloperPageexam46> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage46()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage47()));
              },
