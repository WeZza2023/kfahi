...
class WordPressDeveloperPageexam37 extends StatefulWidget {
  const WordPressDeveloperPageexam37({super.key});

  @override
  _WordPressDeveloperPageexam37State createState() =>
      _WordPressDeveloperPageexam37State();
}

class _WordPressDeveloperPageexam37State
    extends State<WordPressDeveloperPageexam37> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage37()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage38()));
              },
