...
import 'WordPressDeveloperPage88.dart';
import 'WordPressDeveloperPage89.dart';

class WordPressDeveloperPageexam88 extends StatefulWidget {
  const WordPressDeveloperPageexam88({super.key});

  @override
  _WordPressDeveloperPageexam88State createState() =>
      _WordPressDeveloperPageexam88State();
}

class _WordPressDeveloperPageexam88State
    extends State<WordPressDeveloperPageexam88> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage88()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 88'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage89()));
              },
