...
class WordPressDeveloperPageexam39 extends StatefulWidget {
  const WordPressDeveloperPageexam39({super.key});

  @override
  _WordPressDeveloperPageexam39State createState() =>
      _WordPressDeveloperPageexam39State();
}

class _WordPressDeveloperPageexam39State
    extends State<WordPressDeveloperPageexam39> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage39()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage40()));
              },
