...
import 'WordPressDeveloperPage22.dart';
import 'WordPressDeveloperPage23.dart';

class WordPressDeveloperPageexam22 extends StatefulWidget {
  const WordPressDeveloperPageexam22({super.key});

  @override
  _WordPressDeveloperPageexam22State createState() =>
      _WordPressDeveloperPageexam22State();
}

class _WordPressDeveloperPageexam22State
    extends State<WordPressDeveloperPageexam22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage23()));
              },
