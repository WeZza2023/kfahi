...
import 'WordPressDeveloperPage61.dart';
import 'WordPressDeveloperPage62.dart';

class WordPressDeveloperPageexam61 extends StatefulWidget {
  const WordPressDeveloperPageexam61({super.key});

  @override
  _WordPressDeveloperPageexam61State createState() =>
      _WordPressDeveloperPageexam61State();
}

class _WordPressDeveloperPageexam61State
    extends State<WordPressDeveloperPageexam61> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage61()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 61'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage62()));
              },
