...
class WordPressDeveloperPageexam24 extends StatefulWidget {
  const WordPressDeveloperPageexam24({super.key});

  @override
  _WordPressDeveloperPageexam24State createState() =>
      _WordPressDeveloperPageexam24State();
}

class _WordPressDeveloperPageexam24State
    extends State<WordPressDeveloperPageexam24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const WordPressDeveloperPage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WordPressDeveloperPage25()));
              },
