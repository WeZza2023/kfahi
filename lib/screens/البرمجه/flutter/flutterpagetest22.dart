...
class flutterpagetest22 extends StatefulWidget {
  const flutterpagetest22({super.key});

  @override
  _flutterpagetest22State createState() => _flutterpagetest22State();
}

class _flutterpagetest22State extends State<flutterpagetest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage22()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 22'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage23()));
              },
