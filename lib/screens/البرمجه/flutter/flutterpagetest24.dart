...
class flutterpagetest24 extends StatefulWidget {
  const flutterpagetest24({super.key});

  @override
  _flutterpagetest24State createState() => _flutterpagetest24State();
}

class _flutterpagetest24State extends State<flutterpagetest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage24()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 24'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage25()));
              },
