...
class flutterpagetest8 extends StatefulWidget {
  const flutterpagetest8({super.key});

  @override
  _flutterpagetest8State createState() => _flutterpagetest8State();
}

class _flutterpagetest8State extends State<flutterpagetest8> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage8()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage9()));
              },
