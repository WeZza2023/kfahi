...
class flutterpagetest45 extends StatefulWidget {
  const flutterpagetest45({super.key});

  @override
  _flutterpagetest45State createState() => _flutterpagetest45State();
}

class _flutterpagetest45State extends State<flutterpagetest45> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage45()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 45'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage46()));
              },
