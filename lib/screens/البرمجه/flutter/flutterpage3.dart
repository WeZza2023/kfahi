...
import 'flutterpagetest3.dart';

class FlutterPage3 extends StatefulWidget {
  const FlutterPage3({super.key});

  @override
  _FlutterPage3State createState() => _FlutterPage3State();
}

class _FlutterPage3State extends State<FlutterPage3> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: 'KFAoG9iHQuM', // تحديث معرف الفيديو الجديد هنا
    ...
    _youtubeController.addListener(() {
      ...
      if (_youtubeController.value.playerState == PlayerState.ended) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const flutterpagetest3(),
          ),
        );
      }
    });
