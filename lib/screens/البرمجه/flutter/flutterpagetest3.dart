...
class flutterpagetest3 extends StatefulWidget {
  const flutterpagetest3({super.key});

  @override
  _flutterpagetest3State createState() => _flutterpagetest3State();
}

class _flutterpagetest3State extends State<flutterpagetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage4()));
              },
