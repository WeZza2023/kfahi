...
class flutterpagetest47 extends StatefulWidget {
  const flutterpagetest47({super.key});

  @override
  _flutterpagetest47State createState() => _flutterpagetest47State();
}

class _flutterpagetest47State extends State<flutterpagetest47> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage47()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 47'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage48()));
              },
