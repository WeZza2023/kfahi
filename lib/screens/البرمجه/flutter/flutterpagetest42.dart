...
class flutterpagetest42 extends StatefulWidget {
  const flutterpagetest42({super.key});

  @override
  _flutterpagetest42State createState() => _flutterpagetest42State();
}

class _flutterpagetest42State extends State<flutterpagetest42> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage42()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 42'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage43()));
              },
