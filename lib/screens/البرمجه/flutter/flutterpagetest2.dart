...
import 'flutterpage2.dart';
import 'flutterpage3.dart';

class flutterpagetest2 extends StatefulWidget {
  const flutterpagetest2({super.key});

  @override
  _flutterpagetest2State createState() => _flutterpagetest2State();
}

class _flutterpagetest2State extends State<flutterpagetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage3()));
              },
