...
import 'flutterpage1.dart';
import 'flutterpage2.dart';

class flutterpagetest1 extends StatefulWidget {
  const flutterpagetest1({super.key});

  @override
  _flutterpagetest1State createState() => _flutterpagetest1State();
}

class _flutterpagetest1State extends State<flutterpagetest1> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage1()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage2()));
              },
