...
import 'flutterpage4.dart';

class flutterpagetest4 extends StatefulWidget {
  const flutterpagetest4({super.key});

  @override
  _flutterpagetest4State createState() => _flutterpagetest4State();
}

class _flutterpagetest4State extends State<flutterpagetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage4()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 4'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage5()));
              },
