...
class flutterpagetest17 extends StatefulWidget {
  const flutterpagetest17({super.key});

  @override
  _flutterpagetest17State createState() => _flutterpagetest17State();
}

class _flutterpagetest17State extends State<flutterpagetest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage17()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 17'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage18()));
              },
