...
class flutterpagetest20 extends StatefulWidget {
  const flutterpagetest20({super.key});

  @override
  _flutterpagetest20State createState() => _flutterpagetest20State();
}

class _flutterpagetest20State extends State<flutterpagetest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage20()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 20'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage21()));
              },
