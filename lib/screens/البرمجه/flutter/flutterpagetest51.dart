...
class flutterpagetest51 extends StatefulWidget {
  const flutterpagetest51({super.key});

  @override
  _flutterpagetest51State createState() => _flutterpagetest51State();
}

class _flutterpagetest51State extends State<flutterpagetest51> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage51()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 51'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage52()));
              },
