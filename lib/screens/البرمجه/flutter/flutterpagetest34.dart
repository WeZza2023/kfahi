...
class flutterpagetest34 extends StatefulWidget {
  const flutterpagetest34({super.key});

  @override
  _flutterpagetest34State createState() => _flutterpagetest34State();
}

class _flutterpagetest34State extends State<flutterpagetest34> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage34()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 34'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage35()));
              },
