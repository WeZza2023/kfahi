...
class flutterpagetest15 extends StatefulWidget {
  const flutterpagetest15({super.key});

  @override
  _flutterpagetest15State createState() => _flutterpagetest15State();
}

class _flutterpagetest15State extends State<flutterpagetest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage15()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 15'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage16()));
              },
