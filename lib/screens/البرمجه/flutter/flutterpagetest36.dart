...
class flutterpagetest36 extends StatefulWidget {
  const flutterpagetest36({super.key});

  @override
  _flutterpagetest36State createState() => _flutterpagetest36State();
}

class _flutterpagetest36State extends State<flutterpagetest36> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage36()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 36'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage37()));
              },
