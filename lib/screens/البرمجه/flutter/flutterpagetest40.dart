...
import 'flutterpage40.dart';

class flutterpagetest40 extends StatefulWidget {
  const flutterpagetest40({super.key});

  @override
  _flutterpagetest40State createState() => _flutterpagetest40State();
}

class _flutterpagetest40State extends State<flutterpagetest40> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage40()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 40'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage41()));
              },
