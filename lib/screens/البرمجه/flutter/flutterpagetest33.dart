...
import 'flutterpage34.dart';

class flutterpagetest33 extends StatefulWidget {
  const flutterpagetest33({super.key});

  @override
  _flutterpagetest33State createState() => _flutterpagetest33State();
}

class _flutterpagetest33State extends State<flutterpagetest33> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage33()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 33'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage34()));
              },
