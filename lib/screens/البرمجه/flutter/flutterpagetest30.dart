...
class flutterpagetest30 extends StatefulWidget {
  const flutterpagetest30({super.key});

  @override
  _flutterpagetest30State createState() => _flutterpagetest30State();
}

class _flutterpagetest30State extends State<flutterpagetest30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage30()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 30'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage31()));
              },
