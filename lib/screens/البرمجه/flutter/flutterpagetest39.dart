...
class flutterpagetest39 extends StatefulWidget {
  const flutterpagetest39({super.key});

  @override
  _flutterpagetest39State createState() => _flutterpagetest39State();
}

class _flutterpagetest39State extends State<flutterpagetest39> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage39()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 39'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage40()));
              },
