...
class flutterpagetest11 extends StatefulWidget {
  const flutterpagetest11({super.key});

  @override
  _flutterpagetest11State createState() => _flutterpagetest11State();
}

class _flutterpagetest11State extends State<flutterpagetest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage11()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 11'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage12()));
              },
