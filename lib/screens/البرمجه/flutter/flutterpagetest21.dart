...
import 'package:kfahi/screens/%D8%A7%D9%84%D8%A8%D8%B1%D9%85%D8%AC%D9%87/flutter/flutterpage21.dart';
import 'package:kfahi/screens/%D8%A7%D9%84%D8%A8%D8%B1%D9%85%D8%AC%D9%87/flutter/flutterpage22.dart';

class flutterpagetest21 extends StatefulWidget {
  const flutterpagetest21({super.key});

  @override
  _flutterpagetest21State createState() => _flutterpagetest21State();
}

class _flutterpagetest21State extends State<flutterpagetest21> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      'question': 'سؤال 1: ما هو الووردبريس؟',
      'options': [
        ' مدونه اللكتونيه',
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage21()));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختبار المحاضره 21'),
      ),
      body: Center(
        child: Column(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => const FlutterPage22()));
              },
