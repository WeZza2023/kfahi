...
class flutterpagetest54 extends StatefulWidget {
  const flutterpagetest54({super.key});

  @override
  _flutterpagetest54State createState() => _flutterpagetest54State();
}

class _flutterpagetest54State extends State<flutterpagetest54> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const FlutterPage54()));
    }
