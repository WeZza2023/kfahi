...
class Ethicalhackingpagetest16 extends StatefulWidget {
  const Ethicalhackingpagetest16({super.key});

  @override
  _Ethicalhackingpagetest16State createState() =>
      _Ethicalhackingpagetest16State();
}

class _Ethicalhackingpagetest16State extends State<Ethicalhackingpagetest16> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage16()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage17()));
              },
