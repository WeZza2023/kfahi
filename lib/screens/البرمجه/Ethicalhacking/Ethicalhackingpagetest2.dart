...
import 'Ethicalhackingpage2.dart';
import 'Ethicalhackingpage3.dart';

class Ethicalhackingpagetest2 extends StatefulWidget {
  const Ethicalhackingpagetest2({super.key});

  @override
  _Ethicalhackingpagetest2State createState() =>
      _Ethicalhackingpagetest2State();
}

class _Ethicalhackingpagetest2State extends State<Ethicalhackingpagetest2> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage2()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage3()));
              },
