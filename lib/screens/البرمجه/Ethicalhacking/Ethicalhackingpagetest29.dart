...
class Ethicalhackingpagetest29 extends StatefulWidget {
  const Ethicalhackingpagetest29({super.key});

  @override
  _Ethicalhackingpagetest29State createState() =>
      _Ethicalhackingpagetest29State();
}

class _Ethicalhackingpagetest29State extends State<Ethicalhackingpagetest29> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage29()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage30()));
              },
