...
import 'Ethicalhackingpage19.dart';
import 'Ethicalhackingpage20.dart';

class Ethicalhackingpagetest19 extends StatefulWidget {
  const Ethicalhackingpagetest19({super.key});

  @override
  _Ethicalhackingpagetest19State createState() =>
      _Ethicalhackingpagetest19State();
}

class _Ethicalhackingpagetest19State extends State<Ethicalhackingpagetest19> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage19()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage20()));
              },
