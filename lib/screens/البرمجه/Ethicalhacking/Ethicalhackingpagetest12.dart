...
class Ethicalhackingpagetest12 extends StatefulWidget {
  const Ethicalhackingpagetest12({super.key});

  @override
  _Ethicalhackingpagetest12State createState() =>
      _Ethicalhackingpagetest12State();
}

class _Ethicalhackingpagetest12State extends State<Ethicalhackingpagetest12> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage12()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage13()));
              },
