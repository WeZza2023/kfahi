...
class Ethicalhackingpagetest27 extends StatefulWidget {
  const Ethicalhackingpagetest27({super.key});

  @override
  _Ethicalhackingpagetest27State createState() =>
      _Ethicalhackingpagetest27State();
}

class _Ethicalhackingpagetest27State extends State<Ethicalhackingpagetest27> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage27()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage28()));
              },
