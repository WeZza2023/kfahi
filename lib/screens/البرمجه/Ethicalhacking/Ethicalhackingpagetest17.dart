...
import 'Ethicalhackingpage17.dart';
import 'Ethicalhackingpage18.dart';

class Ethicalhackingpagetest17 extends StatefulWidget {
  const Ethicalhackingpagetest17({super.key});

  @override
  _Ethicalhackingpagetest17State createState() =>
      _Ethicalhackingpagetest17State();
}

class _Ethicalhackingpagetest17State extends State<Ethicalhackingpagetest17> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage17()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage18()));
              },
