...
import 'Ethicalhackingpage25.dart';
import 'Ethicalhackingpage26.dart';

class Ethicalhackingpagetest25 extends StatefulWidget {
  const Ethicalhackingpagetest25({super.key});

  @override
  _Ethicalhackingpagetest25State createState() =>
      _Ethicalhackingpagetest25State();
}

class _Ethicalhackingpagetest25State extends State<Ethicalhackingpagetest25> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage25()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage26()));
              },
