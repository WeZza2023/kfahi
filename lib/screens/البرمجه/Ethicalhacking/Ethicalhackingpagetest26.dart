...
import 'Ethicalhackingpage27.dart';

class Ethicalhackingpagetest26 extends StatefulWidget {
  const Ethicalhackingpagetest26({super.key});

  @override
  _Ethicalhackingpagetest26State createState() =>
      _Ethicalhackingpagetest26State();
}

class _Ethicalhackingpagetest26State extends State<Ethicalhackingpagetest26> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage26()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage27()));
              },
