...
import 'Ethicalhackingpage20.dart';
import 'Ethicalhackingpage21.dart';

class Ethicalhackingpagetest20 extends StatefulWidget {
  const Ethicalhackingpagetest20({super.key});

  @override
  _Ethicalhackingpagetest20State createState() =>
      _Ethicalhackingpagetest20State();
}

class _Ethicalhackingpagetest20State extends State<Ethicalhackingpagetest20> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage20()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage21()));
              },
