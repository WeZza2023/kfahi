...
import 'Ethicalhackingpage23.dart';
import 'Ethicalhackingpage24.dart';

class Ethicalhackingpagetest23 extends StatefulWidget {
  const Ethicalhackingpagetest23({super.key});

  @override
  _Ethicalhackingpagetest23State createState() =>
      _Ethicalhackingpagetest23State();
}

class _Ethicalhackingpagetest23State extends State<Ethicalhackingpagetest23> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage23()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage24()));
              },
