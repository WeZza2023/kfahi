...
class Ethicalhackingpagetest31 extends StatefulWidget {
  const Ethicalhackingpagetest31({super.key});

  @override
  _Ethicalhackingpagetest31State createState() =>
      _Ethicalhackingpagetest31State();
}

class _Ethicalhackingpagetest31State extends State<Ethicalhackingpagetest31> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage31()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage32()));
              },
