...
class Ethicalhackingpagetest3 extends StatefulWidget {
  const Ethicalhackingpagetest3({super.key});

  @override
  _Ethicalhackingpagetest3State createState() =>
      _Ethicalhackingpagetest3State();
}

class _Ethicalhackingpagetest3State extends State<Ethicalhackingpagetest3> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage3()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage4()));
              },
