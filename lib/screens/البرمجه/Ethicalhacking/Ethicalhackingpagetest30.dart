...
import 'Ethicalhackingpage30.dart';
import 'Ethicalhackingpage31.dart';

class Ethicalhackingpagetest30 extends StatefulWidget {
  const Ethicalhackingpagetest30({super.key});

  @override
  _Ethicalhackingpagetest30State createState() =>
      _Ethicalhackingpagetest30State();
}

class _Ethicalhackingpagetest30State extends State<Ethicalhackingpagetest30> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage30()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage31()));
              },
