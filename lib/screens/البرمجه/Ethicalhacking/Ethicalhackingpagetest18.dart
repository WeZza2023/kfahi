...
class Ethicalhackingpagetest18 extends StatefulWidget {
  const Ethicalhackingpagetest18({super.key});

  @override
  _Ethicalhackingpagetest18State createState() =>
      _Ethicalhackingpagetest18State();
}

class _Ethicalhackingpagetest18State extends State<Ethicalhackingpagetest18> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage18()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage19()));
              },
