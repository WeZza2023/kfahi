...
import 'Ethicalhackingpage28.dart';
import 'Ethicalhackingpage29.dart';

class Ethicalhackingpagetest28 extends StatefulWidget {
  const Ethicalhackingpagetest28({super.key});

  @override
  _Ethicalhackingpagetest28State createState() =>
      _Ethicalhackingpagetest28State();
}

class _Ethicalhackingpagetest28State extends State<Ethicalhackingpagetest28> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage28()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage29()));
              },
