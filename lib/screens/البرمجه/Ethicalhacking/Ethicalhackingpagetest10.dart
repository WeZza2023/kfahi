...
import 'Ethicalhackingpage10.dart';
import 'Ethicalhackingpage11.dart';

class Ethicalhackingpagetest10 extends StatefulWidget {
  const Ethicalhackingpagetest10({super.key});

  @override
  _Ethicalhackingpagetest10State createState() =>
      _Ethicalhackingpagetest10State();
}

class _Ethicalhackingpagetest10State extends State<Ethicalhackingpagetest10> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage10()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage11()));
              },
