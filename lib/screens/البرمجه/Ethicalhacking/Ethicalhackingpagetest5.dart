...
import 'Ethicalhackingpage6.dart';

class Ethicalhackingpagetest5 extends StatefulWidget {
  const Ethicalhackingpagetest5({super.key});

  @override
  _Ethicalhackingpagetest5State createState() =>
      _Ethicalhackingpagetest5State();
}

class _Ethicalhackingpagetest5State extends State<Ethicalhackingpagetest5> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage5()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage6()));
              },
