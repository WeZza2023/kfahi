...
import 'Ethicalhackingpage12.dart';

class Ethicalhackingpagetest11 extends StatefulWidget {
  const Ethicalhackingpagetest11({super.key});

  @override
  _Ethicalhackingpagetest11State createState() =>
      _Ethicalhackingpagetest11State();
}

class _Ethicalhackingpagetest11State extends State<Ethicalhackingpagetest11> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage11()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage12()));
              },
