...
class Ethicalhackingpagetest9 extends StatefulWidget {
  const Ethicalhackingpagetest9({super.key});

  @override
  _Ethicalhackingpagetest9State createState() =>
      _Ethicalhackingpagetest9State();
}

class _Ethicalhackingpagetest9State extends State<Ethicalhackingpagetest9> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage9()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage10()));
              },
