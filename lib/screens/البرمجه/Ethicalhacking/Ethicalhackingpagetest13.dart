...
import 'Ethicalhackingpage13.dart';
import 'Ethicalhackingpage14.dart';

class Ethicalhackingpagetest13 extends StatefulWidget {
  const Ethicalhackingpagetest13({super.key});

  @override
  _Ethicalhackingpagetest13State createState() =>
      _Ethicalhackingpagetest13State();
}

class _Ethicalhackingpagetest13State extends State<Ethicalhackingpagetest13> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage13()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage14()));
              },
