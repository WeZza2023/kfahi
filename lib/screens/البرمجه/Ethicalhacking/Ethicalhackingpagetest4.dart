...
import 'Ethicalhackingpage4.dart';
import 'Ethicalhackingpage5.dart';

class Ethicalhackingpagetest4 extends StatefulWidget {
  const Ethicalhackingpagetest4({super.key});

  @override
  _Ethicalhackingpagetest4State createState() =>
      _Ethicalhackingpagetest4State();
}

class _Ethicalhackingpagetest4State extends State<Ethicalhackingpagetest4> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage4()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage5()));
              },
