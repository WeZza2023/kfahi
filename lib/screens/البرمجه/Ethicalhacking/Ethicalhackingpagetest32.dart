...
import 'Ethicalhackingpage32.dart';
import 'Ethicalhackingpage33.dart';

class Ethicalhackingpagetest32 extends StatefulWidget {
  const Ethicalhackingpagetest32({super.key});

  @override
  _Ethicalhackingpagetest32State createState() =>
      _Ethicalhackingpagetest32State();
}

class _Ethicalhackingpagetest32State extends State<Ethicalhackingpagetest32> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage32()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage33()));
              },
