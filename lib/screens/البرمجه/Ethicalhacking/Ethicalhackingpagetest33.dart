...
class Ethicalhackingpagetest33 extends StatefulWidget {
  const Ethicalhackingpagetest33({super.key});

  @override
  _Ethicalhackingpagetest33State createState() =>
      _Ethicalhackingpagetest33State();
}

class _Ethicalhackingpagetest33State extends State<Ethicalhackingpagetest33> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage33()));
    }
