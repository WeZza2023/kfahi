...
import 'Ethicalhackingpage22.dart';
import 'Ethicalhackingpage23.dart';

class Ethicalhackingpagetest22 extends StatefulWidget {
  const Ethicalhackingpagetest22({super.key});

  @override
  _Ethicalhackingpagetest22State createState() =>
      _Ethicalhackingpagetest22State();
}

class _Ethicalhackingpagetest22State extends State<Ethicalhackingpagetest22> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage22()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage23()));
              },
