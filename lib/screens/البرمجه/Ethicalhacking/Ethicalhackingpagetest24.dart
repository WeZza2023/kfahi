...
class Ethicalhackingpagetest24 extends StatefulWidget {
  const Ethicalhackingpagetest24({super.key});

  @override
  _Ethicalhackingpagetest24State createState() =>
      _Ethicalhackingpagetest24State();
}

class _Ethicalhackingpagetest24State extends State<Ethicalhackingpagetest24> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage24()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage25()));
              },
