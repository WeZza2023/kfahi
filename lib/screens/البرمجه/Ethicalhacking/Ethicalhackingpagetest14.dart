...
import 'Ethicalhackingpage14.dart';
import 'Ethicalhackingpage15.dart';

class Ethicalhackingpagetest14 extends StatefulWidget {
  const Ethicalhackingpagetest14({super.key});

  @override
  _Ethicalhackingpagetest14State createState() =>
      _Ethicalhackingpagetest14State();
}

class _Ethicalhackingpagetest14State extends State<Ethicalhackingpagetest14> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage14()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage15()));
              },
