...
import 'Ethicalhackingpage15.dart';
import 'Ethicalhackingpage16.dart';

class Ethicalhackingpagetest15 extends StatefulWidget {
  const Ethicalhackingpagetest15({super.key});

  @override
  _Ethicalhackingpagetest15State createState() =>
      _Ethicalhackingpagetest15State();
}

class _Ethicalhackingpagetest15State extends State<Ethicalhackingpagetest15> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage15()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage16()));
              },
