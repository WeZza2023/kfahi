...
class Ethicalhackingpagetest21 extends StatefulWidget {
  const Ethicalhackingpagetest21({super.key});

  @override
  _Ethicalhackingpagetest21State createState() =>
      _Ethicalhackingpagetest21State();
}

class _Ethicalhackingpagetest21State extends State<Ethicalhackingpagetest21> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage21()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage22()));
              },
