...
import 'Ethicalhackingpage7.dart';

class Ethicalhackingpagetest6 extends StatefulWidget {
  const Ethicalhackingpagetest6({super.key});

  @override
  _Ethicalhackingpagetest6State createState() =>
      _Ethicalhackingpagetest6State();
}

class _Ethicalhackingpagetest6State extends State<Ethicalhackingpagetest6> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage6()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage7()));
              },
