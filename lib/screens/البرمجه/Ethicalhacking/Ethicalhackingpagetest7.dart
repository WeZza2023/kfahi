...
class Ethicalhackingpagetest7 extends StatefulWidget {
  const Ethicalhackingpagetest7({super.key});

  @override
  _Ethicalhackingpagetest7State createState() =>
      _Ethicalhackingpagetest7State();
}

class _Ethicalhackingpagetest7State extends State<Ethicalhackingpagetest7> {
  ...
  void _showResult() {
    ...
    if (percentage >= 80) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const Ethicalhackingpage7()));
    }
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ethicalhackingpage8()));
              },
